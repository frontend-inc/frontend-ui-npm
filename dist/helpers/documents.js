...
var getDocumentValue = function (document, field) {
  var _a, _b, _c;
  if (
    index_1.ATTACHMENT_FIELDS.includes(
      field === null || field === void 0 ? void 0 : field.variant
    )
  ) {
    return (_a = (0, lodash_1.get)(
      document,
    ...
    index_1.REFERENCE_FIELDS.includes(
      field === null || field === void 0 ? void 0 : field.variant
    )
  ) {
    var documents =
      (_c =
        (_b =
          document === null || document === void 0
            ? void 0
            : document.document_links) === null || _b === void 0
          ? void 0
          : _b.filter(function (d) {
              var _a;
              return (
                ((_a = d === null || d === void 0 ? void 0 : d.target) ===
                  null || _a === void 0
                  ? void 0
                  : _a.content_type) ===
    ...
    index_1.SYSTEM_FIELDS.includes(
      field === null || field === void 0 ? void 0 : field.name
    )
  ) {
    ...
    return (0, lodash_1.get)(
      document,
      "data.".concat(field === null || field === void 0 ? void 0 : field.name)
    );
  }
};
