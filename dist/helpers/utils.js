...
var isEmptyObject = function (object) {
  if (
    Object.values(object).every(function (x) {
      return x === null || x === "";
    })
  ) {
    return false;
...
var buildOptions = function (items, key, value) {
  ...
  var list =
    (items === null || items === void 0 ? void 0 : items.data) || items;
...
var resize = function (src, _a) {
  var width = _a.width,
    height = _a.height,
    _b = _a.transform,
    transform = _b === void 0 ? "fill" : _b;
  if (!src) return null;
  var index = src.indexOf("/upload") + 7; // 7 is number of chars in '/upload'
  var params = ["/c_".concat(transform)];
  if (width && width > 0) params.push("w_".concat(width));
  if (height && height > 0) params.push("h_".concat(height));
  var transformedUrl =
...
var imageFromVideoUrl = function (url) {
  return url === null || url === void 0
    ? void 0
    : url.replace(/mp4|mpeg|ogg|mkv|mov/i, "jpg");
};
