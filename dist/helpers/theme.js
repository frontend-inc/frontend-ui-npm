...
var buildTheme = function (theme, bgcolor) {
  ...
  var secondaryText = (0, material_1.alpha)(
    primaryText,
    index_1.SECONDARY_TEXT_ALPHA
  ); // 0.9
  var neutral = contrast > 4.5 ? "#EEEEEE" : "#222222";
  var divider =
    contrast > 4.5
      ? (0, material_1.darken)(bgcolor, 0.1)
      : (0, material_1.lighten)(bgcolor, 0.2);
  var newTheme = __assign(__assign({}, theme), {
