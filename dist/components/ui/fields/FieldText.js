...
var FieldText = function (props) {
    var value = props.value, label = props.label, placeholder = props.placeholder, expandable = props.expandable, _a = props.maxChars, maxChars = _a === void 0 ? 80 : _a, className = props.className;
