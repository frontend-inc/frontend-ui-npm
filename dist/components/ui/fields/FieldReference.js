...
var FieldReference = function (props) {
    ...
    return (react_1.default.createElement(components_2.FieldWrapper, { label: label },
        react_1.default.createElement(components_1.Button, { variant: "ghost", endIcon: react_1.default.createElement(lucide_react_1.Repeat2, { className: "w-5 h-5" }), onClick: handleClick }, value)));
};
