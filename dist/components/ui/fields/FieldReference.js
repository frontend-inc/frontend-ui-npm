...
var FieldReference = function (props) {
    ...
    return (react_1.default.createElement(components_1.FieldWrapper, { label: label, color: color, disableLabel: disableLabel },
        react_1.default.createElement(core_1.Button, { variant: "outlined", endIcon: react_1.default.createElement(lucide_react_1.Repeat2, { className: "w-5 h-5" }), onClick: handleClick }, value)));
};
