...
var FieldDate = function (props) {
    ...
    return (react_1.default.createElement(components_2.FieldWrapper, __assign({ label: label }, rest),
        react_1.default.createElement(components_1.FieldString, { value: formattedValue })));
};
