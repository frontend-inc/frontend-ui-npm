...
var FieldWrapper = function (props) {
    ...
    var wrapperClasses = (0, react_2.cn)('flex w-full', direction === 'row' && 'flex-row space-x-2', direction === 'column' && 'flex-col space-y-2', className);
    return (react_1.default.createElement("div", { className: wrapperClasses },
        label && (react_1.default.createElement("div", { className: (0, react_2.cn)('min-w-[100px] pr-1', direction == 'row' && 'w-[100px] pr-1') },
            react_1.default.createElement("label", { className: "text-xs text-foreground/70 font-medium uppercase tracking-wider" }, label))),
