...
var Image = function (props) {
  var _a = props.src,
    ...
    _d = props.alt,
    alt = _d === void 0 ? "image" : _d,
    _e = props.bgcolor,
    bgcolor = _e === void 0 ? "#000000" : _e,
    _f = props.opacity,
    opacity = _f === void 0 ? 0.5 : _f,
    _g = props.enableOverlay,
    enableOverlay = _g === void 0 ? false : _g,
    _h = props.enableGradient,
    enableGradient = _h === void 0 ? false : _h,
    _j = props.disableBorderRadius,
  ...
  return react_1.default.createElement(
    material_1.Box,
    {
      sx: __assign(__assign({}, sx.root), {
        ...
        borderRadius:
          !disableBorderRadius && "".concat(theme.shape.borderRadius, "px"),
        "&::after": __assign(
          __assign(
            __assign(
              __assign(
                __assign(
                  __assign({}, sx.afterBase),
