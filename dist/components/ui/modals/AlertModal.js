...
var AlertModal = function (props) {
    ...
    return (react_1.default.createElement(components_1.Modal, { open: open, loading: loading, actions: react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(material_1.Button, { variant: "contained", color: "secondary", onClick: handleClose }, "Cancel"),
            react_1.default.createElement(material_1.Button, { variant: "contained", color: "primary", onClick: handleConfirm, startIcon: react_1.default.createElement(components_1.ButtonLoader, { loading: loading }) }, "Confirm")), handleClose: handleClose }, !loading && (react_1.default.createElement(components_1.Placeholder, { icon: icon, title: title, description: description }))));
};
