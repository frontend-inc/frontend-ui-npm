...
function MediaModal(_a) {
    ...
    if (!open)
        return null;
    return (react_1.default.createElement(core_1.Backdrop, { open: open, onClick: handleClose },
        ...
        react_1.default.createElement("button", { className: (0, frontend_shadcn_1.cn)('absolute top-5 right-5 p-2 rounded-full', 'bg-black bg-opacity-50 hover:bg-opacity-75', 'transition-colors duration-200'), onClick: handleClose },
