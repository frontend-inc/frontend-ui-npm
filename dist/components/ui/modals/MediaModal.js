...
function MediaModal(_a) {
    ...
    return (react_1.default.createElement(components_1.Backdrop, { open: open, onClick: handleClose },
        react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('relative rounded overflow-hidden', 'max-w-[calc(100vw-50px)] max-h-[calc(100vh-50px)]'), onClick: function (e) { return e.stopPropagation(); } }, children),
