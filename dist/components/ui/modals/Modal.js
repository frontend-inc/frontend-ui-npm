...
var Modal = function (props) {
  var open = props.open,
    ...
    _c = props.enableCancel,
    enableCancel = _c === void 0 ? false : _c,
    _d = props.hideBackdrop,
    hideBackdrop = _d === void 0 ? false : _d;
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        material_1.Box,
        { sx: sx.dialogTitleContent },
        react_1.default.createElement(
          material_1.Typography,
          { variant: "subtitle2", color: "textPrimary", sx: sx.title },
          title
        ),
        !loading &&
          react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      { sx: __assign(__assign({}, sx.dialogContent), { p: p }) },
      subtitle &&
        react_1.default.createElement(
          material_1.Typography,
          { variant: "body1", mt: 1 },
    ...
    !loading &&
      react_1.default.createElement(
        ...
        enableCancel &&
          react_1.default.createElement(
            material_1.Button,
            { variant: "contained", color: "secondary", onClick: handleClose },
            "Cancel"
          ),
        actions && actions
      )
