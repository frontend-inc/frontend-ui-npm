...
var Sheet = function (_a) {
    ...
    return (react_1.default.createElement(frontend_shadcn_2.Sheet, { open: open, onOpenChange: handleClose },
        react_1.default.createElement(frontend_shadcn_2.SheetContent, { side: side, className: (0, frontend_shadcn_1.cn)(mode, 'w-full sm:w-[300px]', disablePadding && 'px-0', className) },
