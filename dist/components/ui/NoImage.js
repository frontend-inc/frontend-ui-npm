...
var NoImage = function (props) {
    ...
    return (react_1.default.createElement("div", { className: (0, react_2.cn)(!disableBorderRadius && 'rounded-lg', 'relative h-full w-full overflow-hidden'), style: {
            maxHeight: "".concat(height, "px"),
        } },
        react_1.default.createElement(frontend_shadcn_1.AspectRatio, { ratio: aspectRatio },
            react_1.default.createElement("div", { className: (0, react_2.cn)(!disableBorderRadius && 'rounded-lg', 'h-full w-full bg-gradient-to-br from-black to-gray-600') })),
        icon && (react_1.default.createElement("div", { className: "absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" },
            react_1.default.createElement(frontend_shadcn_1.Avatar, null,
                react_1.default.createElement(frontend_shadcn_1.AvatarFallback, { className: "bg-transparent border border-white" },
