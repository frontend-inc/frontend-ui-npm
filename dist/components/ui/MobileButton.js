...
var MobileButton = function (props) {
    var startIcon = props.startIcon, onClick = props.onClick, _a = props.color, color = _a === void 0 ? "primary" : _a, children = props.children, variant = props.variant;
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(material_1.Hidden, { smDown: true },
            react_1.default.createElement(material_1.Button, { variant: variant, color: color, startIcon: startIcon, onClick: onClick }, children)),
