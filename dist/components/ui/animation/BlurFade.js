...
function BlurFade(props) {
    var _a = props || {}, children = _a.children, className = _a.className, variant = _a.variant, _b = _a.duration, duration = _b === void 0 ? 0.4 : _b, _c = _a.delay, delay = _c === void 0 ? 0 : _c, _d = _a.yOffset, yOffset = _d === void 0 ? 6 : _d, _e = _a.inView, inView = _e === void 0 ? false : _e, _f = _a.inViewMargin, inViewMargin = _f === void 0 ? '-50px' : _f, _g = _a.blur, blur = _g === void 0 ? '6px' : _g;
