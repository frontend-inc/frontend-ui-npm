...
exports.selectStyles = {
    ...
    singleValue: function (styles) { return (__assign(__assign({}, styles), { color: 'text.primary', borderRadius: 1 })); },
    multiValue: function (styles) { return (__assign(__assign({}, styles), { p: '0px 2px', borderRadius: 1, fontSize: 15, border: '1px solid', borderColor: theme.palette.primary.main, bgcolor: 'common.input' })); },
