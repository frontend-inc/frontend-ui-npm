...
exports.selectStyles = {
  ...
  noOptionsMessage: function (styles) {
    return __assign(__assign({}, styles), {
      fontSize: theme.typography.body1.fontSize,
      fontFamily: theme.typography.body1.fontFamily,
  ...
  input: function (styles) {
    return __assign(__assign({}, styles), { color: "text.primary" });
  },
  ...
  multiValueLabel: function (styles) {
    return __assign(__assign({}, styles), { color: "primary.main" });
  },
