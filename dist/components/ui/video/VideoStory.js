...
var VideoVert = function (props) {
    ...
    return !open ? (react_1.default.createElement(components_1.AvatarVert, { image: image, handleClick: handleItemClick, buttonText: buttonText, textVariant: textVariant, objectFit: objectFit, height: height, width: width, enableBorder: enableBorder, enableGradient: enableGradient, enableOverlay: enableOverlay })) : (react_1.default.createElement(components_1.VideoModal, { open: open, title: title, src: video, handleClose: function () { return setOpen(false); } }));
};
