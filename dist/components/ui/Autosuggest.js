...
var AutocompleteOption = function (props) {
  ...
  return react_1.default.createElement(
    material_1.ListItem,
    __assign({ sx: { mr: 2, flexShrink: 0 } }, props),
    ...
    (option === null || option === void 0 ? void 0 : option.image) &&
      react_1.default.createElement(
        material_1.ListItemIcon,
        null,
        react_1.default.createElement(image_1.default, {
          src: option === null || option === void 0 ? void 0 : option.image,
          alt: option === null || option === void 0 ? void 0 : option.label,
          width: 32,
          height: 32,
          //@ts-ignore
          style: styles.image,
...
var AutocompletePaper = function (props) {
  return react_1.default.createElement(
    material_1.Paper,
    __assign({}, props, { elevation: 10, sx: sx.paper })
  );
};
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(Autocomplete_1.default, {
        ...
        sx: __assign(__assign({}, sx.autocomplete), {
          paper: sx.paper,
          option: sx.option,
        ...
        renderOption: function (props, option) {
          return react_1.default.createElement(
            AutocompleteOption,
            __assign({}, props, { option: option })
          );
        },
        PaperComponent: AutocompletePaper,
        renderInput: function (params) {
          return react_1.default.createElement(material_1.InputBase, {
            placeholder: placeholder,
            ref: params.InputProps.ref,
            inputProps: __assign(__assign({}, params.inputProps), {
              autoComplete: "off",
            }),
            sx: __assign(__assign({}, sx.inputBase), error && sx.inputError),
          });
        },
      }),
...
var sx = {
  ...
  inputBase: {
    ...
    "& input": {
      ...
      "&:focus": {
        border: function (theme) {
          return "2px solid ".concat(theme.palette.primary.light);
        },
      },
    },
  },
