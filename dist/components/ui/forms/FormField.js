...
var FormField = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        variant === "select" && (react_1.default.createElement(components_1.SelectInput, { errors: errors, label: label, name: name, value: value, options: field.options.map(function (option) { return ({
                label: option,
                value: option,
