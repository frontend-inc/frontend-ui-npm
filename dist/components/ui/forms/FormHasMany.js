...
var FormHasMany = function (props) {
    ...
    return !submitted ? (react_1.default.createElement(material_1.Stack, { spacing: 1, sx: sx.root }, fields === null || fields === void 0 ? void 0 :
        ...
        react_1.default.createElement(material_1.Button, { variant: variant, onClick: handleSubmit, disabled: loading, endIcon: react_1.default.createElement(components_1.ButtonLoader, { color: "primary", loading: foreignLoading }) }, buttonText))) : (react_1.default.createElement(components_1.Placeholder, { enableBorder: true, icon: react_1.default.createElement(lucide_react_1.Check, { size: 32 }), title: "Success", description: "Your form has been submitted", actions: react_1.default.createElement(material_1.Button, { color: "secondary", variant: "outlined", onClick: function () { return setSubmitted(false); } }, "Done") }));
};
