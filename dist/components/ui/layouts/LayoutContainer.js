...
var LayoutContainer = function (props) {
    var children = props.children, _a = props.editing, editing = _a === void 0 ? false : _a, _b = props.mode, mode = _b === void 0 ? 'accent' : _b, _c = props.topNav, topNav = _c === void 0 ? false : _c, handleClick = props.handleClick, headerLinks = props.headerLinks, footerLinks = props.footerLinks, socialUrls = props.socialUrls, notifications = props.notifications, _d = props.enableAuth, enableAuth = _d === void 0 ? false : _d, _e = props.enableShopify, enableShopify = _e === void 0 ? false : _e;
        ...
        react_1.default.createElement(material_1.Box, { sx: __assign(__assign({}, sx.root), (!topNav && sx.sideNav)) },
            ...
            react_1.default.createElement(material_1.Box, { sx: __assign(__assign(__assign({}, sx.content), (topNav && sx.contentHeader)), (topNav ? sx.contentTopNav : sx.contentSideNav)) },
                react_1.default.createElement(components_1.LayoutScroll, null,
                    children,
                    react_1.default.createElement(components_1.ModeTheme, { mode: mode },
                        react_1.default.createElement(components_1.Footer, { menuItems: footerLinks, socialUrls: socialUrls, handleClick: handleClick })))))));
};
