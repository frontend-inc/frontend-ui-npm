...
var Logo = function (props) {
  var _a = props || {},
    src = _a.src,
    _b = _a.width,
    width = _b === void 0 ? LOGO_WIDTH : _b,
    _c = _a.height,
    height = _c === void 0 ? LOGO_HEIGHT : _c,
    handleClick = _a.handleClick;
  return react_1.default.createElement(
    material_1.Button,
    { disableRipple: true, sx: sx.root, onClick: handleClick },
    (src === null || src === void 0 ? void 0 : src.length) > 1
      ...
      : react_1.default.createElement(NoImage_1.default, {
          width: width ? Number(width) : LOGO_WIDTH,
          height: height ? Number(height) : LOGO_HEIGHT,
        })
  );
