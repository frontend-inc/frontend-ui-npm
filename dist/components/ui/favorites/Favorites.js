...
var Favorites = function (props) {
    ...
    return (react_1.default.createElement(components_1.StyledList, { resources: resources, layout: layout, style: style, editing: editing, loading: loading, buttonText: buttonText, handleClick: handleClick, enableBorder: enableBorder, enableGradient: enableGradient, enableOverlay: enableOverlay, emptyTitle: "No favorites found", emptyDescription: "Try adding some favorites", emptyIcon: "Bookmark" }));
};
