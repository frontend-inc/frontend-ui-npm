...
var FooterLinks = function (props) {
    ...
    return (react_1.default.createElement(material_1.List, { component: "nav", subheader: react_1.default.createElement(material_1.ListSubheader, { sx: sx.listSubheader }, menuItem === null || menuItem === void 0 ? void 0 : menuItem.label) }, children === null || children === void 0 ? void 0 : children.map(function (link, i) { return (react_1.default.createElement(material_1.ListItem, { key: i, disablePadding: true, dense: true },
