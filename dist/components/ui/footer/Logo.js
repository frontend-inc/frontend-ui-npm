...
var Logo = function (props) {
    ...
    return (
    // @ts-ignore
    react_1.default.createElement(material_1.Button, { disableRipple: true, sx: sx.root, onClick: handleClick }, (src === null || src === void 0 ? void 0 : src.length) > 1 ? (react_1.default.createElement(image_1.default, { src: src, alt: "logo", width: width ? Number(width) : LOGO_WIDTH, height: height ? Number(height) : LOGO_HEIGHT, 
        //@ts-ignore
