...
function ImageCard(props) {
    ...
    return (react_1.default.createElement("div", { className: "dark" },
        react_1.default.createElement("div", { className: (0, react_2.cn)('relative flex flex-col overflow-hidden rounded', 'transition-shadow duration-300 hover:shadow-md') },
            react_1.default.createElement(components_1.Image, __assign({ src: image, height: height, alt: primary, handleClick: handleClick, className: "w-full h-auto object-cover" }, slots.image)),
