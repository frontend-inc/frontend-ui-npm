...
var AvatarList = function (props) {
    ...
    return (react_1.default.createElement(material_1.List, { disablePadding: true, sx: sx.listItem },
        react_1.default.createElement(material_1.ListItem, { disablePadding: true, disableGutters: true, secondaryAction: react_1.default.createElement(components_1.ButtonActions, { numVisible: 0, buttons: buttons, resource: resource }) },
