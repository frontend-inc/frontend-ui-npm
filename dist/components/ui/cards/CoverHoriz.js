...
var CoverHoriz = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { sx: sx.root, spacing: 1 },
        react_1.default.createElement(components_1.TouchableOpacity, { handleClick: handleItemClick },
            react_1.default.createElement(components_1.Image, { src: image, objectFit: objectFit, alt: title, height: height, enableGradient: enableGradient, enableOverlay: enableOverlay })),
        react_1.default.createElement(material_1.Stack, { spacing: 1, sx: sx.cover },
            react_1.default.createElement(material_1.Stack, { spacing: 1, direction: 'row', alignItems: "center" },
                icon && (react_1.default.createElement(material_1.Box, null,
                    react_1.default.createElement(components_1.Icon, { size: 20, name: icon, color: "common.white" }))),
