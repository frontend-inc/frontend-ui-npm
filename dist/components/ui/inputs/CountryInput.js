...
var CountryInput = function (props) {
    ...
    return (react_1.default.createElement(__1.Autosuggest, { name: name, label: label, errors: errors, value: value, 
        //@ts-ignore
        options: constants_1.COUNTRIES, handleChange: handleChange }));
};
