...
var ShopifyProductInput = function (props) {
    var _a, _b, _c, _d;
    var value = props.value, label = props.label, _e = props.direction, direction = _e === void 0 ? 'column' : _e, placeholder = props.placeholder, _f = props.name, name = _f === void 0 ? 'shopify_handle' : _f, handleChange = props.handleChange, className = props.className;
    ...
    return (react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('flex flex-col space-y-4', className) },
        react_1.default.createElement(core_1.Collapse, { in: !!(product === null || product === void 0 ? void 0 : product.id) },
            react_1.default.createElement("div", { className: "w-[180px] h-[180px] rounded overflow-hidden transition-shadow duration-300 hover:shadow-md" },
                react_1.default.createElement(components_2.Image, { enableGradient: true, src: (_d = (_c = (_b = (_a = product === null || product === void 0 ? void 0 : product.images) === null || _a === void 0 ? void 0 : _a.edges) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.node) === null || _d === void 0 ? void 0 : _d.url, alt: product === null || product === void 0 ? void 0 : product.title, height: 180, width: 180 }))),
