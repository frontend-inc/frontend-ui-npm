...
var TabsInput = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { sx: __assign(__assign({}, styles_1.default.stack), (direction == 'row' && styles_1.default.stackVertical)), direction: direction, spacing: 1 },
