...
var SliderInput = function (props) {
    ...
    return (react_1.default.createElement(frontend_shadcn_1.Slider, { name: name, defaultValue: value, onValueChange: handleChange, step: stepSize, min: min, max: max, value: value, className: (0, react_2.cn)('w-full', className) }));
};
