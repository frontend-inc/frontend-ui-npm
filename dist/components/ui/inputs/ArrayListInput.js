...
var ArrayItemInput = function (props) {
  ...
  return react_1.default.createElement(
    material_1.Stack,
    { spacing: 0.5, direction: "row", sx: sx.root },
...
var ArrayListInput = function (props) {
  ...
  var handleRemove = function (index) {
    ...
    newValues = newValues.filter(function (_, i) {
      return i !== index;
    });
    handleChange({
      target: {
  ...
  return react_1.default.createElement(
    ...
    values === null || values === void 0
      ...
      : values.map(function (value, index) {
          return react_1.default.createElement(ArrayItemInput, {
            key: index,
            index: index,
            value: value,
            handleChange: handleInputChange,
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        material_1.Button,
        {
          ...
          startIcon: react_1.default.createElement(lucide_react_1.Plus, {
            size: 20,
          }),
        },
        "Add"
