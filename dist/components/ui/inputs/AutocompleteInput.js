...
var AutocompleteInput = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { width: '100%', direction: "column", spacing: 1 },
        react_1.default.createElement(__1.TextInput, { name: name, label: label, value: value, options: options, handleChange: handleKeywordChange, direction: direction, placeholder: placeholder, onFocus: function () { return setOpen(true); } }),
        react_1.default.createElement(material_1.Box, { sx: sx.anchor }, open && (react_1.default.createElement(material_1.Paper, { elevation: 2, sx: __assign(__assign({}, sx.paper), { height: (options === null || options === void 0 ? void 0 : options.length) * 64 }) },
            react_1.default.createElement(material_1.List, { dense: true, sx: sx.list }, options === null || options === void 0 ? void 0 : options.map(function (option, index) { return (react_1.default.createElement(material_1.ListItem, { disableGutters: true },
                react_1.default.createElement(material_1.ListItemButton, { sx: sx.listItemButton, onClick: function () { return handleClick(option); } },
                    react_1.default.createElement(material_1.ListItemIcon, { sx: { mr: 2 } },
                    ...
                    react_1.default.createElement(material_1.ListItemText, { primary: option.label })))); })))))));
};
