...
var CustomPopper = function (props) {
  return react_1.default.createElement(
    material_1.Popper,
    __assign({}, props, { sx: exports.sx.popper, placement: "bottom" })
  );
};
var ArrayInput = function (props) {
  var errors = props.errors,
    ...
    _a = props.freeSolo,
    freeSolo = _a === void 0 ? true : _a;
  var _b = (0, hooks_1.useError)({
      errors: errors,
      name: name,
    }),
    error = _b.error,
    clearError = _b.clearError;
  ...
  return react_1.default.createElement(
    ...
    value &&
      react_1.default.createElement(material_1.Autocomplete, {
        ...
        clearIcon: react_1.default.createElement(lucide_react_1.X, null),
        ...
        renderInput: function (params) {
          return react_1.default.createElement(
            ...
            __assign({}, params, {
              color: "primary",
              sx: __assign(
                __assign({}, exports.sx.textField),
                (error && exports.sx.inputError) || {}
              ),
...
exports.sx = {
  ...
  textField: {
    "& .MuiOutlinedInput-root": {
      ...
      "&.Mui-focused fieldset": {
        border: function (theme) {
          return "0px solid ".concat(theme.palette.primary.light);
        },
      },
    },
    root: {
  ...
  popper: {
    fontWeight: function (theme) {
      return theme.typography.body2.fontWeight;
    },
    fontFamily: function (theme) {
      return theme.typography.body2.fontFamily;
    },
