...
var TextInput = function (props) {
  ...
  var _e = (0, hooks_1.useError)({
    ...
    error = _e.error,
    clearError = _e.clearError;
  var handleInputChange = function (e) {
    if (error) clearError();
    setText(e.target.value);
  };
  var debouncedChanged = (0, use_debounce_1.useDebounce)(
    handleInputChange,
    2000
  )[0];
  (0, react_1.useEffect)(
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      {
        sx: __assign(
          __assign({}, styles_1.sx.stack),
          direction == "row" && !multiline && styles_1.sx.stackVertical
        ),
        direction: direction,
        spacing: 1,
      },
      label &&
        react_1.default.createElement(
          ...
          { sx: styles_1.sx.label, variant: "caption", color: "textSecondary" },
          label
        ),
      react_1.default.createElement(material_1.InputBase, {
        ...
        sx: __assign(
          __assign(
            __assign({}, styles_1.sx.inputBase),
            (error && styles_1.sx.inputError) || {}
          ),
          styles
        ),
        multiline: multiline,
