...
var ColorInput = function (props) {
  var name = props.name,
    value = props.value,
    _a = props.disableTone,
    disableTone = _a === void 0 ? false : _a,
    handleChange = props.handleChange;
  var _b = (0, react_1.useState)(500),
    tone = _b[0],
    setTone = _b[1];
  ...
  return react_1.default.createElement(
    material_1.Stack,
    { spacing: 2, direction: "column", sx: sx.root },
    !disableTone &&
      react_1.default.createElement(
        material_1.Stack,
        { spacing: 0, sx: sx.slider },
        react_1.default.createElement(
    ...
    react_1.default.createElement(
      material_1.Box,
      { sx: sx.grid },
      index_1.MUI_COLORS.map(function (color) {
      ...
      index_1.HEX_COLORS.map(function (hexColor) {
        return react_1.default.createElement(material_1.Box, {
          sx: __assign(
            __assign(__assign({}, sx.color), hex == hexColor && sx.selected),
            { bgcolor: hexColor }
          ),
          onClick: function () {
            return handleHexColorChange(hexColor);
          },
        });
      }),
      react_1.default.createElement(material_1.Box, {
        sx: __assign(
          __assign(
            __assign(__assign({}, sx.color), sx.transparent),
            hex == "" && sx.selected
          ),
          { bgcolor: "#FFF" }
        ),
