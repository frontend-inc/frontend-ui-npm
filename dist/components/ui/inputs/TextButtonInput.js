...
var TextButtonInput = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { direction: "row", spacing: 0, alignItems: "flex-end", sx: sx.inputContainer },
        ...
        react_1.default.createElement(material_1.Button, { variant: "contained", color: color, sx: sx.button, onClick: onClick, startIcon: loading ? react_1.default.createElement(components_1.IconLoading, { loading: true }) : null }, children)));
};
