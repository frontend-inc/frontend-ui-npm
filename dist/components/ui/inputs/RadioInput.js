...
var RadioInput = function (props) {
    var label = props.label, name = props.name, value = props.value, options = props.options, handleChange = props.handleChange;
    return (react_1.default.createElement(material_1.FormControl, { fullWidth: true, component: "fieldset" },
        label && (react_1.default.createElement(material_1.Typography, { variant: "caption", color: "text.secondary", gutterBottom: true }, label)),
