...
var AttachmentInput = function (props) {
  var name = props.name,
    ...
    _a = props.variant,
    variant = _a === void 0 ? "file" : _a,
    _b = props.size,
    size = _b === void 0 ? IMAGE_WIDTH : _b,
    _c = props.objectFit,
    objectFit = _c === void 0 ? "cover" : _c;
  var _d = (0, react_1.useState)(),
    src = _d[0],
    setSrc = _d[1];
  var onDrop = function (file, preview) {
  ...
  return react_1.default.createElement(
    ...
    (attachment === null || attachment === void 0 ? void 0 : attachment.url) &&
      react_1.default.createElement(RenderAttachment, {
        variant: variant,
        src: attachment.url,
        size: size,
        objectFit: objectFit,
    ...
    !(attachment === null || attachment === void 0 ? void 0 : attachment.url) &&
      !src &&
      react_1.default.createElement(DropZone_1.default, {
        onDrop: onDrop,
