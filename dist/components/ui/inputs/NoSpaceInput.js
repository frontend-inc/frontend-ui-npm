...
var NoSpaceInput = function (props) {
    var errors = props.errors, _a = props.joinChar, joinChar = _a === void 0 ? '_' : _a, _b = props.direction, direction = _b === void 0 ? 'column' : _b, value = props.value, name = props.name, label = props.label, placeholder = props.placeholder, handleChange = props.handleChange, disabled = props.disabled, disableLowerCase = props.disableLowerCase;
