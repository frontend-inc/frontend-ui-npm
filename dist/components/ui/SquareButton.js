...
var SquareButton = function (props) {
    ...
    return (react_1.default.createElement("button", { className: (0, frontend_shadcn_2.cn)("w-full flex flex-row space-x-3 items-center rounded-lg hover:border-primary p-4 transition duration-200", selected ? "border-2 border-primary scale-105 shadow-lg" : "border-2 border-border"), onClick: handleClick ? handleClick : undefined },
