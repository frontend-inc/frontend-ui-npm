    ...
    return (react_1.default.createElement("div", { className: "container mx-auto max-w-screen-lg" },
        react_1.default.createElement("div", { className: "flex flex-col w-full justify-start items-center space-y-6" },
            react_1.default.createElement("div", { className: "w-full max-w-screen-md justify-start items-center space-y-3" },
                ...
                (startsAt || endsAt) && (react_1.default.createElement(components_1.Typography, { variant: "subtitle2", className: "text-foreground/70", textAlign: textAlign },
                    startsAt,
                    " - ",
                    endsAt)),
                publishedAt && (react_1.default.createElement(components_1.Typography, { variant: "subtitle2", className: "text-foreground/70", textAlign: textAlign }, publishedAt)),
            ...
            react_1.default.createElement("div", { className: "w-full sm:max-w-screen-md flex flex-col space-y-6" },
                description && (react_1.default.createElement(components_1.Typography, { variant: "subtitle2", className: "text-foreground/70" }, description)),
                ...
                lat && lng && (react_1.default.createElement("div", { className: "w-full py-4 flex flex-col space-y-2" },
                    ...
                    react_1.default.createElement("span", { className: "text-sm text-foreground/70 italic" },
                        react_1.default.createElement("strong", null, "Location: "),
                        " ",
                        location))),
                (tags === null || tags === void 0 ? void 0 : tags.length) > 0 && (react_1.default.createElement("div", { className: "w-full flex flex-wrap gap-3" }, tags.map(function (tag, index) { return (react_1.default.createElement(frontend_shadcn_1.Badge, { key: index, variant: "outline", className: "px-3 py-1 text-foreground/70" }, tag)); })))))));
};
