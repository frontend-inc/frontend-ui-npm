...
var Placeholder = function (props) {
    var icon = props.icon, title = props.title, description = props.description, buttons = props.buttons, _a = props.color, color = _a === void 0 ? 'text.secondary' : _a, _b = props.enableBorder, enableBorder = _b === void 0 ? false : _b;
