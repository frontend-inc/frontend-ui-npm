...
var ProfileInfo = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
        react_1.default.createElement("div", { className: "flex flex-col" },
            react_1.default.createElement(components_1.FieldString, { value: label, variant: "caption", className: "text-muted-foreground" }),
            ...
            react_1.default.createElement(components_1.FieldText, { value: description, variant: "body2", className: "text-muted-foreground" }))));
};
