...
var ExpandableText = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { direction: "column", spacing: 0 },
        open ? (react_1.default.createElement(material_1.Typography, { variant: variant, color: color, sx: sx.text }, text)) : (react_1.default.createElement(material_1.Typography, { variant: variant, color: color, sx: sx.text }, text === null || text === void 0 ? void 0 : text.slice(0, maxChars))),
