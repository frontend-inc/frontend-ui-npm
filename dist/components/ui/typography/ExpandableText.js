...
var ExpandableText = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col" },
        open ? (react_1.default.createElement(core_1.Typography, { variant: variant, className: className }, text)) : (react_1.default.createElement(core_1.Typography, { variant: variant, className: className }, text === null || text === void 0 ? void 0 : text.slice(0, maxChars))),
