...
var Heading = function (props) {
    var _a = props || {}, label = _a.label, title = _a.title, description = _a.description, _b = _a.textAlign, textAlign = _b === void 0 ? 'left' : _b, _c = _a.textVariant, textVariant = _c === void 0 ? 'h4' : _c, _d = _a.enableBorder, enableBorder = _d === void 0 ? false : _d, secondaryAction = _a.secondaryAction;
    ...
    return (react_1.default.createElement(material_1.Box, { sx: sx.root },
        react_1.default.createElement(material_1.Stack, { sx: sx.toolbar, direction: { sm: 'row', xs: 'column' } },
            react_1.default.createElement(material_1.Stack, { sx: __assign(__assign(__assign({}, sx.stack), (enableBorder && sx.border)), { alignItems: textAlign }), direction: 'column', spacing: 0.5 },
