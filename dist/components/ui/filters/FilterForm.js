...
var FilterForm = function (props) {
  ...
  var _a = (0, react_1.useState)([]),
    filterOptions = _a[0],
    setFilterOptions = _a[1];
  var _b = (0, react_1.useState)([]),
    sortOptions = _b[0],
    setSortOptions = _b[1];
  var _c = (0, react_1.useState)([]),
    activeFilters = _c[0],
    setActiveFilters = _c[1];
  var defaultFilter = {
    where: "AND",
    field: "id",
    operator: "eq",
  ...
  var handleFilterChange = function (ev, index) {
    ...
    var _b = ev.target,
      name = _b.name,
      value = _b.value;
    var updatedFilter = __assign(
      __assign({}, filter),
      ((_a = {}), (_a[name] = value), _a)
    );
    // reset the filter
    if (name === "field") {
      updatedFilter = __assign(__assign({}, updatedFilter), {
        operator: "",
        value: "",
      });
    }
  ...
  var handleAddFilter = function () {
    var updatedFilters = __spreadArray(
  ...
  var handleFilters = function (fields) {
    var filter = function (field) {
      return index_1.FILTERABLE_TYPES.includes(
  ...
  var handleSort = function (fields) {
    var filter = function (field) {
      return index_1.SORTABLE_TYPES.includes(
        field === null || field === void 0 ? void 0 : field.variant
      );
    };
    var filters = handleFilterFields(fields, filter);
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      material_1.Box,
      { sx: sx.searchBar },
      react_1.default.createElement(components_1.FilterKeywordsInput, {
        label: "keywords",
    ...
    react_1.default.createElement(
      material_1.Box,
      { sx: sx.searchBar },
      react_1.default.createElement(components_1.FilterSortInput, {
        label: "sort by",
    ...
    react_1.default.createElement(components_1.FilterInputs, {
      ...
      react_1.default.createElement(
        ...
        react_1.default.createElement(
          material_1.Button,
          {
            variant: "contained",
            color: "secondary",
            startIcon: react_1.default.createElement(lucide_react_1.Plus, null),
    ...
    react_1.default.createElement(
      ...
      {
        sx: sx.button,
        startIcon: react_1.default.createElement(lucide_react_1.Search, {
          size: 20,
        }),
