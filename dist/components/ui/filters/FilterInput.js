...
var FilterFieldWrapper = function (props) {
    ...
    return (react_1.default.createElement(material_1.Box, { sx: sx.root },
        ...
        react_1.default.createElement(material_1.Box, { sx: sx.inputFilter },
            react_1.default.createElement(components_1.Autosuggest, { name: 'where', options: index_1.WHERE_OPTIONS, placeholder: "where", value: (filter === null || filter === void 0 ? void 0 : filter.where) || 'AND', handleChange: function (ev) { return handleChange(ev, index); } })),
        react_1.default.createElement(material_1.Box, { sx: sx.inputFilter },
            react_1.default.createElement(components_1.Autosuggest, { name: 'field', options: fieldOptions, placeholder: "field", value: (filter === null || filter === void 0 ? void 0 : filter.field) || '', handleChange: function (ev) { return handleChange(ev, index); } })),
        ...
        react_1.default.createElement(material_1.Box, { sx: sx.inputValue },
            ...
            index_1.SELECT_FIELDS.includes(field === null || field === void 0 ? void 0 : field.variant) && (react_1.default.createElement(components_1.Autosuggest, { name: 'value', placeholder: "Select...", options: (_a = field === null || field === void 0 ? void 0 : field.options) === null || _a === void 0 ? void 0 : _a.map(function (opt) { return ({
                    label: opt,
                    value: opt,
