...
var FilterFieldWrapper = function (props) {
  ...
  var operatorOptions = [];
  if (filter.field) {
    field = fieldOptions.find(function (f) {
      return f.value == filter.field;
    });
    operatorOptions =
      index_1.FILTER_OPERATORS[
        (field === null || field === void 0 ? void 0 : field.db_type) ||
          "integer"
      ];
  }
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        { variant: "subtitle2", color: "textSecondary", sx: sx.inputWhere },
        "where"
      )
    ),
    react_1.default.createElement(
      material_1.Box,
      { sx: sx.inputFilter },
      react_1.default.createElement(components_1.Autosuggest, {
        name: "where",
        options: index_1.WHERE_OPTIONS,
        placeholder: "where",
        value:
          (filter === null || filter === void 0 ? void 0 : filter.where) ||
          "AND",
        handleChange: function (ev) {
          return handleChange(ev, index);
        },
      })
    ),
    react_1.default.createElement(
    ...
    react_1.default.createElement(
      material_1.Box,
      { sx: sx.inputValue },
      index_1.BOOLEAN_FIELDS.includes(
        field === null || field === void 0 ? void 0 : field.db_type
      ) &&
        react_1.default.createElement(components_1.Autosuggest, {
          name: "value",
          placeholder: "true or false",
          options: index_1.BOOLEAN_OPTIONS,
          value:
        ...
        react_1.default.createElement(
          ...
          ["gte", "lte"].includes(
            ...
            ? react_1.default.createElement(components_1.Autosuggest, {
                ...
                options: index_1.DATE_RANGE_OPTIONS,
                value:
      ...
      index_1.NUMBER_FIELDS.includes(
        field === null || field === void 0 ? void 0 : field.variant
      ) &&
        react_1.default.createElement(
          react_1.default.Fragment,
      ...
      index_1.STRING_FIELDS.includes(
        field === null || field === void 0 ? void 0 : field.variant
      ) &&
        react_1.default.createElement(components_1.TextInput, {
          name: "value",
      ...
      index_1.SELECT_FIELDS.includes(
        field === null || field === void 0 ? void 0 : field.variant
      ) &&
        react_1.default.createElement(components_1.Autosuggest, {
          name: "value",
          ...
          options:
            (_a =
              field === null || field === void 0 ? void 0 : field.options) ===
              null || _a === void 0
              ? void 0
              : _a.map(function (opt) {
                  return {
