...
var SignupForm = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1 },
        !disableUsername && (react_1.default.createElement(ui_1.TextInput, { errors: errors, name: "username", value: user === null || user === void 0 ? void 0 : user.username, placeholder: "Username", handleChange: handleChange })),
        react_1.default.createElement(ui_1.TextInput, { errors: errors, name: "first_name", value: user === null || user === void 0 ? void 0 : user.first_name, placeholder: "First name", handleChange: handleChange }),
        react_1.default.createElement(ui_1.TextInput, { errors: errors, name: "last_name", value: user === null || user === void 0 ? void 0 : user.last_name, placeholder: "Last name", handleChange: handleChange }),
        ...
        react_1.default.createElement(material_1.Button, { fullWidth: true, color: "primary", onClick: handleSubmit, variant: "contained", startIcon: react_1.default.createElement(ui_1.IconLoader, { loading: loading }) }, "Register"),
