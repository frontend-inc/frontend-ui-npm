...
var AuthMenu = function (props) {
    ...
    return (react_1.default.createElement(material_1.Menu, { open: open, onClose: toggleMenu, anchorEl: anchorEl }, currentUser ? (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(material_1.MenuItem, { onClick: handleMyAccount },
            react_1.default.createElement(material_1.ListItemText, { primary: react_1.default.createElement(material_1.Typography, { variant: "body1" }, currentUser === null || currentUser === void 0 ? void 0 : currentUser.username), secondary: react_1.default.createElement(material_1.Typography, { variant: "body2", color: "textSecondary" }, currentUser === null || currentUser === void 0 ? void 0 : currentUser.email) })),
