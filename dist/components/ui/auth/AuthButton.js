...
var AuthButton = function (props) {
  var _a = props || {},
    _b = _a.showLabel,
    showLabel = _b === void 0 ? false : _b,
    _c = _a.showIcon,
    showIcon = _c === void 0 ? true : _c,
    _d = _a.editing,
    editing = _d === void 0 ? false : _d,
    myAccountUrl = _a.myAccountUrl;
  var router = (0, navigation_1.useRouter)();
  var _e = (0, hooks_1.useAuth)(),
    logout = _e.logout,
    fetchMe = _e.fetchMe,
    currentUser = _e.currentUser;
  var _f = (0, hooks_1.useMenu)(),
    open = _f.open,
    anchorEl = _f.anchorEl,
    closeMenu = _f.closeMenu,
    toggleMenu = _f.toggleMenu;
  ...
  return react_1.default.createElement(
      ...
      ? react_1.default.createElement(
          ...
          (
            ...
            ? react_1.default.createElement(
                ...
                { onClick: toggleMenu },
                react_1.default.createElement(components_1.AuthAvatar, null)
              )
            : react_1.default.createElement(
                material_1.IconButton,
                { onClick: handleLogin },
    ...
    currentUser &&
      react_1.default.createElement(components_1.AuthMenu, {
        open: open,
        anchorEl: anchorEl,
