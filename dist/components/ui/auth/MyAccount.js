...
var MyAccount = function (props) {
  ...
  var _a = (0, hooks_1.useAuth)(),
    loading = _a.loading,
    user = _a.user,
    setUser = _a.setUser,
    currentUser = _a.currentUser,
    updateMe = _a.updateMe,
    handleChange = _a.handleChange,
    fetchMe = _a.fetchMe,
    deleteAvatar = _a.deleteAvatar;
  var handleDeleteAvatar = function () {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, deleteAvatar()];
          case 1:
            _a.sent();
            return [2 /*return*/];
        }
  ...
  return react_1.default.createElement(
    ...
    currentUser &&
      react_1.default.createElement(
        ...
        react_1.default.createElement(components_1.MyAccountForm, {
          user: user,
