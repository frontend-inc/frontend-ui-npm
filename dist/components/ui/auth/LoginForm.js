...
var LoginForm = function (props) {
  var errors = props.errors,
    ...
    handleOneTimePassword = props.handleOneTimePassword;
  return react_1.default.createElement(
    ...
    handleForgotPassword &&
      react_1.default.createElement(
        material_1.Button,
        { fullWidth: true, color: "primary", onClick: handleForgotPassword },
        "Forgot password?"
      ),
    handleOneTimePassword &&
      react_1.default.createElement(
        material_1.Button,
        { fullWidth: true, color: "primary", onClick: handleOneTimePassword },
        "One-time password"
      )
  );
};
