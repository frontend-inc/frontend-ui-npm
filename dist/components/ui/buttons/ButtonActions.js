...
var ButtonActions = function (props) {
    ...
    return (react_1.default.createElement("div", { className: (0, react_2.cn)('flex flex-row w-full', justifyContent && "justify-center md:".concat(justifyContent), className) }, (buttons === null || buttons === void 0 ? void 0 : buttons.length) > 0 && (react_1.default.createElement("div", { className: (0, react_2.cn)('w-full flex flex-col sm:flex-row sm:space-x-3', justifyContent) }, buttons.map(function (button, index) { return (react_1.default.createElement("div", { key: index, className: "w-full sm:w-auto" },
        react_1.default.createElement(ButtonAction_1.default, { size: size, color: button === null || button === void 0 ? void 0 : button.color, icon: button === null || button === void 0 ? void 0 : button.icon, path: button === null || button === void 0 ? void 0 : button.path, url: button === null || button === void 0 ? void 0 : button.url, src: button === null || button === void 0 ? void 0 : button.src, action: button === null || button === void 0 ? void 0 : button.action, variant: button === null || button === void 0 ? void 0 : button.variant }, button === null || button === void 0 ? void 0 : button.label))); })))));
};
