...
var ButtonActions = function (props) {
    var _a = props || {}, buttons = _a.buttons, _b = _a.size, size = _b === void 0 ? 'default' : _b, _c = _a.justifyContent, justifyContent = _c === void 0 ? 'justify-center' : _c, className = _a.className;
    return (react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('flex flex-row w-full', justifyContent && "justify-center md:".concat(justifyContent), className) }, (buttons === null || buttons === void 0 ? void 0 : buttons.length) > 0 && (react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('w-full flex flex-col sm:flex-row sm:space-x-3', justifyContent) }, buttons.map(function (button, index) { return (react_1.default.createElement("div", { key: index, className: "w-full sm:w-auto" },
