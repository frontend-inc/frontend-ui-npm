...
var ActionButtons = function (props) {
    var _a, _b, _c;
    var color = props.color, buttons = props.buttons, resource = props.resource, _d = props.numVisible, numVisible = _d === void 0 ? 2 : _d, justifyContent = props.justifyContent;
