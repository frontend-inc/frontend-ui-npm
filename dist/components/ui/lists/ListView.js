...
var ListView = function (props) {
    var items = props.items, editing = props.editing, handleClick = props.handleClick, buttonText = props.buttonText, _a = props.flexDirection, flexDirection = _a === void 0 ? "column" : _a, _b = props.component, Component = _b === void 0 ? components_1.CardHoriz : _b, _c = props.enableBorder, enableBorder = _c === void 0 ? false : _c, _d = props.enableGradient, enableGradient = _d === void 0 ? false : _d, _e = props.enableOverlay, enableOverlay = _e === void 0 ? false : _e, _f = props.spacing, spacing = _f === void 0 ? 1 : _f, _g = props.justifyContent, justifyContent = _g === void 0 ? "flex-start" : _g;
    return (react_1.default.createElement(material_1.Stack, { sx: __assign(__assign(__assign({}, sx.root), (flexDirection === "row" && sx.row)), { justifyContent: {
                sm: justifyContent,
                xs: "flex-start",
