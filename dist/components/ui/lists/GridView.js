...
var GridView = function (props) {
    var items = props.items, editing = props.editing, buttonText = props.buttonText, handleClick = props.handleClick, _a = props.xs, xs = _a === void 0 ? 12 : _a, _b = props.sm, sm = _b === void 0 ? 6 : _b, _c = props.md, md = _c === void 0 ? 4 : _c, _d = props.lg, lg = _d === void 0 ? 4 : _d, _e = props.xl, xl = _e === void 0 ? 4 : _e, _f = props.component, Component = _f === void 0 ? ui_1.CardVert : _f, _g = props.enableBorder, enableBorder = _g === void 0 ? false : _g, _h = props.enableGradient, enableGradient = _h === void 0 ? false : _h, _j = props.enableOverlay, enableOverlay = _j === void 0 ? false : _j;
