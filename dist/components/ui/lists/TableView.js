...
var TableView = function (props) {
  ...
  var _c = (0, hooks_1.useResource)({
    ...
    query = _c.query,
    setQuery = _c.setQuery,
    page = _c.page,
    perPage = _c.perPage,
    numPages = _c.numPages,
    totalCount = _c.totalCount,
    sortDirection = _c.sortDirection;
  ...
  var handleQueryChange = function (ev) {
    ...
    var _b = ev.target,
      ...
      name = _b.name;
    setQuery(
      __assign(__assign({}, query), ((_a = {}), (_a[name] = value), _a))
    );
  };
  ...
  var handleSort = function (field) {
    var sortDirection =
      (query === null || query === void 0 ? void 0 : query.sort_by) || "desc";
    if (
      (field === null || field === void 0 ? void 0 : field.name) ==
      (activeField === null || activeField === void 0
        ? void 0
        : activeField.name)
    ) {
      if (
    ...
    var newRows = resources.map(function (resource) {
      ...
      fields.forEach(function (field) {
        ...
        if (
          ...
          row[field.name] =
            (_a = resource[field.name]) === null || _a === void 0
              ? void 0
              : _a.url;
        } else {
          row[field.name] =
