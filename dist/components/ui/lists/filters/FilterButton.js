...
var FilterButton = function (props) {
  ...
  return react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        react_1.default.createElement(
          material_1.Button,
          {
            ...
            variant: "text",
            startIcon: loading
              ? react_1.default.createElement(components_1.ButtonLoader, {
                  loading: loading,
                })
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        components_1.Popup,
        { p: 1, anchorEl: anchorEl, open: open, handleClose: handleClose },
        react_1.default.createElement(
          material_1.Stack,
          { spacing: 2 },
          fields === null || fields === void 0
            ...
            : fields.map(function (field, index) {
                return react_1.default.createElement(FilterField_1.default, {
                  key: index,
                  filters: filters,
                  field: field,
