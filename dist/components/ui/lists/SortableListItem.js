...
function SortableListItem(_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, react_2.cn)('flex items-center p-4 transition-colors duration-200', isDragging && 'bg-secondary') },
        react_1.default.createElement("div", { className: "mr-4 cursor-grab active:cursor-grabbing" },
            react_1.default.createElement(lucide_react_1.GripVertical, { className: "h-5 w-5 text-foreground/70" })),
