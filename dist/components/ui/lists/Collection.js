    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1, sx: sx.root },
        react_1.default.createElement(material_1.Stack, { direction: "row", justifyContent: 'space-between', spacing: 1 },
            ...
            react_1.default.createElement(material_1.Box, null,
                enableFilters && (react_1.default.createElement(components_1.ListFilterButton, { fields: fields, filters: activeFilters, handleFilter: handleFilter, handleClear: handleClearFilters })),
                (enableSortTitle || enableSortPrice) && (react_1.default.createElement(components_1.ListSortButton, { sortBy: query === null || query === void 0 ? void 0 : query.sort_by, sortDirection: query === null || query === void 0 ? void 0 : query.sort_direction, fields: __spreadArray(__spreadArray([], ((enableSortTitle && [index_1.TITLE_SORT]) || []), true), ((enableSortPrice && [index_1.PRICE_SORT]) || []), true), handleSortBy: handleSortBy, handleSortDirection: handleSortDirection })))),
        enableSearch && (react_1.default.createElement(components_1.SearchInput, { value: keywords, handleChange: handleChange, handleSearch: handleSearch })),
        react_1.default.createElement(components_1.StyledList, { resources: resources, layout: layout, style: style, editing: editing, loading: loading, buttonText: buttonText, handleClick: handleClick, 
            //@ts-ignore
