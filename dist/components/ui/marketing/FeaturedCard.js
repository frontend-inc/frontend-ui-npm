...
var FeaturedCard = function (props) {
  ...
  var _a = props || {},
    ...
    href = _a.href,
    _d = _a.height,
    height = _d === void 0 ? index_1.FEATURED_CARD_HEIGHT : _d,
    buttonText = _a.buttonText,
    _e = _a.flexDirection,
    flexDirection = _e === void 0 ? "row" : _e,
    _f = _a.textVariant,
    textVariant = _f === void 0 ? "h3" : _f,
    handleClick = _a.handleClick,
    _g = _a.objectFit,
    objectFit = _g === void 0 ? "cover" : _g,
    _h = _a.enableBorder,
    enableBorder = _h === void 0 ? false : _h,
    _j = _a.enableGradient,
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      material_1.Box,
      {
        sx: __assign(__assign({}, sx.imageContainer), {
          flexDirection: {
            sm: flexDirection,
            xs: "column",
          },
          ...
          react_1.default.createElement(
            ...
            label &&
              react_1.default.createElement(
                ...
                { color: "primary", sx: sx.label, variant: "caption" },
                label
              ),
            react_1.default.createElement(
              material_1.Typography,
              {
                sx: __assign(__assign({}, sx.title), {
            ...
            react_1.default.createElement(
              ...
              {
                variant: "body2",
                sx: __assign(__assign({}, sx.description), {
                  textAlign: direction == "row" ? "left" : "center",
                }),
              },
            ...
            buttonText &&
              react_1.default.createElement(
                material_1.Box,
                {
                  sx: __assign(__assign({}, sx.actions), {
                    justifyContent:
