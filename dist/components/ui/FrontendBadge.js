...
var FrontendBadge = function () {
    return (react_1.default.createElement("div", { className: "absolute bottom-0 right-0 w-full flex flex-row justify-end pb-4 pr-4" },
        react_1.default.createElement(link_1.default, { href: "https://www.frontend.co", target: "_blank", className: "relative p-[2px] rounded-full shadow-lg hover:scale-105 transition-transform cursor-pointer overflow-hidden" },
