...
function ButtonTabs(_a) {
    ...
    return (react_1.default.createElement(frontend_shadcn_1.Tabs, { value: value.toString(), onValueChange: handleChange },
        react_1.default.createElement(frontend_shadcn_1.TabsList, { className: (0, frontend_shadcn_2.cn)('bg-muted p-1', className, fullWidth && 'w-full') }, options.map(function (tab, i) {
            return (react_1.default.createElement(frontend_shadcn_1.TabsTrigger, { key: i, value: tab.value.toString(), className: (0, frontend_shadcn_2.cn)('w-full flex items-center justify-center gap-2 transition-all', 'data-[state=active]:bg-background data-[state=active]:text-foreground', 'data-[state=active]:shadow-sm', 'hover:bg-muted-foreground/10') },
                tab.icon && react_1.default.createElement(__1.Icon, { name: tab.icon, className: "h-5 w-5" }),
