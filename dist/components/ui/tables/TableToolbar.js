...
var TableToolbar = function (props) {
  var loading = props.loading,
    ...
    query = props.query,
    _a = props.enableDelete,
    enableDelete = _a === void 0 ? false : _a,
    _b = props.enableEdit,
    enableEdit = _b === void 0 ? false : _b,
  ...
  (0, react_1.useEffect)(
    function () {
      ...
      if (query === null || query === void 0 ? void 0 : query.filters) {
        setBadgeCount(
          (_a = Object.keys(query.filters)) === null || _a === void 0
            ? void 0
            : _a.length
        );
      } else {
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        react_1.default.createElement(
          material_1.Box,
          { sx: sx.toolbar },
          react_1.default.createElement(components_2.FilterButton, {
            loading: loading,
            query: query,
                  ...
                  react_1.default.createElement(
                    ...
                    react_1.default.createElement(
                      material_1.Button,
                      {
                        ...
                        variant: "text",
                        onClick: function () {
                          return handleUnpublish(selected);
                        },
                      },
                      "Unpublish"
                    )
              ...
              react_1.default.createElement(
                ...
                enableDelete &&
                  ...
                  react_1.default.createElement(
                    ...
                    react_1.default.createElement(lucide_react_1.Trash, {
                      size: 20,
                    })
                  ),
                enableEdit &&
                  ...
                  react_1.default.createElement(
                    material_1.IconButton,
                    { onClick: handleEdit },
                    react_1.default.createElement(lucide_react_1.Edit, {
                      size: 20,
                    })
                  )
              )
