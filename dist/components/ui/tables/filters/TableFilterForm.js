...
var TableFilterForm = function (props) {
    ...
    return (react_1.default.createElement(material_1.Box, null,
        react_1.default.createElement(material_1.Box, { sx: sx.searchBar },
            react_1.default.createElement(__1.TableFilterKeywordsInput, { label: "keywords", value: query === null || query === void 0 ? void 0 : query.keywords, handleChange: handleChange, handleSearch: handleFilterSearch })),
        react_1.default.createElement(material_1.Box, { sx: sx.searchBar },
            react_1.default.createElement(__1.TableFilterSortInput, { label: "sort by", fieldOptions: sortOptions, handleChange: handleChange, sortBy: query === null || query === void 0 ? void 0 : query.sort_by, sortDirection: query === null || query === void 0 ? void 0 : query.sort_direction })),
        react_1.default.createElement(__1.TableFilterInputs, { filters: activeFilters, fieldOptions: filterOptions, handleChange: handleFilterChange, handleRemove: handleRemoveFilter }),
        ...
        react_1.default.createElement(material_1.Button, { sx: sx.button, startIcon: loading ? react_1.default.createElement(__1.IconLoading, { loading: loading }) : react_1.default.createElement(lucide_react_1.Search, { size: 20 }), onClick: handleFilterSearch, fullWidth: true, variant: "contained", color: "primary" }, "Search"),
