...
var TableFilterDrawer = function (props) {
    ...
    return (react_1.default.createElement(__1.Drawer, { open: open, handleClose: handleClose, title: "search" },
        react_1.default.createElement(TableFilterForm_1.default, { query: query, fields: fields, handleSearch: handleSearch, handleChange: handleChange, handleClearFilters: handleClearFilters })));
};
