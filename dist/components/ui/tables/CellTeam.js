...
var CellTeam = function (props) {
    ...
    return (react_1.default.createElement(material_1.Box, { sx: sx.cell },
        react_1.default.createElement(material_1.Button, { sx: sx.button, size: "small", color: "secondary", onClick: handleClick, startIcon: react_1.default.createElement(components_1.TeamAvatar, { team: team }) },
