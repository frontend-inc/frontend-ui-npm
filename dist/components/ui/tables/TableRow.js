    ...
    return (react_1.default.createElement(frontend_shadcn_1.TableRow, null,
        enableSelect && (react_1.default.createElement(components_1.TableCell, { small: true, align: 'center', sticky: true },
            react_1.default.createElement("div", { className: "mx-2" },
                react_1.default.createElement(core_1.Checkbox, { name: "select-".concat(row.id), value: selected, 
                    //@ts-ignore
        ...
        (enableEdit || enableDelete) && (react_1.default.createElement(components_1.TableCell, { small: true },
            react_1.default.createElement("div", { className: "flex flex-row space-x-1" },
                enableShow && (react_1.default.createElement(core_1.Button, { size: "small", color: "secondary", onClick: handleShow ? function () { return handleShow(row); } : undefined }, "View")),
                enableEdit && (react_1.default.createElement(core_1.Button, { size: "sm", variant: "secondary", onClick: handleEdit ? function () { return handleEdit(row); } : undefined }, "Edit")),
                enableDelete && (react_1.default.createElement(core_1.Button, { size: "sm", variant: "secondary", onClick: handleDelete ? function () { return handleDelete(row); } : undefined }, "Delete"))))), fields === null || fields === void 0 ? void 0 :
