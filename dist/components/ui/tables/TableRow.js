...
var TableRow = function (props) {
  var row = props.row,
    fields = props.fields,
    _a = props.enableEdit,
    enableEdit = _a === void 0 ? false : _a,
    _b = props.enableSelect,
    enableSelect = _b === void 0 ? false : _b,
    handleClick = props.handleClick,
    handleEdit = props.handleEdit,
    selectedIds = props.selectedIds,
    handleSelect = props.handleSelect;
  var selected = (
    selectedIds === null || selectedIds === void 0
      ? void 0
  ...
  return react_1.default.createElement(
    material_1.TableRow,
    { sx: sx.root, selected: selected },
    enableSelect &&
      react_1.default.createElement(
        components_1.TableCell,
        { align: "center", sticky: true },
    ...
    fields === null || fields === void 0
      ...
      : fields.map(function (field, index) {
          ...
          return react_1.default.createElement(
            components_1.TableCell,
            { key: index },
            react_1.default.createElement(components_1.Cell, {
              row: row,
              field: field,
              value: value,
              handleClick: handleClick
                ? function () {
                    return handleClick(value, row, field);
                  }
                : null,
            })
          );
