...
var TableHeaders = function (props) {
    ...
    return (react_1.default.createElement(frontend_shadcn_1.TableRow, null,
        enableSelect && (react_1.default.createElement(components_2.TableCell, { variant: "head", sticky: true, header: true, small: true },
            react_1.default.createElement("div", { className: "mx-2" },
                react_1.default.createElement(components_1.Checkbox, { value: checked, handleChange: handleSelectAll })))),
        (enableEdit || enableDelete || enableShow) && (react_1.default.createElement(components_2.TableCell, { variant: "head", header: true, small: true },
            react_1.default.createElement("div", null))), fields === null || fields === void 0 ? void 0 :
        fields.map(function (field, index) { return (react_1.default.createElement(components_2.TableCell, { header: true, key: index },
            react_1.default.createElement(components_2.CellHeader, { field: field, sortBy: sortBy, sortDirection: sortDirection, handleSort: handleSort }))); })));
};
