...
function CustomTableCell(_a) {
    ...
    var cellClasses = (0, react_2.cn)('px-1 min-w-[100px] bg-background overflow-x-auto whitespace-nowrap max-w-[240px] scrollbar-hide', small && 'min-w-[40px] w-[40px]', sticky && 'sticky left-0 z-20');
