...
var TableCell = function (props) {
    ...
    return (react_1.default.createElement(TableCell_1.default, { variant: variant, align: align, sx: __assign(__assign(__assign(__assign(__assign({}, sx.root), (small && sx.cellSmall)), (sticky && sx.cellSticky)), (header && sx.cellHeader)), (header && sticky && sx.cellStickyHeader)) }, children));
};
