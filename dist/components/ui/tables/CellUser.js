...
var CellUser = function (props) {
    ...
    return (react_1.default.createElement(material_1.Box, { sx: sx.cell },
        react_1.default.createElement(material_1.Button, { sx: sx.button, size: "small", color: "secondary", startIcon: react_1.default.createElement(components_1.UserAvatar, { src: (_a = user === null || user === void 0 ? void 0 : user.avatar) === null || _a === void 0 ? void 0 : _a.url }) },
