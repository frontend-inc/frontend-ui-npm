...
var CellUser = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "w-full flex flex-row justify-start" },
        react_1.default.createElement(core_1.Button, { size: "sm", variant: "secondary", onClick: handleClick, startIcon: react_1.default.createElement(components_1.UserAvatar, { size: 28, user: user }) }, user === null || user === void 0 ? void 0 :
            user.first_name,
