...
var Table = function (props) {
  ...
  var loading = props.loading,
    _b = props.enableBorder,
    enableBorder = _b === void 0 ? true : _b,
    fields = props.fields,
    rows = props.rows,
    _c = props.enableSelect,
    enableSelect = _c === void 0 ? false : _c,
    _d = props.enableEdit,
    enableEdit = _d === void 0 ? false : _d,
    _e = props.enableDelete,
    enableDelete = _e === void 0 ? false : _e,
    handleClick = props.handleClick,
    handleEdit = props.handleEdit,
    handleEditSelected = props.handleEditSelected,
    handleDelete = props.handleDelete,
    handlePublish = props.handlePublish,
    handleUnpublish = props.handleUnpublish,
    secondaryActions = props.secondaryActions,
    query = props.query,
    handleClearQuery = props.handleClearQuery,
    ...
    page = _f === void 0 ? 1 : _f,
    _g = props.numPages,
    numPages = _g === void 0 ? 1 : _g,
    _h = props.totalCount,
    totalCount = _h === void 0 ? 0 : _h,
  ...
  var _k = (0, hooks_1.useSelected)(),
    selected = _k.selected,
    selectedIds = _k.selectedIds,
    setSelected = _k.setSelected,
    setSelectedIds = _k.setSelectedIds,
    handleSelect = _k.handleSelect;
  ...
  return react_1.default.createElement(
    material_1.Box,
    { sx: sx.root },
    react_1.default.createElement(components_1.TableToolbar, {
      loading: loading,
      query: query,
      selected: selected,
    ...
    react_1.default.createElement(
      components_1.TableContainer,
      { styles: styles },
      react_1.default.createElement(components_1.TableHeaders, {
        enableEdit: enableEdit,
      ...
      react_1.default.createElement(
        ...
        null,
        rows === null || rows === void 0
          ? void 0
          : rows.map(function (row) {
              return react_1.default.createElement(components_1.TableRow, {
    ...
    react_1.default.createElement(components_1.Pagination, {
      page: page,
      numPages: numPages,
    ...
    react_1.default.createElement(components_1.FilterPopup, {
      open: showFilters,
      anchorEl: anchorEl,
      query: query,
