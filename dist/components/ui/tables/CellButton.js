...
var CellButton = function (props) {
    ...
    return (react_1.default.createElement(material_1.Box, { sx: sx.cell },
        react_1.default.createElement(material_1.Button, { size: "small", color: "secondary", variant: "contained", sx: sx.button, startIcon: react_1.default.createElement(components_1.Icon, { color: "secondary.contrastText", name: icon }), onClick: handleClick && handleClick }, children)));
};
