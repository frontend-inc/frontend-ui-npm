...
var ProgressLoader = function (props) {
    var _a = props.size, size = _a === void 0 ? 48 : _a, _b = props.styles, styles = _b === void 0 ? {} : _b, _c = props.borderWidth, borderWidth = _c === void 0 ? 4 : _c;
    return (react_1.default.createElement(material_1.Box, { sx: __assign(__assign({}, sx.root), styles) },
        react_1.default.createElement(material_1.Box, { sx: sx.box },
