...
var CheckboxFilter = function (props) {
    ...
    return (react_1.default.createElement(__1.MenuList, { label: label, disablePadding: disablePadding }, BOOLEAN_OPTIONS === null || BOOLEAN_OPTIONS === void 0 ? void 0 : BOOLEAN_OPTIONS.map(function (option, index) { return (react_1.default.createElement(CheckboxFilterItem_1.default, { key: index, values: values, option: option, handleClick: function () {
            return handleClick({
                field: field,
                where: 'OR',
