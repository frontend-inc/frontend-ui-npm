...
var CheckboxFilter = function (props) {
    var label = props.label, field = props.field, _a = props.where, where = _a === void 0 ? 'AND' : _a, _b = props.operator, operator = _b === void 0 ? 'eq' : _b, options = props.options, values = props.values, handleClick = props.handleClick;
