...
var CheckboxFilter = function (props) {
    var label = props.label, name = props.name, options = props.options, values = props.values, handleClick = props.handleClick, _a = props.disablePadding, disablePadding = _a === void 0 ? true : _a, _b = props.defaultClosed, defaultClosed = _b === void 0 ? false : _b;
