...
var CheckboxFilterItem = function (props) {
    ...
    return (react_1.default.createElement("li", { className: "list-none" },
        react_1.default.createElement("button", { className: (0, frontend_shadcn_1.cn)(" rounded-md cursor-pointer hover:bg-muted/20 flex py-1 px-2 items-center w-full border border-input shadow-sm", selected && "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground shadow-md"), onClick: handleClick },
            react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)("w-full flex flex-row space-x-2 items-center justify-between") },
                react_1.default.createElement(core_1.Typography, { variant: "body1", className: (0, frontend_shadcn_1.cn)("font-medium", selected && "text-primary-foreground") }, option === null || option === void 0 ? void 0 : option.label),
