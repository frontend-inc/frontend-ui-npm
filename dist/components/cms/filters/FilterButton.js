...
var FilterGroup = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "w-full flex flex-col space-y-3 p-4 rounded-lg" },
        react_1.default.createElement(components_1.Typography, { variant: "body1", className: "font-medium" }, filterOption === null || filterOption === void 0 ? void 0 : filterOption.label),
