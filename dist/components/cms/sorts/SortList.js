...
var SortList = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(__1.ExpandableList, { label: "Sort by" }, sortOptions === null || sortOptions === void 0 ? void 0 : sortOptions.map(function (sortOption) { return (react_1.default.createElement(material_1.ListItem, { disablePadding: true, disableGutters: true, sx: sx.listItem },
            react_1.default.createElement(material_1.ListItemButton, { sx: sx.listItemButton, disableRipple: true, onClick: function () { return handleSortBy(sortOption); } },
                react_1.default.createElement(material_1.ListItemIcon, { sx: sx.listItemIcon },
                    react_1.default.createElement(material_1.Radio, { checked: sortBy == (sortOption === null || sortOption === void 0 ? void 0 : sortOption.field), onChange: function () { return handleSortBy(sortOption); } })),
        ...
        react_1.default.createElement(__1.ExpandableList, { label: "Direction" }, index_1.SORT_DIRECTIONS.map(function (direction, i) { return (react_1.default.createElement(material_1.ListItem, { disablePadding: true, key: i, sx: sx.listItem },
