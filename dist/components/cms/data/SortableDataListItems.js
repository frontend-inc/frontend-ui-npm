...
var SortableDataListItems = function (props) {
    var _a = (0, frontend_js_1.useResourceContext)(), loading = _a.loading, resources = _a.resources, page = _a.page, numPages = _a.numPages, _b = _a.query, query = _b === void 0 ? {} : _b, setQuery = _a.setQuery, updatePositions = _a.updatePositions, reloadMany = _a.reloadMany;
    ...
    return (react_1.default.createElement(__2.DataLayout, __assign({}, slots.list, { loading: loading }),
        react_1.default.createElement(__1.SortableList, { droppableId: 'sortable', handleDrop: handleDrop, items: resources, renderItem: function (resource) { return (react_1.default.createElement(Component, __assign({}, slots.item, { sortable: true, key: resource === null || resource === void 0 ? void 0 : resource.id, resource: resource, enableShow: enableShow, enableEdit: enableEdit, enableDelete: enableDelete, handleClick: function () { return handleShowClick(resource); }, handleEdit: enableEdit ? function () { return handleEdit(resource); } : undefined, handleDelete: enableDelete ? function () { return handleDeleteClick(resource); } : undefined }))); } }),
