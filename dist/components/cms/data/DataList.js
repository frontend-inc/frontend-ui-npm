...
var DataList = function (props) {
    ...
    var resource = props.resource, enableSearch = props.enableSearch, enableShow = props.enableShow, enableCreate = props.enableCreate, enableEdit = props.enableEdit, enableDelete = props.enableDelete, enableAddReference = props.enableAddReference, enableFilters = props.enableFilters, enableSorting = props.enableSorting, href = props.href, url = props.url, foreignUrl = props.foreignUrl, name = props.name, _a = props.query, query = _a === void 0 ? {} : _a, _b = props.fields, fields = _b === void 0 ? [] : _b, _c = props.filterOptions, filterOptions = _c === void 0 ? [] : _c, _d = props.sortOptions, sortOptions = _d === void 0 ? [] : _d, perPage = props.perPage, emptyIcon = props.emptyIcon, emptyTitle = props.emptyTitle, emptyDescription = props.emptyDescription, _e = props.toolbar, Toolbar = _e === void 0 ? __1.DataToolbar : _e, _f = props.list, List = _f === void 0 ? __1.DataListItems : _f, _g = props.component, Component = _g === void 0 ? __1.DataItem : _g, _h = props.show, Show = _h === void 0 ? __1.DataShow : _h, _j = props.edit, Edit = _j === void 0 ? __1.DataForm : _j, _k = props.create, Create = _k === void 0 ? __1.DataForm : _k, _l = props.destroy, Delete = _l === void 0 ? __1.DataDelete : _l, _m = props.empty, Empty = _m === void 0 ? __1.DataEmpty : _m, _o = props.references, References = _o === void 0 ? __1.DataReferences : _o, _p = props.slots, slots = _p === void 0 ? SLOT_PROPS : _p, loadMore = props.loadMore, rest = __rest(props, ["resource", "enableSearch", "enableShow", "enableCreate", "enableEdit", "enableDelete", "enableAddReference", "enableFilters", "enableSorting", "href", "url", "foreignUrl", "name", "query", "fields", "filterOptions", "sortOptions", "perPage", "emptyIcon", "emptyTitle", "emptyDescription", "toolbar", "list", "component", "show", "edit", "create", "destroy", "empty", "references", "slots", "loadMore"]);
    return (react_1.default.createElement(frontend_js_1.ResourceProvider, { name: name, url: url },
        react_1.default.createElement(__1.DataFetcher, { query: query },
            ...
            react_1.default.createElement(List, __assign({}, rest, { href: href, enableEdit: enableEdit, enableDelete: enableDelete, enableAddReference: enableAddReference, component: Component, slots: {
                    item: slots.item,
                } }, slots.list)),
