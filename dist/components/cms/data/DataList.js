...
var DataList = function (props) {
    ...
    var _a = props.grid, grid = _a === void 0 ? false : _a, selectable = props.selectable, resource = props.resource, enableSearch = props.enableSearch, enableShow = props.enableShow, enableCreate = props.enableCreate, enableEdit = props.enableEdit, enableDelete = props.enableDelete, enableAddToList = props.enableAddToList, enableFilters = props.enableFilters, enableSorting = props.enableSorting, href = props.href, url = props.url, foreignUrl = props.foreignUrl, name = props.name, _b = props.query, query = _b === void 0 ? {} : _b, _c = props.fields, fields = _c === void 0 ? [] : _c, _d = props.filterOptions, filterOptions = _d === void 0 ? [] : _d, _e = props.sortOptions, sortOptions = _e === void 0 ? [] : _e, perPage = props.perPage, emptyIcon = props.emptyIcon, emptyTitle = props.emptyTitle, emptyDescription = props.emptyDescription, _f = props.buttons, buttons = _f === void 0 ? [] : _f, _g = props.toolbar, Toolbar = _g === void 0 ? __1.DataToolbar : _g, _h = props.toolbarModal, ToolbarModal = _h === void 0 ? __1.DataMultiselectToolbar : _h, _j = props.list, List = _j === void 0 ? __1.DataListItems : _j, _k = props.component, Component = _k === void 0 ? __1.DataItem : _k, _l = props.show, Show = _l === void 0 ? __1.DataShow : _l, _m = props.edit, Edit = _m === void 0 ? __1.DataForm : _m, _o = props.create, Create = _o === void 0 ? __1.DataForm : _o, _p = props.destroy, Delete = _p === void 0 ? __1.DataDelete : _p, _q = props.empty, Empty = _q === void 0 ? __1.DataEmpty : _q, _r = props.slots, slots = _r === void 0 ? SLOT_PROPS : _r, loadMore = props.loadMore, rest = __rest(props, ["grid", "selectable", "resource", "enableSearch", "enableShow", "enableCreate", "enableEdit", "enableDelete", "enableAddToList", "enableFilters", "enableSorting", "href", "url", "foreignUrl", "name", "query", "fields", "filterOptions", "sortOptions", "perPage", "emptyIcon", "emptyTitle", "emptyDescription", "buttons", "toolbar", "toolbarModal", "list", "component", "show", "edit", "create", "destroy", "empty", "slots", "loadMore"]);
