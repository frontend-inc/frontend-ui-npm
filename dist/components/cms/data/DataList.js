    ...
    return (react_1.default.createElement(frontend_js_1.ResourceProvider, { name: name, url: url, foreignUrl: foreignUrl },
        react_1.default.createElement(__1.DataFetcher, { query: query },
            react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
                ...
                react_1.default.createElement(List, __assign({ grid: grid, selectable: selectable, href: href, enableEdit: enableEdit, enableDelete: enableDelete, component: Component }, slots.list, { slots: {
                        item: slots.item,
                    } })),
