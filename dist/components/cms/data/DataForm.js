...
var DataForm = function (props) {
    ...
    return (react_1.default.createElement(__1.Sheet, { open: openEdit, handleClose: function () { return setOpenEdit(false); }, title: (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Edit' : 'Add', buttons: react_1.default.createElement(react_2.Button, { variant: "solid", color: "primary", fullWidth: true, onPress: handleSubmit, isLoading: loading }, (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Update' : 'Save') },
