...
var DataForm = function (props) {
    ...
    return (react_1.default.createElement(__1.Sheet, { open: openEdit, handleClose: function () { return setOpenEdit(false); }, title: (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Edit' : 'Add', buttons: react_1.default.createElement(core_1.Button, { fullWidth: true, onClick: handleSubmit, loading: loading }, (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Update' : 'Save') },
