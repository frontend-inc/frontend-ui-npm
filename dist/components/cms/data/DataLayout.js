...
function DataLayout(props) {
    ...
    return (react_1.default.createElement("div", { className: (0, react_2.cn)('w-full', loading && 'opacity-50') },
        layout == 'grid' && (react_1.default.createElement("div", { className: (0, react_2.cn)('w-full gap-6 pb-1 grid grid-cols-[repeat(auto-fill,minmax(240px,1fr))]', gridSize[size]) }, children)),
        layout == 'list' && (react_1.default.createElement("div", { className: "w-full flex flex-col space-y-4" }, children)),
        layout == 'slider' && (react_1.default.createElement(frontend_shadcn_1.ScrollArea, { className: (0, react_2.cn)('w-full whitespace-nowrap pb-4', loading && 'opacity-50') },
