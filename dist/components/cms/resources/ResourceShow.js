...
var ResourceShow = function (props) {
    ...
    return (react_1.default.createElement(ResourceModal_1.default, { title: title, loading: loading, open: open, handleClose: handleClose, enableEdit: enableEdit, enableDelete: enableDelete, handleEdit: handleEdit, handleDelete: handleDelete },
        react_1.default.createElement(ResourceDetails_1.default, { label: resource === null || resource === void 0 ? void 0 : resource.label, image: (_a = resource === null || resource === void 0 ? void 0 : resource.image) === null || _a === void 0 ? void 0 : _a.url, title: resource === null || resource === void 0 ? void 0 : resource.title, subtitle: resource === null || resource === void 0 ? void 0 : resource.subtitle, resource: resource, fields: fields })));
};
