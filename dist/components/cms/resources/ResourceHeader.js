...
var ResourceHeader = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { direction: { xs: 'column', sm: direction }, sx: sx.buttons, spacing: 1 },
        ...
        react_1.default.createElement(material_1.Stack, { direction: "row", spacing: 1, sx: sx.secondaryActions },
            secondaryAction,
            (enableCreate || secondaryAction) && (react_1.default.createElement(material_1.Button, { sx: sx.button, color: "primary", variant: "contained", onClick: handleAdd, startIcon: react_1.default.createElement(__1.Icon, { name: "Plus", color: "primary.contrastText" }) }, "Add")))));
};
