...
var ResourceItem = function (props) {
    var _a;
    var icon = props.icon, color = props.color, avatar = props.avatar, resource = props.resource, handleClick = props.handleClick, handleEdit = props.handleEdit, handleDelete = props.handleDelete, handleSelect = props.handleSelect, handleReload = props.handleReload, secondaryActions = props.secondaryActions, menuActions = props.menuActions, sortable = props.sortable, selectable = props.selectable, selected = props.selected, _b = props.isDragging, isDragging = _b === void 0 ? false : _b, _c = props.enableBorder, enableBorder = _c === void 0 ? false : _c;
    return (react_1.default.createElement(ResourceListItem_1.default, { icon: icon, color: color, avatar: avatar, primary: resource === null || resource === void 0 ? void 0 : resource.title, secondary: (0, helpers_1.truncate)(resource === null || resource === void 0 ? void 0 : resource.description, 60), image: (_a = resource === null || resource === void 0 ? void 0 : resource.image) === null || _a === void 0 ? void 0 : _a.url, handleClick: function () { return handleClick(resource); }, handleEdit: handleEdit, handleDelete: handleDelete, handleSelect: handleSelect, handleReload: handleReload, menuActions: menuActions, secondaryActions: secondaryActions, sortable: sortable, selectable: selectable, selected: selected, isDragging: isDragging, enableBorder: enableBorder }));
};
