...
var ResourceModal = function (props) {
    ...
    return (react_1.default.createElement(__1.Drawer, { open: open, handleClose: handleClose, title: title, disablePadding: disablePadding, buttons: (enableEdit || enableDelete) && (react_1.default.createElement("div", { className: "w-fill flex flex-row space-x-2" },
