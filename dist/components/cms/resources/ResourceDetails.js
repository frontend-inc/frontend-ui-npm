...
var ResourceDetails = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "w-full py-4" },
        react_1.default.createElement("div", { className: "w-full flex flex-col space-y-6" },
            !disableImage && (react_1.default.createElement("div", { className: "flex flex-col space-y-6 w-full" },
            ...
            react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('w-full flex flex-col space-y-6') },
