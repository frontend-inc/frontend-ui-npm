...
function ResourceGridItem(props) {
    var _a = props || {}, selectable = _a.selectable, selected = _a.selected, primary = _a.primary, secondary = _a.secondary, avatar = _a.avatar, label = _a.label, image = _a.image, handleClick = _a.handleClick, handleEdit = _a.handleEdit, handleDelete = _a.handleDelete, handleSelect = _a.handleSelect, secondaryAction = _a.secondaryAction, menuActions = _a.menuActions, _b = _a.slots, slots = _b === void 0 ? {} : _b;
    return (react_1.default.createElement(frontend_shadcn_2.Card, { className: (0, frontend_shadcn_1.cn)('overflow-hidden bg-background', 'border border-transparent', 'border-border hover:shadow-md transition-shadow duration-200', selected && 'border-primary') },
        react_1.default.createElement(frontend_shadcn_2.CardHeader, { className: "w-full p-2 flex flex-row space-x-2 justify-between items-center" },
        ...
        react_1.default.createElement("div", { className: "overflow-hidden h-40 flex items-center justify-center cursor-pointer", onClick: handleClick },
            avatar && avatar,
            image && (react_1.default.createElement(image_1.default, __assign({ src: image, alt: label || 'Resource image', width: 320, height: 160, className: "object-cover w-full h-full" }, slots.image)))),
