...
var ResourceForm = function (props) {
    var _a = props || {}, loading = _a.loading, errors = _a.errors, open = _a.open, handleClose = _a.handleClose, resource = _a.resource, setResource = _a.setResource, handleChange = _a.handleChange, handleRemove = _a.handleRemove, handleSubmit = _a.handleSubmit, _b = _a.fields, fields = _b === void 0 ? [] : _b;
