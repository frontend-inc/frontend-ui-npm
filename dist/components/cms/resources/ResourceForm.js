...
var ResourceForm = function (props) {
    ...
    return (react_1.default.createElement(components_1.Drawer, { open: open, handleClose: handleClose, title: title ? title : (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Edit' : 'Add', buttons: react_1.default.createElement(components_2.Button, { fullWidth: true, onClick: handleSubmit, loading: loading }, (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Update' : 'Save') },
