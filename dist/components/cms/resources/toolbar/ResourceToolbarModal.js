...
function ResourceToolbarModal(props) {
    ...
    return (react_1.default.createElement("div", { className: (0, react_3.cn)(!open && 'hidden', 'dark-dark bg-background', 'fixed top-0 left-0 right-0 z-50 transition-transform duration-300 ease-in-out ') },
