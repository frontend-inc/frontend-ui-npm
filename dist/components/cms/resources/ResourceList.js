    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1, sx: sx.root },
        ...
        react_1.default.createElement(material_1.Box, { sx: __assign({}, (delayedLoading && sx.loading)) },
            react_1.default.createElement(material_1.Stack, { spacing: 2, sx: sx.fullWidth },
                react_1.default.createElement(material_1.Box, { sx: __assign(__assign(__assign({}, sx.layout), (layout == 'grid' ? sx.grid : sx.list)), (dense && sx.listDense)) }, resources === null || resources === void 0 ? void 0 : resources.map(function (resource, index) {
                    var _a;
                    return (react_1.default.createElement(Component, { key: index, title: resource === null || resource === void 0 ? void 0 : resource.title, description: resource === null || resource === void 0 ? void 0 : resource.description, icon: resource === null || resource === void 0 ? void 0 : resource.icon, image: (_a = resource === null || resource === void 0 ? void 0 : resource.image) === null || _a === void 0 ? void 0 : _a.url, color: resource === null || resource === void 0 ? void 0 : resource.color, handleClick: handleClick ?
                            (function () { return handleClick(resource); }) : undefined, handleEdit: enableEdit ?
                            (function () { return handleEdit(resource); }) : undefined, handleDelete: enableDelete ?
                            (function () { return handleDeleteClick(resource); }) : undefined }));
                })))),
