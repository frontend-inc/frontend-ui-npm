...
var DisplayField = function (props) {
    var field = props.field, resource = props.resource, _a = props.disableBorder, disableBorder = _a === void 0 ? false : _a, _b = props.disableLabel, disableLabel = _b === void 0 ? false : _b, _c = props.color, color = _c === void 0 ? 'text.secondary' : _c, rest = __rest(props, ["field", "resource", "disableBorder", "disableLabel", "color"]);
    ...
    if (!value || value == '')
        return null;
    return (react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)(!disableBorder && 'border border-border p-2 rounded-md') },
        react_1.default.createElement(Component, __assign({ label: label, icon: icon, variant: "caption", color: color, value: value, disableLabel: disableLabel }, componentProps, rest))));
};
