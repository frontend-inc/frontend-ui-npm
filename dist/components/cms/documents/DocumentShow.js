        ...
        react_1.default.createElement("div", { className: "flex flex-col space-y-6 pb-[40px] w-full" },
            react_1.default.createElement(__2.BlurFade, { delay: 0.25, inView: true, className: "w-full" },
                react_1.default.createElement("div", { className: "w-full" },
                    react_1.default.createElement(__1.DocumentDetails, { disableImage: disableImage, resource: resource, metafields: metafields, actions: react_1.default.createElement(__1.SocialButtons, { size: "large", justifyContent: 'center', resource: resource, enableLikes: enableLikes, enableFavorites: enableFavorites, enableSharing: enableSharing }) }),
