...
var GeoHeader = function (props) {
    ...
    var _g = (0, hooks_1.useSearch)({
        url: url,
        query: defaultQuery,
    }), query = _g.query, keywords = _g.keywords, handleKeywordChange = _g.handleKeywordChange, location = _g.location, handleLocationChange = _g.handleLocationChange, handleSearch = _g.handleSearch, handleSortBy = _g.handleSortBy, handleSortDirection = _g.handleSortDirection, activeFilters = _g.activeFilters, handleToggleFilter = _g.handleToggleFilter, handleClearFilters = _g.handleClearFilters;
    if (!enableSearch && !enableFilters && !enableSorting) {
        return null;
    }
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-4 mb-4" },
        react_1.default.createElement("div", { className: "flex flex-col sm:flex-row justify-between space-y-4 sm:space-y-0 sm:space-x-4" },
            react_1.default.createElement("div", { className: "flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4" },
