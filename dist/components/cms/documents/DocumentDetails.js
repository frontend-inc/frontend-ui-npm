...
var DocumentDetails = function (props) {
    ...
    var fields = constants_1.DOCUMENT_SHOW_FIELDS[(resource === null || resource === void 0 ? void 0 : resource.content_type) || 'post'];
    ...
    return (react_1.default.createElement("div", { className: "w-full flex flex-col space-y-6" },
        !disableImage && (react_1.default.createElement("div", { className: "w-full flex flex-row justify-center" },
            react_1.default.createElement("div", { className: "w-full max-w-screen-sm" },
...
exports.default = DocumentDetails;
