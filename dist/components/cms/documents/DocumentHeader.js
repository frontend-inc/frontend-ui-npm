    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-1 mb-1" },
        react_1.default.createElement("div", { className: "flex flex-col sm:flex-row justify-between space-y-1 sm:space-y-0 sm:space-x-1" },
            react_1.default.createElement("div", { className: "flex flex-col sm:flex-row items-center space-y-1 sm:space-y-0 sm:space-x-1" },
                enableSearch && !enableGeoSearch && (react_1.default.createElement(__2.SearchInput, { value: keywords, handleChange: handleKeywordChange, handleSearch: handleSearch })),
                enableGeoSearch && !enableSearch && (react_1.default.createElement(__2.GeoSearchInput, { value: keywords, location: location, handleChange: handleKeywordChange, handleLocationChange: handleLocationChange, handleSearch: handleSearch })),
                enableFilters && (react_1.default.createElement("div", { className: "w-full sm:w-auto" },
                    react_1.default.createElement(__2.FilterButton, { filterOptions: filterOptions, filters: activeFilters, handleFilter: handleFilterClick }))),
                enableSorting && (react_1.default.createElement("div", { className: "w-full sm:w-auto" },
                    react_1.default.createElement(__2.SortButton, { sortOptions: sortOptions, sortBy: (query === null || query === void 0 ? void 0 : query.sort_by) || 'id', sortDirection: (query === null || query === void 0 ? void 0 : query.sort_direction) || 'desc', handleSortBy: handleSortBy, handleSortDirection: handleSortDirection })))),
            enableCreate && (react_1.default.createElement("div", { className: "flex flex-col sm:flex-row items-center space-y-1 sm:space-y-0 sm:space-x-1" },
                react_1.default.createElement(__1.Button, { className: (0, frontend_shadcn_1.cn)('w-full sm:w-auto', 'bg-primary text-primary-foreground hover:bg-primary/90'), onClick: handleAdd, startIcon: react_1.default.createElement(react_2.RiAddFill, null) }, buttonText))))));
};
