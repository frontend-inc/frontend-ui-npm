...
var __2 = require("../..");
var __3 = require("../..");
var BlogListItems = function (props) {
    ...
    var selectable = props.selectable, _b = props.layout, layout = _b === void 0 ? 'grid' : _b, _c = props.buttons, buttons = _c === void 0 ? [] : _c, _d = props.style, style = _d === void 0 ? 'card' : _d, handleClick = props.handleClick, _e = props.metafields, metafields = _e === void 0 ? [] : _e, _f = props.enableGradient, enableGradient = _f === void 0 ? false : _f, _g = props.enableOverlay, enableOverlay = _g === void 0 ? false : _g, _h = props.enableFavorites, enableFavorites = _h === void 0 ? false : _h, _j = props.enableLikes, enableLikes = _j === void 0 ? false : _j, _k = props.enableComments, enableComments = _k === void 0 ? false : _k, _l = props.slots, slots = _l === void 0 ? {
        item: {},
    } : _l;
    ...
    var firstPost = resources === null || resources === void 0 ? void 0 : resources[0];
    var remainingPosts = (resources === null || resources === void 0 ? void 0 : resources.slice(1)) || [];
    var firstPostStyle = {
        card: 'card',
        cover: 'cover',
        list: 'card',
