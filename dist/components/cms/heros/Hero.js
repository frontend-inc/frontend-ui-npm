...
var HeroYouTube_1 = __importDefault(require("./addons/HeroYouTube"));
var HeroVimeo_1 = __importDefault(require("./addons/HeroVimeo"));
var __1 = require("../..");
...
var Hero = function (props) {
    ...
    if (handle == 'index')
        handle = undefined;
    var _a = props || {}, _b = _a.style, style = _b === void 0 ? 'article' : _b, _resource = _a.resource, fields = _a.fields, fieldName = _a.fieldName, url = _a.url, actions = _a.actions, enableBorder = _a.enableBorder, enableEdit = _a.enableEdit, enableFavorites = _a.enableFavorites, enableLikes = _a.enableLikes, enableSharing = _a.enableSharing, enableBuyNow = _a.enableBuyNow, enableStripePaymentLink = _a.enableStripePaymentLink;
