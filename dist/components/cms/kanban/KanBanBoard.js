...
var KanBanBoard = function (props) {
    ...
    return (react_1.default.createElement(core_1.DndContext, { sensors: sensors, collisionDetection: core_1.closestCenter, onDragStart: handleDragStart, onDragEnd: handleDragEnd },
                ...
                react_1.default.createElement(material_1.Box, null,
                    ...
                    react_1.default.createElement(sortable_1.SortableContext, { key: header.value, items: (_a = columns[header.value]) === null || _a === void 0 ? void 0 : _a.map(function (res) { return res.id; }), strategy: sortable_1.verticalListSortingStrategy },
                        react_1.default.createElement(material_1.List, { sx: sx.cardList, disablePadding: true },
                            columns[header.value].length > 0 ? ((_b = columns[header.value]) === null || _b === void 0 ? void 0 : _b.map(function (res) { return (react_1.default.createElement(__1.CollectionKanBanCard, { loading: loading && (activeResource === null || activeResource === void 0 ? void 0 : activeResource.id) == (res === null || res === void 0 ? void 0 : res.id), key: res === null || res === void 0 ? void 0 : res.id, id: res === null || res === void 0 ? void 0 : res.id, resource: res, buttons: buttons, displayFields: displayFields, handleClick: function () { return handleClick(res); }, enableOverlay: enableOverlay, enableGradient: enableGradient, enableComments: enableComments, enableFavorites: enableFavorites, enableLikes: enableLikes, enableRatings: enableRatings, enableEdit: enableEdit, enableDelete: enableDelete, handleEdit: function () { return handleEdit(res); }, handleDelete: function () { return handleDelete(res); } })); })) : (react_1.default.createElement(Droppable_1.default, { id: header.value })),
        ...
        react_1.default.createElement(core_1.DragOverlay, null, draggedResource ? (react_1.default.createElement(__1.CollectionKanBanCard, { enableDragging: true, id: draggedResource === null || draggedResource === void 0 ? void 0 : draggedResource.id, resource: draggedResource, displayFields: displayFields, buttons: [], enableRatings: enableRatings, enableFavorites: enableFavorites, enableLikes: enableLikes })) : null)));
