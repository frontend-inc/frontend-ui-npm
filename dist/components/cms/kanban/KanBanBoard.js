            ...
            return (react_1.default.createElement(material_1.Stack, { sx: sx.column, key: header.value, direction: "column", spacing: 1, justifyContent: "space-between" },
                react_1.default.createElement(material_1.Box, null,
                    ...
                    react_1.default.createElement(sortable_1.SortableContext, { key: header.value, items: (_a = columns[header.value]) === null || _a === void 0 ? void 0 : _a.map(function (res) { return res.id; }), strategy: sortable_1.verticalListSortingStrategy },
                        react_1.default.createElement(material_1.List, __assign({ sx: sx.cardList }, slots.list, { disablePadding: true }),
                ...
                enableCreate && (react_1.default.createElement(material_1.Button, { fullWidth: true, variant: "contained", color: "secondary", onClick: function () { return handleAdd(header.value); }, startIcon: react_1.default.createElement(__1.Icon, { name: "Plus", color: "secondary.contrastText" }) }, "Add"))));
        })),
