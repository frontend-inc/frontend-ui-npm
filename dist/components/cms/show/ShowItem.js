...
var ShowItem = function (props) {
    ...
    return (react_1.default.createElement(Component, { image: (_a = resource === null || resource === void 0 ? void 0 : resource.image) === null || _a === void 0 ? void 0 : _a.url, primary: resource === null || resource === void 0 ? void 0 : resource.title, secondary: react_1.default.createElement("div", { className: "w-full flex flex-col space-y-6" },
            ...
            react_1.default.createElement(__1.ExpandableText, { text: resource === null || resource === void 0 ? void 0 : resource.description })), actions: react_1.default.createElement(__1.SocialButtons, { size: "large", justifyContent: 'center', resource: resource, enableLikes: enableLikes, enableFavorites: enableFavorites, enableSharing: enableSharing }), secondaryAction: buttons && (react_1.default.createElement("div", { className: "w-full" },
