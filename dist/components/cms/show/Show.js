...
var Show = function (props) {
    var _a = props || {}, _b = _a.style, style = _b === void 0 ? 'item' : _b, fields = _a.fields, url = _a.url, enableBorder = _a.enableBorder, resource = _a.resource;
    return (react_1.default.createElement(material_1.Stack, { direction: "column", spacing: 4, sx: sx.root },
        style == 'item' && (react_1.default.createElement(Item_1.default, { resource: resource })),
        style == 'article' && (react_1.default.createElement(Article_1.default, { resource: resource })),
        style == 'person' && (react_1.default.createElement(Person_1.default, { resource: resource })),
