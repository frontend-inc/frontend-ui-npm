...
var CollectionFormModal = function (props) {
    ...
    var _b = (0, frontend_js_1.useCollection)(), openDelete = _b.openDelete, setOpenDelete = _b.setOpenDelete, openEdit = _b.openEdit, setOpenFormModal = _b.setOpenFormModal;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(__1.Drawer, { open: openEdit, handleClose: function () { return setOpenFormModal(false); }, title: (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Edit' : 'Add', actions: react_1.default.createElement(material_1.Button, { fullWidth: true, variant: "contained", color: "primary", onClick: handleSubmit, startIcon: react_1.default.createElement(__1.IconLoading, { loading: loading }) }, (resource === null || resource === void 0 ? void 0 : resource.id) ? 'Update' : 'Save') },
