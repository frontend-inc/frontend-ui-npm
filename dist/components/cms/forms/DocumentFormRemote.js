...
var DocumentFormRemote = function (props) {
    ...
    return (react_1.default.createElement(__1.Form, { loading: loading, errors: errors, fields: fields, resource: resource, handleChange: handleChange, handleRemove: handleRemove, handleSubmit: handleSubmit, buttonText: buttonText }));
};
exports.default = DocumentFormRemote;
