...
var FormFields = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1, sx: sx.root }, fields === null || fields === void 0 ? void 0 :
        fields.map(function (field, index) { return (react_1.default.createElement(FormFieldInput_1.default, { key: index, resource: resource, errors: errors, field: field, value: (0, lodash_1.get)(resource, field.name), handleChange: handleChange, handleRemove: handleRemove })); }),
