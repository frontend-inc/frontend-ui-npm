...
var FormFields = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-3 w-full p-1" }, fields === null || fields === void 0 ? void 0 : fields.map(function (field, index) {
