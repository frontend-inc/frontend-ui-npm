...
var FormData = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "w-full flex flex-col space-y-4" },
        react_1.default.createElement(__1.Heading, { title: form === null || form === void 0 ? void 0 : form.title, subtitle: form === null || form === void 0 ? void 0 : form.description, size: "lg", textAlign: "center" }),
        react_1.default.createElement(__1.Form, { errors: errors, loading: loading || responseLoading, resource: contact, 
            //@ts-ignore
            handleChange: handleChange, handleSubmit: handleSubmit, fields: form === null || form === void 0 ? void 0 : form.questions, handleRemove: handleRemove, handleRemoveAttachment: handleRemove, handleAddAttachment: handleAddAttachment, buttonText: buttonText })));
};
