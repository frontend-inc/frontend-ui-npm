...
var SingleChoiceInput = function (props) {
    ...
    return (react_1.default.createElement(MultipleChoiceInput_1.default, { layout: "grid", multiSelect: false, direction: direction, name: name, label: label, value: value, handleChange: handleChange, options: options }));
};
