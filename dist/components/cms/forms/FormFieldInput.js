...
var FormFieldInput = function (props) {
    ...
    var name = field.name, label = field.label, placeholder = field.placeholder, variant = field.variant, options = field.options, url = field.url, foreignUrl = field.foreignUrl, contentType = field.contentType, fields = field.fields;
    return (react_1.default.createElement(FormInput_1.default, { errors: errors, name: name, label: label, placeholder: placeholder, variant: variant, options: options, value: value, handleChange: handleChange, handleRemove: handleRemove, 
        // Reference props 
        url: url, foreignUrl: foreignUrl, resource: resource, contentType: contentType, fields: fields }));
};
