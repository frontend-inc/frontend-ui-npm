...
var FormWizardField = function (props) {
    ...
    return (react_1.default.createElement(material_1.Fade, { in: fadeIn, timeout: 350 },
        react_1.default.createElement(material_1.Stack, { direction: "column", spacing: 3 },
            ...
            field && (react_1.default.createElement(react_1.default.Fragment, null, index_1.SYSTEM_FIELDS.includes(field.name) ? (react_1.default.createElement(FormFieldInput_1.default, { field: field, value: (0, lodash_1.get)(resource, field.name), handleChange: handleChange, handleRemove: handleRemove })) : (react_1.default.createElement(FormFieldInput_1.default, { field: field, value: (0, lodash_1.get)(resource === null || resource === void 0 ? void 0 : resource.data, field.name), handleChange: handleDataChange })))))));
};
