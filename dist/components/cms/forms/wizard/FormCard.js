    ...
    return (react_1.default.createElement("div", { className: "flex flex-col items-center space-y-4" },
        checkMark && (react_1.default.createElement(frontend_shadcn_1.Avatar, null,
            react_1.default.createElement(frontend_shadcn_1.AvatarFallback, { className: "bg-primary" },
                react_1.default.createElement(react_3.RiCheckLine, { size: 28, className: "text-primary-foreground" })))),
        ...
        react_1.default.createElement(components_1.Heading, { title: title, subtitle: subtitle, textAlign: "center" }),
        react_1.default.createElement("div", null,
            react_1.default.createElement(react_2.Button, { onPress: handleClick, variant: "solid", color: "primary" }, buttonText))));
};
