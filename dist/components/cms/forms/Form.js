...
var Form = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1, sx: sx.root },
        ...
        handleSubmit && (react_1.default.createElement(material_1.Button, { size: "medium", variant: "contained", onClick: handleSubmit, disabled: loading, endIcon: loading ? (react_1.default.createElement(__1.IconLoading, { color: "primary.contrastText" })) : null }, buttonText))));
};
