...
var Form = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1, sx: sx.root }, fields === null || fields === void 0 ? void 0 :
        ...
        handleSubmit && (react_1.default.createElement(material_1.Button, { size: "large", variant: "contained", onClick: handleSubmit, disabled: loading, endIcon: react_1.default.createElement(components_1.IconLoading, { color: "primary", loading: loading }) }, buttonText))));
};
