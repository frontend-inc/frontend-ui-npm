...
var FormField = function (props) {
    ...
    var name = field.name, label = field.label, placeholder = field.placeholder, variant = field.variant, options = field.options, displayField = field.displayField, valueParam = field.valueParam, url = field.url;
    return (react_1.default.createElement(FormInput_1.default, { errors: errors, name: name, label: label, placeholder: placeholder, variant: variant, options: options, value: value, handleChange: handleChange, handleRemove: handleRemove, handleAddAttachment: handleAddAttachment, handleRemoveAttachment: handleRemoveAttachment, url: url, displayField: displayField, valueParam: valueParam, inputOptions: inputOptions, inputParams: inputParams }));
};
