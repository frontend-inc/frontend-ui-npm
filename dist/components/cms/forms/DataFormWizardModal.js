...
var DataFormWizard = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "container max-auto max-w-screen-lg" },
        react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
            !submitted ? (react_1.default.createElement(__1.FormCard, { image: (_a = form === null || form === void 0 ? void 0 : form.image) === null || _a === void 0 ? void 0 : _a.url, title: form === null || form === void 0 ? void 0 : form.title, subtitle: form === null || form === void 0 ? void 0 : form.description, buttonText: (form === null || form === void 0 ? void 0 : form.button_text) || 'Get Started', handleClick: function () { return setOpen(true); } })) : (react_1.default.createElement(__1.FormCard, { checkMark: true, title: form === null || form === void 0 ? void 0 : form.end_title, subtitle: form === null || form === void 0 ? void 0 : form.end_description, buttonText: form === null || form === void 0 ? void 0 : form.end_button_text, handleClick: handleResetForm })),
