...
var Details = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "w-full grid" }, document &&
        (displayFields === null || displayFields === void 0 ? void 0 : displayFields.map(function (field, i) { return (react_1.default.createElement("div", { key: i, className: (0, react_2.cn)('grid-span-1', FULL_WIDTH_VARIANTS.includes(field === null || field === void 0 ? void 0 : field.variant)
                ? 'sm:grid-span-3'
                : 'sm:grid-span-1') },
