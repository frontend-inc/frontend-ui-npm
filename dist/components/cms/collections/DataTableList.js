...
var DataTableList = function (props) {
    ...
    return (react_1.default.createElement(__1.ListContainer, { resource: resource, url: url, query: query, filterUser: filterUser, filterTeam: filterTeam, filterRelated: filterRelated, perPage: perPage, fields: fields, enableSearch: enableSearch, enableCreate: enableCreate },
        react_1.default.createElement(__1.DataTableListItems, __assign({}, rest, { url: url }))));
};
