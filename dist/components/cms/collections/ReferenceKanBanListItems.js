...
var ReferenceKanBanListItems = function (props) {
    var _a;
    ...
    var _e = (0, frontend_js_2.useResourceContext)(), loading = _e.loading, resources = _e.resources, update = _e.update, updateMany = _e.updateMany, updatePositions = _e.updatePositions, setResource = _e.setResource, reloadMany = _e.reloadMany, setOpenShow = _e.setOpenShow;
    var handleClick = function (reference) {
    ...
    if (!headers || !fieldName || ((_a = Object.keys(columns)) === null || _a === void 0 ? void 0 : _a.length) == 0)
        return null;
    return (react_1.default.createElement(components_1.KanBanBoard, { loading: loading, columns: columns, headers: headers, handleClick: handleClick, handleDrop: handleDrop, enableEdit: enableEdit, enableDelete: enableEdit, enableCreate: enableCreate, handleEdit: handleEdit, handleDelete: handleDeleteClick, handleAdd: handleAdd, component: components_1.ReferenceCollectionKanBanCard, slots: slots }));
};
exports.default = ReferenceKanBanListItems;
