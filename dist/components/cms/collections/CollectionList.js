...
var CollectionList = function (props) {
    var _a = props || {}, url = _a.url, foreignUrl = _a.foreignUrl, query = _a.query, resource = _a.resource, perPage = _a.perPage, filterUser = _a.filterUser, filterTeam = _a.filterTeam, filterSimilar = _a.filterSimilar, filterGeo = _a.filterGeo, enableLikes = _a.enableLikes, enableFavorites = _a.enableFavorites, enableRatings = _a.enableRatings, enableComments = _a.enableComments, enableUsers = _a.enableUsers, enableGradient = _a.enableGradient, enableOverlay = _a.enableOverlay, style = _a.style, _b = _a.buttons, buttons = _b === void 0 ? [] : _b, _c = _a.displayFields, displayFields = _c === void 0 ? [] : _c, enableShow = _a.enableShow, enableEdit = _a.enableEdit, enableCreate = _a.enableCreate, enableDelete = _a.enableDelete, enableAddReference = _a.enableAddReference, _d = _a.fields, fields = _d === void 0 ? [] : _d, enableSearch = _a.enableSearch, enableFilters = _a.enableFilters, enableSorting = _a.enableSorting, _e = _a.filterOptions, filterOptions = _e === void 0 ? [] : _e, _f = _a.sortOptions, sortOptions = _f === void 0 ? [] : _f, _g = _a.headers, headers = _g === void 0 ? [] : _g, // Used by KanBan
    _h = _a.toolbar, // Used by KanBan
    Toolbar = _h === void 0 ? __1.CollectionToolbar : _h, _j = _a.list, List = _j === void 0 ? __1.CollectionListItems : _j, _k = _a.component, Component = _k === void 0 ? __1.CollectionListItem : _k, _l = _a.show, Show = _l === void 0 ? __1.CollectionShow : _l, _m = _a.edit, Edit = _m === void 0 ? __1.CollectionForm : _m, _o = _a.create, Create = _o === void 0 ? __1.CollectionForm : _o, _p = _a.destroy, Destroy = _p === void 0 ? __1.CollectionDelete : _p, _q = _a.empty, Empty = _q === void 0 ? __1.CollectionEmpty : _q, _r = _a.references, References = _r === void 0 ? __1.CollectionReferences : _r, _s = _a.slots, defaultSlots = _s === void 0 ? {
        toolbar: {},
        list: {},
        item: {},
        show: {},
