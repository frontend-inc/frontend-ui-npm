...
var CarouselView = function (props) {
    var items = props.items, editing = props.editing, buttonText = props.buttonText, handleClick = props.handleClick, _a = props.component, Component = _a === void 0 ? __1.CardVert : _a, _b = props.enableAutoPlay, enableAutoPlay = _b === void 0 ? false : _b, _c = props.enableArrows, enableArrows = _c === void 0 ? false : _c, _d = props.enableDots, enableDots = _d === void 0 ? true : _d, _e = props.enableBorder, enableBorder = _e === void 0 ? false : _e, _f = props.enableGradient, enableGradient = _f === void 0 ? false : _f, _g = props.enableOverlay, enableOverlay = _g === void 0 ? false : _g;
    return (react_1.default.createElement(__1.Carousel, { enableAutoPlay: enableAutoPlay, enableArrows: enableArrows, enableDots: enableDots }, items === null || items === void 0 ? void 0 : items.map(function (item, index) {
        var _a, _b;
