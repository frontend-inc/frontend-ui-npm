...
var CollectionKanBan = function (props) {
    ...
    var url = props.url, searchUrl = props.searchUrl, headers = props.headers, _a = props.fields, fields = _a === void 0 ? [] : _a, _resource = props.resource, _b = props.displayFields, displayFields = _b === void 0 ? [] : _b, _c = props.actions, actions = _c === void 0 ? [] : _c, enableEdit = props.enableEdit, enableDelete = props.enableDelete, enableCreate = props.enableCreate, enableComments = props.enableComments, enableFavorites = props.enableFavorites, enableLikes = props.enableLikes, enableRatings = props.enableRatings, enableSharing = props.enableSharing, enableUsers = props.enableUsers, _d = props.enableSearch, enableSearch = _d === void 0 ? false : _d, _e = props.enableFilters, enableFilters = _e === void 0 ? false : _e, _f = props.enableSorting, enableSorting = _f === void 0 ? false : _f, _g = props.filterOptions, filterOptions = _g === void 0 ? [] : _g, _h = props.sortOptions, sortOptions = _h === void 0 ? [] : _h, _j = props.filterUser, filterUser = _j === void 0 ? false : _j, _k = props.filterTeam, filterTeam = _k === void 0 ? false : _k, enableGradient = props.enableGradient, enableOverlay = props.enableOverlay, emptyIcon = props.emptyIcon, _l = props.emptyTitle, emptyTitle = _l === void 0 ? 'No results found' : _l, _m = props.emptyDescription, emptyDescription = _m === void 0 ? 'Try changing your search or filters.' : _m, rest = __rest(props, ["url", "searchUrl", "headers", "fields", "resource", "displayFields", "actions", "enableEdit", "enableDelete", "enableCreate", "enableComments", "enableFavorites", "enableLikes", "enableRatings", "enableSharing", "enableUsers", "enableSearch", "enableFilters", "enableSorting", "filterOptions", "sortOptions", "filterUser", "filterTeam", "enableGradient", "enableOverlay", "emptyIcon", "emptyTitle", "emptyDescription"]);
    var fieldName = 'status'; //Hard code the field as status
    var _o = (0, frontend_js_1.useDocuments)({
        url: url
    }), loading = _o.loading, delayedLoading = _o.delayedLoading, errors = _o.errors, resource = _o.resource, setResource = _o.setResource, create = _o.create, update = _o.update, destroy = _o.destroy, handleDataChange = _o.handleDataChange, removeAttachment = _o.removeAttachment, addLinks = _o.addLinks, updatePositions = _o.updatePositions;
    var _p = (0, hooks_1.useSearch)({
        url: searchUrl,
        user: currentUser,
        perPage: 1000,
        ...
        query: {},
    }), resources = _p.resources, query = _p.query, keywords = _p.keywords, handleKeywordChange = _p.handleKeywordChange, handleSearch = _p.handleSearch, handleSortBy = _p.handleSortBy, handleSortDirection = _p.handleSortDirection, reloadMany = _p.reloadMany, activeFilters = _p.activeFilters, handleFilter = _p.handleFilter, handleClearFilters = _p.handleClearFilters;
    var _q = (0, react_1.useState)(false), open = _q[0], setOpen = _q[1];
    var _r = (0, react_1.useState)(false), commentsOpen = _r[0], setCommentsOpen = _r[1];
