...
var CollectionKanBan = function (props) {
    ...
    return (react_1.default.createElement(components_1.CollectionContainer, __assign({ url: url, searchUrl: url, component: components_2.KanBan, handleClick: handleClick }, rest)));
};
