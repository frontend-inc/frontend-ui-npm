...
var ShowModal = function (props) {
    ...
    if (!resource)
        return null;
    return (react_1.default.createElement(__1.Sheet, { disablePadding: true, open: openShow, handleClose: function () { return setOpenShow(false); }, title: resource === null || resource === void 0 ? void 0 : resource.title },
        react_1.default.createElement(__1.ShowItem, { style: "snippet", resource: resource, buttons: buttons, displayFields: displayFields, enableLikes: enableLikes, enableFavorites: enableFavorites, enableSharing: enableSharing, slots: {
                image: {
