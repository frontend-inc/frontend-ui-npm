...
var ShowModal = function (props) {
    ...
    var _b = props || {}, _c = _b.buttons, buttons = _c === void 0 ? [] : _c, _d = _b.metafields, metafields = _d === void 0 ? [] : _d, enableComments = _b.enableComments, enableLikes = _b.enableLikes, enableFavorites = _b.enableFavorites, enableSharing = _b.enableSharing;
    if (!resource)
        return null;
