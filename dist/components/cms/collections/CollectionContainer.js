...
var CollectionContainer = function (props) {
    ...
    var _d = props.component, RenderList = _d === void 0 ? components_1.CollectionCards : _d, _resource = props.resource, user = props.user, _e = props.actions, actions = _e === void 0 ? [] : _e, _f = props.style, style = _f === void 0 ? 'card' : _f, href = props.href, url = props.url, searchUrl = props.searchUrl, _g = props.fields, fields = _g === void 0 ? [] : _g, _h = props.displayFields, displayFields = _h === void 0 ? [] : _h, _j = props.filterAnchor, filterAnchor = _j === void 0 ? 'left' : _j, _k = props.filterOptions, filterOptions = _k === void 0 ? [] : _k, _l = props.sortOptions, sortOptions = _l === void 0 ? [] : _l, _m = props.enableGoogleMaps, enableGoogleMaps = _m === void 0 ? false : _m, _o = props.perPage, perPage = _o === void 0 ? 20 : _o, _p = props.enableSearch, enableSearch = _p === void 0 ? false : _p, _q = props.enableFilters, enableFilters = _q === void 0 ? false : _q, _r = props.enableSorting, enableSorting = _r === void 0 ? false : _r, _s = props.enableInfiniteLoad, enableInfiniteLoad = _s === void 0 ? false : _s, _t = props.enableLoadMore, enableLoadMore = _t === void 0 ? true : _t, buttonText = props.buttonText, _u = props.enableBorder, enableBorder = _u === void 0 ? false : _u, _v = props.enableGradient, enableGradient = _v === void 0 ? false : _v, _w = props.enableOverlay, enableOverlay = _w === void 0 ? false : _w, _x = props.enableEdit, enableEdit = _x === void 0 ? false : _x, _y = props.enableCreate, enableCreate = _y === void 0 ? false : _y, _z = props.enableDelete, enableDelete = _z === void 0 ? false : _z, _0 = props.enableFavorites, enableFavorites = _0 === void 0 ? false : _0, _1 = props.enableRatings, enableRatings = _1 === void 0 ? false : _1, _2 = props.enableUsers, enableUsers = _2 === void 0 ? false : _2, _3 = props.filterUser, filterUser = _3 === void 0 ? false : _3, _4 = props.filterTeam, filterTeam = _4 === void 0 ? false : _4, _5 = props.query, defaultQuery = _5 === void 0 ? {} : _5, emptyIcon = props.emptyIcon, _6 = props.emptyTitle, emptyTitle = _6 === void 0 ? 'No results found' : _6, _7 = props.emptyDescription, emptyDescription = _7 === void 0 ? 'Try changing your search or filters.' : _7, rest = __rest(props, ["component", "resource", "user", "actions", "style", "href", "url", "searchUrl", "fields", "displayFields", "filterAnchor", "filterOptions", "sortOptions", "enableGoogleMaps", "perPage", "enableSearch", "enableFilters", "enableSorting", "enableInfiniteLoad", "enableLoadMore", "buttonText", "enableBorder", "enableGradient", "enableOverlay", "enableEdit", "enableCreate", "enableDelete", "enableFavorites", "enableRatings", "enableUsers", "filterUser", "filterTeam", "query", "emptyIcon", "emptyTitle", "emptyDescription"]);
    var _8 = (0, frontend_js_1.useDocuments)({
        url: url,
    }), loading = _8.loading, errors = _8.errors, resource = _8.resource, setResource = _8.setResource, update = _8.update, create = _8.create, destroy = _8.destroy, addLinks = _8.addLinks, removeAttachment = _8.removeAttachment, handleDataChange = _8.handleDataChange, flattenDocument = _8.flattenDocument;
    var _9 = (0, hooks_1.useSearch)({
        url: searchUrl,
        user: user,
        perPage: perPage,
        ...
        query: defaultQuery,
    }), searchLoading = _9.delayedLoading, resources = _9.resources, query = _9.query, reloadMany = _9.reloadMany, page = _9.page, numPages = _9.numPages, loadMore = _9.loadMore, keywords = _9.keywords, handleKeywordChange = _9.handleKeywordChange, handleSearch = _9.handleSearch, handleSortBy = _9.handleSortBy, handleSortDirection = _9.handleSortDirection, activeFilters = _9.activeFilters, handleFilter = _9.handleFilter, handleClearFilters = _9.handleClearFilters;
    ...
    var _10 = props.handleClick, handleClick = _10 === void 0 ? handleNavigate : _10;
    var _11 = (0, react_1.useState)(false), openModal = _11[0], setOpenModal = _11[1];
    var _12 = (0, react_1.useState)(false), openDeleteModal = _12[0], setOpenDeleteModal = _12[1];
