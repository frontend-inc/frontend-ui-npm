...
var ImageListItems = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(material_1.Stack, { direction: "column", spacing: 2 },
            react_1.default.createElement(material_1.Grid, { container: true, spacing: 1 }, resources === null || resources === void 0 ? void 0 : resources.map(function (resource) { return (react_1.default.createElement(material_1.Grid, { item: true, xs: 12, sm: 6, md: 4, lg: 3 },
                react_1.default.createElement(__2.ImageCard, { key: resource.id, resource: resource, enableEdit: enableEdit, enableDelete: enableDelete, enableOverlay: enableOverlay, enableGradient: enableGradient, enableUsers: enableUsers, enableFavorites: enableFavorites, enableComments: enableComments, handleClick: function () { return handleClick(resource); }, handleDelete: function () { return handleDeleteClick(resource); } }))); })),
        ...
        react_1.default.createElement(__2.ShowImageModal, { open: openShow, handleClose: function () { return setOpenShow(false); }, enableGradient: enableGradient })));
};
