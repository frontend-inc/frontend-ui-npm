...
var CollectionTable = function (props) {
    ...
    var _a = (0, frontend_js_1.useQuery)(), loading = _a.loading, resources = _a.resources, findMany = _a.findMany, paginate = _a.paginate, query = _a.query, page = _a.page, perPage = _a.perPage, numPages = _a.numPages, numResults = _a.numResults, totalCount = _a.totalCount;
