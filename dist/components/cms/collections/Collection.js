...
var Collection = function (props) {
    var resource = props.resource, fields = props.fields, enableSearch = props.enableSearch, enableCreate = props.enableCreate, enableFilters = props.enableFilters, enableSorting = props.enableSorting, url = props.url, _a = props.query, query = _a === void 0 ? {} : _a, filterUser = props.filterUser, filterTeam = props.filterTeam, filterRelated = props.filterRelated, filterGeo = props.filterGeo, perPage = props.perPage, rest = __rest(props, ["resource", "fields", "enableSearch", "enableCreate", "enableFilters", "enableSorting", "url", "query", "filterUser", "filterTeam", "filterRelated", "filterGeo", "perPage"]);
