...
var GridViewSkeleton = function (_a) {
    var _b = _a.xs, xs = _b === void 0 ? 12 : _b, _c = _a.sm, sm = _c === void 0 ? 6 : _c, _d = _a.md, md = _d === void 0 ? 4 : _d, _e = _a.lg, lg = _e === void 0 ? 3 : _e, _f = _a.xl, xl = _f === void 0 ? 2 : _f, props = __rest(_a, ["xs", "sm", "md", "lg", "xl"]);
    return (react_1.default.createElement(material_1.Grid, { item: true, xs: xs, sm: sm, md: md, lg: lg, xl: xl },
        react_1.default.createElement(material_1.Card, { elevation: 0, sx: sx.root },
