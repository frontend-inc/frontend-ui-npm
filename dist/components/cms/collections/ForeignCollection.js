...
var ForeignCollection = function (props) {
    var resource = props.resource, url = props.url, fields = props.fields, enableSearch = props.enableSearch, enableCreate = props.enableCreate, filterOptions = props.filterOptions, sortOptions = props.sortOptions, filterUser = props.filterUser, filterTeam = props.filterTeam, perPage = props.perPage, _a = props.query, query = _a === void 0 ? {} : _a, rest = __rest(props, ["resource", "url", "fields", "enableSearch", "enableCreate", "filterOptions", "sortOptions", "filterUser", "filterTeam", "perPage", "query"]);
