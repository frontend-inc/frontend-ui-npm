...
var CarouselList = function (props) {
    ...
    return (react_1.default.createElement(__1.ListContainer, { url: url, query: query, filterUser: filterUser, filterTeam: filterTeam, perPage: perPage, fields: fields, enableSearch: enableSearch, enableCreate: enableCreate, enableFilters: enableFilters, enableSorting: enableSorting },
        react_1.default.createElement(CarouselListItems_1.default, __assign({}, rest, { url: url }))));
};
