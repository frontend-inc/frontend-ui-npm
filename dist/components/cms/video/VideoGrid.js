...
var VideoVert = function (props) {
    var _a = props || {}, actions = _a.actions, resource = _a.resource, _b = _a.objectFit, objectFit = _b === void 0 ? 'cover' : _b, _c = _a.height, height = _c === void 0 ? index_1.VIDEO_HORIZ_HEIGHT : _c, _d = _a.width, width = _d === void 0 ? index_1.VIDEO_HORIZ_WIDTH : _d, _e = _a.enableBorder, enableBorder = _e === void 0 ? false : _e, _f = _a.enableGradient, enableGradient = _f === void 0 ? false : _f, _g = _a.enableOverlay, enableOverlay = _g === void 0 ? false : _g;
