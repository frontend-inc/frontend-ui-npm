...
var ShowModal = function (props) {
    ...
    if (!resource)
        return null;
    return (react_1.default.createElement(__1.Modal, { disablePadding: true, open: open, handleClose: handleClose, maxWidth: "sm" },
        react_1.default.createElement(material_1.Box, { px: 2, pb: 2 },
            react_1.default.createElement(__1.ShowSnippet, { resource: resource, enableEdit: enableEdit, actions: actions, displayFields: displayFields, enableRatings: enableRatings, enablePayments: enablePayments, handleEdit: handleEdit, enableLikes: enableLikes, enableFavorites: enableFavorites, enableSharing: enableSharing }),
