...
var Button = (0, react_1.forwardRef)(function (_a, ref) {
    var _b = _a.size, size = _b === void 0 ? 'default' : _b, _c = _a.variant, variant = _c === void 0 ? 'default' : _c, fullWidth = _a.fullWidth, className = _a.className, children = _a.children, startIcon = _a.startIcon, endIcon = _a.endIcon, _d = _a.loading, loading = _d === void 0 ? false : _d, disabled = _a.disabled, props = __rest(_a, ["size", "variant", "fullWidth", "className", "children", "startIcon", "endIcon", "loading", "disabled"]);
