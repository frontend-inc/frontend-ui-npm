...
function TextField(_a) {
    ...
    return (react_1.default.createElement("div", { className: (0, frontend_shadcn_3.cn)('flex flex-col space-y-2', fullWidth && 'w-full') },
        label && (react_1.default.createElement(frontend_shadcn_2.Label, { htmlFor: inputId, className: (0, frontend_shadcn_3.cn)('text-sm font-medium', error ? 'text-destructive' : 'text-foreground') }, label)),
        react_1.default.createElement(frontend_shadcn_1.Input, { id: inputId, name: name, value: value, onChange: handleChange, type: type, placeholder: placeholder, className: (0, frontend_shadcn_3.cn)('text-foreground', 'transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2', error && 'border-destructive focus:ring-destructive', fullWidth && 'w-full', className) }),
