...
var Slider = react_1.default.forwardRef(function (_a, ref) {
    ...
    return (react_1.default.createElement("div", { ref: ref, className: (0, react_2.cn)('space-y-2', className) },
        ...
        react_1.default.createElement(frontend_shadcn_1.Slider, { id: name, name: name, min: min, max: max, step: step, value: value, onValueChange: handleChange, disabled: disabled, className: (0, react_2.cn)('w-full', disabled && 'opacity-50 cursor-not-allowed') }),
