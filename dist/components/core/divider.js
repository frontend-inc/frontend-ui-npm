...
var Divider = function (_a) {
    ...
    var dividerClasses = (0, react_2.cn)('bg-border', isVertical ? 'h-auto w-px' : 'h-px w-full', variant === 'inset' && 'mx-4', variant === 'middle' && 'mx-2', hasChildren && 'flex items-center', isVertical && hasChildren && 'flex-col', className);
    var childWrapperClasses = (0, react_2.cn)('px-2', isVertical ? 'py-4' : '');
    if (hasChildren) {
