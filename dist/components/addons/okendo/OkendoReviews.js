...
var OkendoReviews = function (props) {
  var _a = props || {},
    handle = _a.handle,
    subscriberId = _a.subscriberId;
  var _b = (0, webstudio_shopify_2.useProducts)(),
    loading = _b.loading,
    product = _b.product,
    fetchProduct = _b.fetchProduct;
  ...
  (0, react_1.useEffect)(
    ...
    [
      ...
      widgetContainer === null || widgetContainer === void 0
        ? void 0
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement("div", {
      ref: widgetContainer,
      "data-oke-widget": true,
      "data-oke-reviews-product-id": "shopify-".concat(
        (0, webstudio_shopify_1.getShopifyIdFromGid)(
          product === null || product === void 0 ? void 0 : product.id
        )
      ),
    })
