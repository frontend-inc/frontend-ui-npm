...
var OkendoStarRating = function (props) {
    ...
    if (!(product === null || product === void 0 ? void 0 : product.id))
        return null;
    return (react_1.default.createElement("div", { style: { color: (_a = theme === null || theme === void 0 ? void 0 : theme.palette) === null || _a === void 0 ? void 0 : _a.text.secondary }, ref: widgetContainer, "data-oke-star-rating": true, "data-oke-reviews-product-id": "shopify-".concat((0, frontend_shopify_1.getShopifyIdFromGid)(product === null || product === void 0 ? void 0 : product.id)) }));
};
