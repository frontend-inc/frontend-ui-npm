...
var UnsplashLogo = function (props) {
    var _a = props || {}, className = _a.className, _b = _a.width, width = _b === void 0 ? 80 : _b;
    return (react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 456 100", width: width, height: (width * 100) / 456, className: className, "aria-label": "Unsplash logo" },
