...
var UnplashCard = function (_a) {
    ...
    return (react_1.default.createElement(frontend_shadcn_2.Card, { className: (0, frontend_shadcn_3.cn)('cursor-pointer rounded bg-background border border-border p-0 min-w-[240px]', selected && 'border-primary') },
        react_1.default.createElement(frontend_shadcn_1.CardContent, { className: "p-0" },
            react_1.default.createElement(components_1.Image, { height: 200, width: 200, src: (_b = image === null || image === void 0 ? void 0 : image.urls) === null || _b === void 0 ? void 0 : _b.regular, alt: image === null || image === void 0 ? void 0 : image.alt_description, objectFit: "cover", disableBorderRadius: true, handleClick: function () { return handleClick && handleClick(image); } }),
            react_1.default.createElement("div", { className: "p-3 w-full" },
