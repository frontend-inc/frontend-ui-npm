...
function SidebarMenuItem(_a) {
    var _b = _a.selected, selected = _b === void 0 ? false : _b, title = _a.title, _c = _a.color, color = _c === void 0 ? 'bg-transparent' : _c, icon = _a.icon, secondaryAction = _a.secondaryAction, handleClick = _a.handleClick, handleEdit = _a.handleEdit, handleDelete = _a.handleDelete;
    return (react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('group flex items-center rounded-md justify-between hover:bg-muted', selected && 'bg-muted text-foreground') },
        react_1.default.createElement("button", { onClick: handleClick, className: "w-full flex gap-2 py-3 pl-4 px-2 rounded-md group items-center focus:outline-none" },
