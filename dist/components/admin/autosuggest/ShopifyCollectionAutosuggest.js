...
var CollectionAutosuggest = function (props) {
    ...
    return (react_1.default.createElement(components_1.Autosuggest, { label: label, name: name, value: value, options: options, placeholder: placeholder, direction: direction, handleChange: handleChange, enableClear: true }));
};
