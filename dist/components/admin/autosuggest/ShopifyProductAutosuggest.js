...
var ShopifyProductAutosuggest = function (props) {
    var value = props.value, label = props.label, _a = props.direction, direction = _a === void 0 ? 'column' : _a, placeholder = props.placeholder, _b = props.name, name = _b === void 0 ? 'shopify_handle' : _b, handleChange = props.handleChange;
    var _c = (0, frontend_shopify_1.useProducts)(), products = _c.products, findProducts = _c.findProducts;
    ...
    return (react_1.default.createElement(components_1.Autosuggest, { label: label, name: name, value: value, options: options, placeholder: placeholder, direction: direction, handleChange: handleChange, handleInputChange: handleInputChange, enableClear: true }));
};
