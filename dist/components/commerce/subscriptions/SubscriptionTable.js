...
var SubscriptionTable = function () {
    ...
    var _c = (0, react_1.useContext)(context_1.AppContext), setCreditCardOpen = _c.setCreditCardOpen, setAuthOpen = _c.setAuthOpen;
    var _d = (0, react_1.useState)(false), openSubscribeModel = _d[0], setOpenSubscribeModal = _d[1];
    var _e = (0, react_1.useState)(false), openUnsubscribeModal = _e[0], setOpenUnsubscribeModal = _e[1];
    var _f = (0, react_1.useState)(null), activeSubscriptionTable = _f[0], setActiveSubscriptionTable = _f[1];
    var handleSubscribe = function () { return __awaiter(void 0, void 0, void 0, function () {
        var resp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(activeSubscriptionTable === null || activeSubscriptionTable === void 0 ? void 0 : activeSubscriptionTable.id)) return [3 /*break*/, 2];
                    return [4 /*yield*/, subscribe(activeSubscriptionTable === null || activeSubscriptionTable === void 0 ? void 0 : activeSubscriptionTable.id)];
                case 1:
                    resp = _a.sent();
                    _a.label = 2;
                case 2:
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(material_1.Stack, { sx: sx.footerLinks, direction: 'row', my: 2, spacing: 1, divider: react_1.default.createElement(material_1.Box, { sx: sx.divider }) },
            (currentUser === null || currentUser === void 0 ? void 0 : currentUser.id) && (react_1.default.createElement(material_1.Link, { sx: sx.cancelLink, color: "text.secondary", onClick: function () { return setCreditCardOpen(true); } }, "Payment Methods")),
            !loading && (currentUser === null || currentUser === void 0 ? void 0 : currentUser.stripe_subscription_id) && (react_1.default.createElement(material_1.Link, { sx: sx.cancelLink, color: "text.secondary", onClick: handleUnsubscribeClick }, "Cancel Subscription"))),
