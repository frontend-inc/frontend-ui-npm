...
var TopNavStripeCustomerButtonButton = function (props) {
...
var SideNavStripeCustomerButtonButton = function (props) {
    var handleClick = props.handleClick, icon = props.icon;
...
var StripeCustomerButton = function (props) {
    var _a = props || {}, _b = _a.icon, icon = _b === void 0 ? 'CreditCard' : _b, _c = _a.variant, variant = _c === void 0 ? 'topNav' : _c;
    var stripeCustomerPortalUrl = (0, react_1.useContext)(context_1.StripeContext).stripeCustomerPortalUrl;
    ...
    if (!stripeCustomerPortalUrl)
        return null;
    return variant == 'topNav' ? (react_1.default.createElement(TopNavStripeCustomerButtonButton, { icon: icon, handleClick: handleClick })) : (react_1.default.createElement(SideNavStripeCustomerButtonButton, { icon: icon, handleClick: handleClick }));
};
exports.default = StripeCustomerButton;
var sx = {
    listItemButton: {
        px: 1,
    },
