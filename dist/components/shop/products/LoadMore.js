...
var LoadMore = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-row w-full justify-center items-center" },
        react_1.default.createElement(components_1.Button, { color: "secondary", onClick: handlePaginate, endIcon: react_1.default.createElement(components_2.RemixIcon, { name: "ri-arrow-down-line" }) }, "Load More")));
};
