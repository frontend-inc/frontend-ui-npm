...
var __1 = require("../..");
var SortableRelatedProductList = function (props) {
    ...
    return (react_1.default.createElement(__1.ProductList, __assign({}, props, { url: url, resource: resource, list: __1.SortableRelatedProductListItems, component: __1.ProductListItem, query: __assign(__assign({}, query), { sort_by: 'position', sort_direction: 'asc' }), slots: __assign(__assign({}, slots), { item: __assign(__assign({}, slots.item), { sortable: true }) }) })));
};
exports.default = SortableRelatedProductList;
