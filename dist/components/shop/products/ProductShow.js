...
var ShowModal = function (props) {
    ...
    var _b = props || {}, _c = _b.buttons, buttons = _c === void 0 ? [] : _c, _d = _b.displayFields, displayFields = _d === void 0 ? [] : _d, enableComments = _b.enableComments, enableRatings = _b.enableRatings, enableLikes = _b.enableLikes, enableFavorites = _b.enableFavorites, enableSharing = _b.enableSharing, enablePayments = _b.enablePayments, enableAddToList = _b.enableAddToList, enableEdit = _b.enableEdit, handleEdit = _b.handleEdit;
    if (!resource)
        return null;
