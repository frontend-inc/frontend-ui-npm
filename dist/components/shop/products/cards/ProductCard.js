...
var ProductCard = function (props) {
    var _a = props || {}, ref = _a.ref, label = _a.label, primary = _a.primary, secondary = _a.secondary, price = _a.price, compareAtPrice = _a.compareAtPrice, actions = _a.actions, secondaryAction = _a.secondaryAction, handleClick = _a.handleClick, image = _a.image, _b = _a.height, height = _b === void 0 ? 240 : _b, _c = _a.slots, slots = _c === void 0 ? {
        item: {},
        image: {},
    } : _c;
