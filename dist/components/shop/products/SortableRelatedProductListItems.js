...
var SortableRelatedListItems = function (props) {
    ...
    var handleShowClick = function (resource) {
        var relatedProduct = resource === null || resource === void 0 ? void 0 : resource.relatedProduct;
        if (handleClick) {
...
exports.default = SortableRelatedListItems;
