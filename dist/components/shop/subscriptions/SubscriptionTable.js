...
var SubscriptionTable = function () {
    ...
    var handleSubscribe = function (subscription) { return __awaiter(void 0, void 0, void 0, function () {
        var currentUrl, resp;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(material_1.Stack, { sx: __assign(__assign({}, sx.table), (loading && sx.loading)), direction: { xs: 'column', sm: 'row' }, spacing: 2 }, subscriptions === null || subscriptions === void 0 ? void 0 : subscriptions.map(function (subscription) {
            ...
            return (react_1.default.createElement(SubscriptionTableCard_1.default, { key: subscription.id, selected: selected, 
                //@ts-ignore
                subscription: subscription, handleClick: function () { return handleSubscribe(subscription); } }));
        })),
