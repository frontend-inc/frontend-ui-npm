...
var CreditCards = function () {
    var stripePublishableKey = (0, react_1.useContext)(context_1.StripeContext).stripePublishableKey;
        ...
        !isEditing ? (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement(material_1.List, null, !loading &&
                (creditCards === null || creditCards === void 0 ? void 0 : creditCards.map(function (creditCard) {
                    ...
                    return (react_1.default.createElement(__1.SelectableListItem, { key: creditCard.id, selected: selected, icon: 'CreditCard', title: creditCard.last4, description: creditCard.brand, handleClick: function () { return handleClick(creditCard); }, handleDelete: selected ? undefined : function () { return handleDeleteClick(creditCard); } }));
                }))),
            !loading && !(creditCards === null || creditCards === void 0 ? void 0 : creditCards.length) && (react_1.default.createElement(__1.Placeholder, { icon: "CreditCard", title: "No Credit Cards", description: "Add a credit card to get started" })),
            ...
            react_1.default.createElement(__1.StripeCreditCard, { publishableKey: stripePublishableKey, handleSubmit: handleSubmit, handleCancel: function () { return setIsEditing(false); } }))),
        react_1.default.createElement(__1.AlertModal, { open: openDeleteModal, title: "Delete Credit Card", description: "Are you sure you want to delete this credit card?", handleConfirm: handleDelete, handleClose: function () { return setOpenDeleteModal(false); } })));
};
