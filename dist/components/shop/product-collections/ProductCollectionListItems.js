...
var __2 = require("../..");
var ProductCollectionListItems = function (props) {
    ...
    var _b = props.layout, layout = _b === void 0 ? 'list' : _b, _c = props.buttons, buttons = _c === void 0 ? [] : _c, _d = props.style, style = _d === void 0 ? 'list' : _d, handleClick = props.handleClick, _e = props.displayFields, displayFields = _e === void 0 ? [] : _e, _f = props.enableGradient, enableGradient = _f === void 0 ? false : _f, _g = props.enableOverlay, enableOverlay = _g === void 0 ? false : _g, _h = props.enableFavorites, enableFavorites = _h === void 0 ? false : _h, _j = props.enableLikes, enableLikes = _j === void 0 ? false : _j, _k = props.enableRatings, enableRatings = _k === void 0 ? false : _k, _l = props.slots, slots = _l === void 0 ? {
        item: {},
    } : _l;
