...
var ProductCollectionList = function (props) {
    ...
    return (react_1.default.createElement(components_1.DataList, { grid: true, url: url, foreignUrl: foreignUrl, name: "product_collection", fields: [], query: __assign(__assign({}, query), { sort_by: 'position', sort_direction: 'asc' }), enableSearch: enableSearch, enableFilters: enableFilters, enableSorting: enableSorting, filterOptions: filterOptions, sortOptions: sortOptions, component: Component, slots: slots }));
};
