...
var ProductCollectionList = function (props) {
    ...
    return (react_1.default.createElement(components_1.DataList, { layout: "grid", url: "".concat(apiUrl, "/shop/product_collections"), name: "product_collection", fields: [], query: __assign(__assign({}, query), { sort_by: 'position', sort_direction: 'asc' }), enableSearch: enableSearch, enableFilters: enableFilters, enableSorting: enableSorting, filterOptions: filterOptions, sortOptions: sortOptions, list: __1.ProductCollectionListItems, show: __1.ProductCollectionShow, component: __1.ProductCollectionListItem, slots: slots }));
};
