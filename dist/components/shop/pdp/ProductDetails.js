...
var ProductDetails = function (props) {
    ...
    if (!(product === null || product === void 0 ? void 0 : product.id))
        return null;
    return (react_1.default.createElement(__1.PDP, { direction: direction, image: (_a = product === null || product === void 0 ? void 0 : product.image) === null || _a === void 0 ? void 0 : _a.url, primary: product === null || product === void 0 ? void 0 : product.title, price: product === null || product === void 0 ? void 0 : product.display_price, compareAtPrice: product === null || product === void 0 ? void 0 : product.display_compare_at_price, description: product === null || product === void 0 ? void 0 : product.description, secondary: react_1.default.createElement("div", { className: "w-full" }, enableRatings == true && (react_1.default.createElement(__2.ProductRating, { resource: product, enableTotal: true }))), actions: react_1.default.createElement(__2.SocialButtons, { size: "large", justifyContent: 'center', resource: product, product: product, enableProductLikes: enableLikes, enableProductFavorites: enableFavorites, enableSharing: enableSharing }), addToCart: product.recurring ?
            react_1.default.createElement(__2.SubscribeButton, { availableForSale: true, size: "lg", productId: product === null || product === void 0 ? void 0 : product.id, className: "max-w-[360px]" }) :
            react_1.default.createElement(__2.AddToCartButton, { availableForSale: true, size: "lg", productId: product === null || product === void 0 ? void 0 : product.id, className: "max-w-[360px]" }), slots: slots }));
};
