...
var CartLineItems = function () {
    ...
    return (react_1.default.createElement(material_1.List, null, cart === null || cart === void 0 ? void 0 : cart.line_items.map(function (lineItem) { return (react_1.default.createElement(CartLineItem_1.default, { key: lineItem.id, lineItem: lineItem })); })));
};
