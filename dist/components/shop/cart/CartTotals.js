...
var CartTotals = function () {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-row space-x-2 justify-between" },
        react_1.default.createElement(core_1.Typography, { variant: "caption" }, "Subtotal"),
        react_1.default.createElement(core_1.Typography, { variant: "subtitle2" }, cart === null || cart === void 0 ? void 0 : cart.display_subtotal)));
};
