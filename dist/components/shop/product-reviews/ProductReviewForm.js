...
var ProductReviewForm = function (props) {
        ...
        react_1.default.createElement(__1.AuthGuard, null,
            react_1.default.createElement(material_1.ListItem, { disableGutters: true },
                react_1.default.createElement(material_1.Stack, { sx: sx.form, direction: "column", spacing: 1 },
                    react_1.default.createElement(__1.RatingInput, { errors: errors, name: "rating", value: resource === null || resource === void 0 ? void 0 : resource.rating, handleChange: handleChange }),
                    react_1.default.createElement(__1.TextInput, { errors: errors, name: "title", value: resource === null || resource === void 0 ? void 0 : resource.title, handleChange: handleChange, placeholder: "Review summary..." }),
                    react_1.default.createElement(__1.TextInput, { errors: errors, multiline: true, rows: 4, name: "body", value: resource === null || resource === void 0 ? void 0 : resource.body, handleChange: handleChange, placeholder: "Leave a review..." }))))));
};
