...
var Feed = function (props) {
    ...
    var socialUrl = "".concat(url, "/social_feed");
    return (react_1.default.createElement(__1.CollectionContainer, { url: socialUrl, query: query, filterUser: filterUser, filterTeam: filterTeam, perPage: perPage, fields: fields, enableSearch: enableSearch, enableCreate: enableCreate, filterOptions: filterOptions, sortOptions: sortOptions },
