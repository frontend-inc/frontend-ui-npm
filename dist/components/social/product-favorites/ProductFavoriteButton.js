...
var ProductFavoriteButton = function (props) {
    var product = props.product, _a = props.size, size = _a === void 0 ? 'small' : _a, _b = props.color, color = _b === void 0 ? 'text.secondary' : _b, numFavorites = props.numFavorites;
    ...
    (0, react_1.useEffect)(function () {
        if (currentUser && (product === null || product === void 0 ? void 0 : product.handle)) {
            if ((0, helpers_1.isProductFavorited)(currentUser, product === null || product === void 0 ? void 0 : product.handle)) {
                setIsFavorite(true);
            }
            else {
                setIsFavorite(false);
