...
var Reviews = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1, sx: sx.root },
        react_1.default.createElement(material_1.Stack, { direction: "row", sx: sx.reviewHeader },
            react_1.default.createElement(material_1.Typography, { color: "text.primary", variant: "h6" },
                "Reviews (",
                totalCount,
                ")")),
        ...
        !loading && !openReview && (reviews === null || reviews === void 0 ? void 0 : reviews.length) == 0 && (react_1.default.createElement(components_1.Placeholder, { icon: "MessageSquare", title: "There are no reviews.", description: "Be the first to leave a review." })),
