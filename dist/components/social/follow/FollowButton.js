...
var FollowButton = function (props) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!following) return [3 /*break*/, 2];
                    setFollowing(false);
                    return [4 /*yield*/, unfollow(user === null || user === void 0 ? void 0 : user.username)];
                case 1:
                    _a.sent();
                    fetchMe();
                    return [3 /*break*/, 4];
                case 2:
                    setFollowing(true);
                    return [4 /*yield*/, follow(user === null || user === void 0 ? void 0 : user.username)];
                case 3:
                    _a.sent();
                    fetchMe();
                    _a.label = 4;
    ...
    (0, react_1.useEffect)(function () {
        if (currentUser && user) {
            if ((0, helpers_1.isFollowing)(currentUser, user)) {
                setFollowing(true);
            }
            else {
                setFollowing(false);
