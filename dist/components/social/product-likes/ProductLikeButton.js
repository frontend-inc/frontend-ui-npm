...
var ProductLikeButton = function (props) {
    var product = props.product, _a = props.color, color = _a === void 0 ? 'text.secondary' : _a, _b = props.size, size = _b === void 0 ? 'small' : _b;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLiked(false);
                    return [4 /*yield*/, unlikeProduct(product === null || product === void 0 ? void 0 : product.handle)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2:
                    setLiked(true);
                    return [4 /*yield*/, likeProduct(product === null || product === void 0 ? void 0 : product.handle)];
                case 3:
                    _a.sent();
                    _a.label = 4;
    ...
    (0, react_1.useEffect)(function () {
        if (currentUser && (product === null || product === void 0 ? void 0 : product.handle)) {
            if ((0, helpers_1.isProductLiked)(currentUser, product === null || product === void 0 ? void 0 : product.handle)) {
                setLiked(true);
            }
            else {
                setLiked(false);
