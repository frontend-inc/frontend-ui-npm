...
var ShimmerButton = react_1.default.forwardRef(function (_a, ref) {
    ...
    return (react_1.default.createElement("button", __assign({ style: {
            ...
            '--cut': shimmerSize,
            '--bg': background,
        }, className: (0, react_2.cn)('group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/10 px-6 py-3 text-white [background:var(--bg)] [border-radius:var(--radius)] dark:text-black', 'transform-gpu transition-transform duration-300 ease-in-out active:translate-y-px', className), ref: ref }, props),
        react_1.default.createElement("div", { className: (0, react_2.cn)('-z-30 blur-[2px]', 'absolute inset-0 overflow-visible [container-type:size]') },
        ...
        children,
        react_1.default.createElement("div", { className: (0, react_2.cn)('insert-0 absolute size-full', 'rounded-2xl px-4 py-1.5 text-sm font-medium shadow-[inset_0_-8px_10px_#ffffff1f]', 
            // transition
        ...
        react_1.default.createElement("div", { className: (0, react_2.cn)('absolute -z-20 [background:var(--bg)] [border-radius:var(--radius)] [inset:var(--cut)]') })));
});
