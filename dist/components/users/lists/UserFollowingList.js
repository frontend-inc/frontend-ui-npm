...
var UserFollowingList = function (props) {
    ...
    return (react_1.default.createElement(__1.ResourceList, { enableSearch: true, enableLoadMore: true, name: "user", url: "/api/v1/cms/users/".concat(user === null || user === void 0 ? void 0 : user.username, "/following"), component: UserListItem_1.default, itemProps: {
            size: 72,
