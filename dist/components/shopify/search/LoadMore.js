...
var LoadMore = function (props) {
    ...
    return (react_1.default.createElement(material_1.Box, { sx: sx.loadMoreContainer },
        react_1.default.createElement(material_1.Button, { variant: "contained", color: "secondary", onClick: handleSearch, disabled: loading, endIcon: react_1.default.createElement(components_1.Icon, { name: "ChevronDown", color: "secondary.contrastText" }) }, "Load More")));
};
