...
function LoadMore(_a) {
    ...
    return (react_1.default.createElement("div", { className: "flex justify-center w-full" },
        react_1.default.createElement(core_1.Button, { loading: loading, color: "secondary", onClick: handleSearch, disabled: loading, endIcon: react_1.default.createElement(lucide_react_1.ChevronDown, { className: "h-4 w-4" }) }, "Load More")));
}
