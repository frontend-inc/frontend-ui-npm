...
var LoadMore_1 = __importDefault(
  require("../../../components/shopify/search/LoadMore")
);
...
var Search = function (props) {
  ...
  if (query == "all") query = "";
  var _a = (0, react_1.useState)(String(query).toLowerCase()),
    keywords = _a[0],
    setKeywords = _a[1];
  var first = PER_PAGE;
  var shopUrl = (0, react_1.useContext)(
    webstudio_shopify_2.ShopContext
  ).shopUrl;
  var _b = (0, webstudio_shopify_1.useProducts)(),
    loading = _b.loading,
    errors = _b.errors,
    cursor = _b.cursor,
    hasNextPage = _b.hasNextPage,
    products = _b.products,
    fetchProducts = _b.fetchProducts,
    searchProducts = _b.searchProducts;
  ...
  var handleSearch = function (keywords) {
    ...
    router.push(
      "".concat(shopUrl, "/search/").concat(keywords.split(" ").join("-"))
    );
  };
  ...
  (0, react_1.useEffect)(
    function () {
      ...
      if ((query === null || query === void 0 ? void 0 : query.length) > 0) {
        var searchKeywords =
          (_a = decodeURI(String(query)).split("-")) === null || _a === void 0
            ? void 0
            : _a.join(" ");
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(LoadMore_1.default, {
      loading: loading,
      hasNextPage: hasNextPage,
      handleSearch: function () {
        return handleLoadMore(cursor);
      },
    })
  );
};
