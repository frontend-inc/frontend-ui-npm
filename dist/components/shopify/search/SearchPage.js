...
var Search = function () {
    ...
    var first = PER_PAGE;
    var shopUrl = (0, react_1.useContext)(shopify_3.ShopContext).shopUrl;
    var _b = (0, shopify_1.useProducts)(), loading = _b.loading, errors = _b.errors, cursor = _b.cursor, hasNextPage = _b.hasNextPage, products = _b.products, fetchProducts = _b.fetchProducts, searchProducts = _b.searchProducts;
    ...
    return (react_1.default.createElement(material_1.Box, { sx: sx.root },
        ...
        (products === null || products === void 0 ? void 0 : products.length) > 0 && (react_1.default.createElement(shopify_2.ProductGrid, { loading: loading, products: products })),
