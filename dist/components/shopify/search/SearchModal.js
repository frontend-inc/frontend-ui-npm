...
var SearchModal = function () {
  ...
  var _a = (0, react_1.useContext)(webstudio_shopify_1.ShopContext),
    setMenuOpen = _a.setMenuOpen,
    searchOpen = _a.searchOpen,
    setSearchOpen = _a.setSearchOpen;
  ...
  var _c = (0, react_1.useState)(""),
    keywords = _c[0],
    setKeywords = _c[1];
  var _d = (0, webstudio_shopify_2.useProducts)(),
    loading = _d.loading,
    products = _d.products,
    setProducts = _d.setProducts,
    searchProducts = _d.searchProducts;
  ...
  var handleSearch = function () {
    if (
      (keywords === null || keywords === void 0 ? void 0 : keywords.length) >=
      MIN_ANALYTICS_CHARS
    ) {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      material_1.Box,
      {
        sx: __assign(__assign({}, sx.container), expanded && sx.expandedModal),
      },
      react_1.default.createElement(
        material_1.AppBar,
        { elevation: 0, position: "sticky", color: "transparent" },
        react_1.default.createElement(
          material_1.Stack,
          { sx: sx.searchContainer, direction: "row", spacing: 1 },
      ...
      react_1.default.createElement(
        ...
        (keywords === null || keywords === void 0 ? void 0 : keywords.length) >
          ...
          react_1.default.createElement(components_1.Placeholder, {
            icon: react_1.default.createElement(lucide_react_1.Search, null),
