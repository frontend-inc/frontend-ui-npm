...
var ProductDetails = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1 },
        ...
        react_1.default.createElement(material_1.Typography, { color: "text.primary", variant: "body2", sx: sx.price },
            price && (0, shopify_2.formatCurrency)(price),
            !disableCompareAtPrice && compareAtPrice && (react_1.default.createElement("span", null, (0, shopify_2.formatCurrency)(compareAtPrice)))),
        react_1.default.createElement(shopify_3.ProductDescription, null)));
};
