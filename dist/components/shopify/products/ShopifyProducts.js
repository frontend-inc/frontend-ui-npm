...
var ShopifyProducts = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: 'w-full grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-4 pb-1' }, products === null || products === void 0 ? void 0 : products.map(function (product) { return (react_1.default.createElement("div", { className: "p-1", key: product === null || product === void 0 ? void 0 : product.id },
