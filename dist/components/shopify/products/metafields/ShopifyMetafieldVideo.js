...
var ShopifyMetafieldVideo = function (props) {
    var shopifyProduct = props.shopifyProduct, metafield = props.metafield, _a = props.controls, controls = _a === void 0 ? false : _a, _b = props.autoPlay, autoPlay = _b === void 0 ? false : _b, _c = props.height, height = _c === void 0 ? 300 : _c;
    ...
    (0, react_1.useEffect)(function () {
        if (product) {
            ...
            var videoRef = (0, frontend_shopify_1.getMetafieldReference)(product, key);
    ...
    return (react_1.default.createElement("video", { height: "".concat(height, "px"), width: '100%', controls: controls, autoPlay: autoPlay },
        mp4 && react_1.default.createElement("source", { src: mp4, type: "video/mp4" }),
        ogg && react_1.default.createElement("source", { src: ogg, type: "video/ogg" }),
        "Your browser does not support the video tag."));
};
exports.default = ShopifyMetafieldVideo;
