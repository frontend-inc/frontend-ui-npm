...
var ShopifyProductImageSlider = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-4" },
        react_1.default.createElement("div", { className: "flex justify-center items-start" }, (image === null || image === void 0 ? void 0 : image.url) &&
            (disableZoom ? (react_1.default.createElement("img", { src: image === null || image === void 0 ? void 0 : image.url, alt: (image === null || image === void 0 ? void 0 : image.altText) || '', className: "h-full w-full object-contain rounded-lg" })) : (react_1.default.createElement(react_medium_image_zoom_1.default, null,
                react_1.default.createElement("img", { src: image === null || image === void 0 ? void 0 : image.url, alt: (image === null || image === void 0 ? void 0 : image.altText) || '', className: "h-full w-full object-contain rounded-lg" }))))),
        react_1.default.createElement("div", { className: "flex flex-row flex-wrap gap-2" }, images === null || images === void 0 ? void 0 : images.map(function (img) { return (react_1.default.createElement(Thumbnail, { key: img === null || img === void 0 ? void 0 : img.id, image: img, active: (img === null || img === void 0 ? void 0 : img.id) === (image === null || image === void 0 ? void 0 : image.id), handleClick: handleClick })); }))));
};
