...
var Thumbnail = function (props) {
    ...
    return (react_1.default.createElement("button", { className: (0, frontend_shadcn_1.cn)('p-0 m-2 w-[96px] h-[96px] overflow-hidden rounded hover:bg-muted/20', active ? 'ring-2 ring-offset-2 ring-primary' : 'ring-2 ring-transparent'), onClick: function () { return handleClick(image); } },
...
var ShopifyProductImageSlider = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-4" },
        react_1.default.createElement("div", { className: "flex justify-center items-start" }, (image === null || image === void 0 ? void 0 : image.url) &&
            (disableZoom ? (react_1.default.createElement("img", { src: image === null || image === void 0 ? void 0 : image.url, alt: (image === null || image === void 0 ? void 0 : image.altText) || '', className: "h-full w-full object-contain" })) : (react_1.default.createElement(react_medium_image_zoom_1.default, null,
