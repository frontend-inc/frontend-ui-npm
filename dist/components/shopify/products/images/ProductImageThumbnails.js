...
var Thumbnail = function (props) {
  ...
  return react_1.default.createElement(
    material_1.Box,
    { sx: __assign(__assign({}, sx.thumbnail), active && sx.activeThumbnail) },
...
var ProductImageSlider = function (props) {
  var image = props.image,
    ...
    handleClick = props.handleClick,
    _a = props.height,
    height = _a === void 0 ? 520 : _a,
    _b = props.width,
    width = _b === void 0 ? 520 : _b,
    _c = props.thumbnailSize,
    thumbnailSize = _c === void 0 ? 80 : _c;
  return react_1.default.createElement(
    material_1.Stack,
    { direction: "column", spacing: 0, sx: sx.root },
    react_1.default.createElement(
      material_1.Box,
      { sx: __assign(__assign({}, sx.image), { width: "100%" }) },
    ...
    react_1.default.createElement(
      material_1.Stack,
      { direction: "row", spacing: 1, sx: sx.thumbnails },
      images === null || images === void 0
        ? void 0
        : images.map(function (img) {
            return react_1.default.createElement(Thumbnail, {
              key: img === null || img === void 0 ? void 0 : img.id,
              image: img,
              active:
