...
var ProductCard = function (props) {
    ...
    return (react_1.default.createElement(material_1.Box, { sx: __assign(__assign({}, sx.root), (enableBorder && sx.rootBorder)) },
        ...
        react_1.default.createElement(__1.ProductModal, { open: open, handleClose: function () { return setOpen(false); }, shopifyProduct: product, enableQuantity: enableQuantity, buttonText: buttonText })));
};
