...
var ShopifyProductCarousel = function (props) {
    ...
    return (react_1.default.createElement("div", { className: (0, react_2.cn)('w-full', loading && 'opacity-50') },
        react_1.default.createElement(frontend_shadcn_1.Carousel, null,
            react_1.default.createElement(frontend_shadcn_1.CarouselContent, null, products === null || products === void 0 ? void 0 : products.map(function (product, index) { return (react_1.default.createElement(frontend_shadcn_1.CarouselItem, { className: "sm:basis-1/2 lg:basis-1/3", key: index },
