...
var ShopifyProductCard = function (props) {
    var _a, _b, _c, _d;
    ...
    return (react_1.default.createElement(material_1.Box, { sx: __assign(__assign({}, sx.root), (enableBorder && sx.rootBorder)) },
        react_1.default.createElement(SwipeableShopifyProductImages_1.default, { product: product, height: height, handleClick: handleItemClick, disableBorderRadius: enableBorder ? true : false }),
        react_1.default.createElement(material_1.Stack, { spacing: 1, sx: sx.content },
            ...
            react_1.default.createElement(material_1.Stack, { spacing: 1, direction: "column" },
                enableAddToCart && (react_1.default.createElement(__1.ShopifyAddToCartButton, { product: product, variant: 
                    //@ts-ignore
                    (_d = (_c = product === null || product === void 0 ? void 0 : product.variants) === null || _c === void 0 ? void 0 : _c.edges[0]) === null || _d === void 0 ? void 0 : _d.node, label: buttonText, enableQuantity: enableQuantity, buttonVariant: buttonVariant, size: "small", enableFavorites: true })),
                enableQuickShop && (react_1.default.createElement(material_1.Button, { variant: "contained", color: "secondary", onClick: handleQuickShop }, "Quick Shop")))),
