...
function ShopifyProductCard(props) {
    ...
    return (react_1.default.createElement("div", { className: (0, frontend_shadcn_2.cn)('w-full overflow-hidden bg-background', className) },
        react_1.default.createElement("div", { className: "w-full h-full min-h-[300px]" },
            react_1.default.createElement(SwipeableShopifyProductImages_1.default, { product: product, height: 300, handleClick: handleItemClick, disableBorderRadius: enableBorder })),
