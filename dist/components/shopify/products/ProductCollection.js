...
var ProductCollection = function (props) {
  var title = props.title,
    ...
    productComponent = props.productComponent,
    ...
    _c = props.enableFilters,
    enableFilters = _c === void 0 ? false : _c,
    _d = props.enableSort,
    enableSort = _d === void 0 ? false : _d,
    _e = props.autoPlay,
    autoPlay = _e === void 0 ? false : _e,
    _f = props.arrows,
    arrows = _f === void 0 ? false : _f,
    _g = props.showDots,
    showDots = _g === void 0 ? true : _g,
    _h = props.enableBorder,
    enableBorder = _h === void 0 ? false : _h,
    _j = props.enableAddToCart,
    enableAddToCart = _j === void 0 ? false : _j,
    _k = props.enableQuickShop,
    enableQuickShop = _k === void 0 ? false : _k,
    _l = props.enableQuantity,
    enableQuantity = _l === void 0 ? false : _l,
    _m = props.enableOkendoStarRating,
    enableOkendoStarRating = _m === void 0 ? false : _m;
  var _o = (0, react_1.useState)({}),
    query = _o[0],
    setQuery = _o[1];
  var _p = (0, react_1.useState)("COLLECTION_DEFAULT"),
    sortKey = _p[0],
    setSortKey = _p[1];
  var _q = (0, react_1.useState)(false),
    reverse = _q[0],
    setReverse = _q[1];
  var _r = (0, webstudio_shopify_1.useCollections)(),
    loading = _r.loading,
    products = _r.products,
    fetchCollection = _r.fetchCollection,
    filters = _r.filters,
    filterVariantOption = _r.filterVariantOption,
    filterInStock = _r.filterInStock,
    filterVendor = _r.filterVendor,
    filterProductType = _r.filterProductType,
    filterTag = _r.filterTag;
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        ...
        null,
        enableFilters &&
          react_1.default.createElement(shopify_1.ProductFilterButton, {
            filters: filters,
        ...
        enableSort &&
          react_1.default.createElement(shopify_1.ProductSortButton, {
            sortKey: sortKey,
            reverse: reverse,
    ...
    layout == "list" &&
      react_1.default.createElement(shopify_1.ProductList, {
        editing: editing,
        loading: loading,
        products: products,
    ...
    layout == "grid" &&
      react_1.default.createElement(shopify_1.ProductGrid, {
        editing: editing,
        loading: loading,
        products: products,
        productComponent: productComponent,
    ...
    layout == "carousel" &&
      react_1.default.createElement(shopify_1.ProductCarousel, {
        editing: editing,
        loading: loading,
        products: products,
        productComponent: productComponent,
