...
var ShopifyOrderDetails = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1 },
        react_1.default.createElement(material_1.Typography, { gutterBottom: true, variant: "body1" }, "Order details"),
        react_1.default.createElement(material_1.List, null, lineItems === null || lineItems === void 0 ? void 0 : lineItems.map(function (lineItem, i) { return (react_1.default.createElement(shopify_1.ShopifyOrderLineItem, { key: i, lineItem: lineItem })); })),
        react_1.default.createElement(material_1.Box, { sx: sx.lineItem },
            ...
            react_1.default.createElement(material_1.Typography, { variant: "body1" }, (0, frontend_shopify_1.formatCurrency)((_a = order === null || order === void 0 ? void 0 : order.totalShippingPrice) === null || _a === void 0 ? void 0 : _a.amount, 2))),
        react_1.default.createElement(material_1.Box, { sx: sx.lineItem },
            react_1.default.createElement(material_1.Typography, { variant: "body1" }, "Total"),
            react_1.default.createElement(material_1.Typography, { variant: "body1" }, (0, frontend_shopify_1.formatCurrency)((_b = order === null || order === void 0 ? void 0 : order.totalPrice) === null || _b === void 0 ? void 0 : _b.amount, 2))),
        ...
        react_1.default.createElement(material_1.Button, { fullWidth: true, variant: "contained", endIcon: react_1.default.createElement(lucide_react_1.ExternalLink, null), onClick: handleOrderStatusClick }, "Order status"),
        supportUrl && (react_1.default.createElement(material_1.Button, { fullWidth: true, variant: "outlined", onClick: handleSupportClick }, "Customer support"))));
};
