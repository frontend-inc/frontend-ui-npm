...
var ShopifyCustomerOrders = function (props) {
  ...
  var _a = props || {},
    _b = _a.title,
    title = _b === void 0 ? "Customer Orders" : _b,
    _c = _a.subtitle,
    subtitle = _c === void 0 ? "Manage your orders" : _c;
  var _d = (0, webstudio_shopify_1.useOrders)(),
    loading = _d.loading,
    orders = _d.orders,
    fetchCustomerOrders = _d.fetchCustomerOrders;
  var handleClick = function (order) {
    var orderId = (0, webstudio_shopify_2.getShopifyIdFromGid)(
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(shopify_1.OrderList, {
        orders: orders,
