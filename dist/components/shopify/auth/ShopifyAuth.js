      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [3 /*break*/, 3];
          case 1:
            return [4 /*yield*/, findShop()];
          case 2:
            shop = _a.sent();
            shopId = getLastPathOfUrl(
              shop === null || shop === void 0 ? void 0 : shop.id
            );
  ...
  return showLabel
    ? react_1.default.createElement(
        material_1.Button,
        {
          ...
          sx: sx.button,
          onClick: handleClick,
          startIcon: react_1.default.createElement(components_1.Icon, {
            name: "User",
            size: 24,
          }),
        },
