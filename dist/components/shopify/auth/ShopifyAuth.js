...
var ShopifyAuth = function (props) {
    ...
    return (showLabel ? (react_1.default.createElement(material_1.Button, { fullWidth: true, sx: sx.button, onClick: handleClick, startIcon: react_1.default.createElement(components_1.Icon, { name: "User", size: 24 }) }, "My Account")) : (react_1.default.createElement(material_1.IconButton, { onClick: handleClick },
