...
var ShopifyRegisterForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-4" },
        ...
        react_1.default.createElement(components_1.Button, { loading: loading, className: "w-full", onClick: handleSubmit, disabled: loading }, "Register"),
        react_1.default.createElement(components_1.Button, { className: "w-full", variant: "ghost", onClick: handleLogin }, "Already have an account? Sign in")));
};
