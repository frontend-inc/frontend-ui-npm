...
var SignInForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-4" },
        ...
        react_1.default.createElement(core_1.Button, { className: "w-full", onClick: handleSubmit, disabled: loading },
            "Sign In",
            loading && react_1.default.createElement(__1.IconLoading, { className: "ml-2 h-4 w-4 animate-spin" })),
        handleSignup && (react_1.default.createElement(core_1.Button, { className: "w-full", variant: "ghost", onClick: handleSignup }, "No account? Sign up")),
        handleForgotPassword && (react_1.default.createElement(core_1.Button, { className: "w-full", variant: "ghost", onClick: handleForgotPassword }, "Forgot password?"))));
};
