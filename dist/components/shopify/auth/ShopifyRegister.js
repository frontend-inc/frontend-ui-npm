...
var ShopifyRegister = function (props) {
    ...
    return (react_1.default.createElement(__1.AuthScreen, { title: title, subtitle: subtitle },
        react_1.default.createElement(__2.ShopifyRegisterForm, { errors: errors, loading: loading, customer: customer, handleChange: handleChange, handleSubmit: handleSubmit, handleLogin: handleLogin })));
};
exports.default = ShopifyRegister;
