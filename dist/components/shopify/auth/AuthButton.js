...
var AuthAvatarButton = function () {
  ...
  var _a = (0, webstudio_shopify_1.useAuth)(),
    logout = _a.logout,
    customer = _a.customer;
  var _b = (0, hooks_1.useMenu)({}),
    open = _b.open,
    anchorEl = _b.anchorEl,
    closeMenu = _b.closeMenu,
    toggleMenu = _b.toggleMenu;
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      { sx: sx.button, onClick: toggleMenu },
