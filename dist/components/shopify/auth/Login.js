...
var Login = function (props) {
  var _a = props || {},
    ...
    _b = _a.title,
    title = _b === void 0 ? "Sign In" : _b,
    _c = _a.subtitle,
    subtitle = _c === void 0 ? "Log in to your account" : _c,
    forgotPasswordUrl = _a.forgotPasswordUrl,
    signupUrl = _a.signupUrl;
  var router = (0, navigation_1.useRouter)();
  var _d = (0, webstudio_shopify_1.useAuth)(),
    errors = _d.errors,
    loading = _d.loading,
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(shopify_1.LoginForm, {
        errors: errors,
        loading: loading,
        customer: customer,
