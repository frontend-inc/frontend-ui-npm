...
var FilterList = function (props) {
  var label = props.label,
    count = props.count,
    _a = props.variant,
    variant = _a === void 0 ? "subtitle2" : _a,
    _b = props.expandable,
    expandable = _b === void 0 ? true : _b,
    enableBorder = props.enableBorder,
    _c = props.disablePadding,
    disablePadding = _c === void 0 ? false : _c,
    children = props.children,
    _d = props.closed,
    closed = _d === void 0 ? false : _d;
  var _e = (0, react_1.useState)(!closed),
    open = _e[0],
    setOpen = _e[1];
  ...
  return react_1.default.createElement(
    material_1.List,
    {
      disablePadding: true,
      sx: __assign(
        __assign(__assign({}, sx.root), !disablePadding && sx.padding),
