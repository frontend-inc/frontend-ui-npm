...
var ProductSortButton = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(material_1.ButtonGroup, null,
            react_1.default.createElement(material_1.Button, { sx: sx.button, variant: "text", onClick: handleOpen, endIcon: reverse === true ? (react_1.default.createElement(icons_material_1.ArrowDownward, { sx: sx.icon })) : (react_1.default.createElement(icons_material_1.ArrowUpward, { sx: sx.icon })) }, (_a = frontend_shopify_1.COLLECTION_SORT_OPTIONS.find(function (option) { return option.value === sortKey; })) === null || _a === void 0 ? void 0 : _a.label)),
