...
var ShopifyCheckboxFilterList = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "space-y-2" }, (_a = option === null || option === void 0 ? void 0 : option.value) === null || _a === void 0 ? void 0 : _a.map(function (optionValue, index) { return (react_1.default.createElement("div", { key: index, className: "flex items-center space-x-2" },
        react_1.default.createElement(react_2.Checkbox, { id: "".concat(option.name, "-").concat(index), isSelected: values === null || values === void 0 ? void 0 : values.includes(optionValue), onValueChange: function () { return handleFilterClick(optionValue); } }),
        react_1.default.createElement(frontend_shadcn_1.Label, { htmlFor: "".concat(option.name, "-").concat(index), className: "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" }, optionValue))); })));
};
