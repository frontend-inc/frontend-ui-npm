...
var CollectionFilters = function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(DesktopFilters_1.default, null,
            colorOptions && (react_1.default.createElement(shopify_1.ProductFilterButton, { label: "Colors", count: colorsCount },
                react_1.default.createElement(shopify_1.ColorFilters, { filters: filters, options: colorOptions, handleClick: handleFilterColor }))),
            sizeOptions && (react_1.default.createElement(shopify_1.ProductFilterButton, { label: "Size", count: sizesCount },
                react_1.default.createElement(shopify_1.SizeFilters, { filters: filters, options: sizeOptions, handleClick: handleFilterSize }))),
            styleOptions && (react_1.default.createElement(shopify_1.ProductFilterButton, { label: "Style", count: stylesCount },
                react_1.default.createElement(shopify_1.StyleFilters, { filters: filters, options: styleOptions, handleClick: handleFilterStyle }))),
            materialOptions && (react_1.default.createElement(shopify_1.ProductFilterButton, { label: "Material", count: materialsCount },
            ...
            vendorOptions && (react_1.default.createElement(shopify_1.ProductFilterButton, { label: "Tags", count: tagsCount },
                react_1.default.createElement(shopify_1.TagFilters, { filters: filters, options: tagOptions, handleClick: handleFilterTag }))),
            vendorOptions && (react_1.default.createElement(shopify_1.ProductFilterButton, { label: "Vendor", count: vendorsCount },
            ...
            productTypeOptions && (react_1.default.createElement(shopify_1.ProductFilterButton, { label: "Product Type", count: productTypesCount },
            ...
            enableInStockFilter && (react_1.default.createElement(shopify_1.ProductFilterButton, { label: "In-Stock" },
