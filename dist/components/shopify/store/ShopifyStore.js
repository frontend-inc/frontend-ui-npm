...
var ShopifyStore = function (props) {
    ...
    if (enableShopify && (!domain || !storefrontAccessToken))
        return null;
    return enableShopify ? (react_1.default.createElement(frontend_shopify_1.ShopProvider, { logo: logo, domain: domain, shopUrl: shopUrl, customerPortalUrl: customerPortalUrl, storefrontAccessToken: storefrontAccessToken },
