...
var AddressItem = function (props) {
  var address = props.address,
    ...
    _a = props.disableActions,
    disableActions = _a === void 0 ? false : _a;
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(material_1.ListItemText, {
        primary: react_1.default.createElement(
          ...
          { gutterBottom: true, variant: "subtitle1" },
        ...
        secondary: react_1.default.createElement(
          ...
          react_1.default.createElement(
            material_1.Typography,
            { gutterBottom: true, variant: "body2", color: "textSecondary" },
            address.address1
          ),
          address.address2 &&
            react_1.default.createElement(
          ...
          react_1.default.createElement(
            ...
            ", ",
            address === null || address === void 0 ? void 0 : address.province,
            " ",
