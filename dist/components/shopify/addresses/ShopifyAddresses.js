...
var Addresses = function (props) {
    ...
    var handleDelete = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(activeAddress === null || activeAddress === void 0 ? void 0 : activeAddress.id)) return [3 /*break*/, 2];
                    //@ts-ignore
                    return [4 /*yield*/, deleteCustomerAddress(activeAddress === null || activeAddress === void 0 ? void 0 : activeAddress.id)];
                case 1:
                    //@ts-ignore
                    _a.sent();
