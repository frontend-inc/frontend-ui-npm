...
var ShopifyAddressItem = function (props) {
    ...
    return (react_1.default.createElement(material_1.ListItem, { disableGutters: true, secondaryAction: !disableActions && (react_1.default.createElement(components_1.MenuButton, null,
            react_1.default.createElement(material_1.MenuItem, { onClick: 
                //@ts-ignore
                function () { return handleEdit(address === null || address === void 0 ? void 0 : address.id); } }, "Edit"),
            react_1.default.createElement(material_1.MenuItem, { onClick: function () { return handleDelete(address); } }, "Delete"))) },
        react_1.default.createElement(material_1.ListItemButton, { onClick: 
            //@ts-ignore
            function () { return handleClick(address === null || address === void 0 ? void 0 : address.id); }, sx: sx.item },
