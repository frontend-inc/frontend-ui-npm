...
var ProductVariantOptions_1 = __importDefault(
  require("./ProductVariantOptions")
);
...
var ProductVariantSelector = function (props) {
  ...
  return react_1.default.createElement(
    ...
    null,
    SORTED_OPTIONS.map(function (optionName) {
      var option = productOption(optionName);
      if (!option) return null;
      return optionName == "Color"
        ? react_1.default.createElement(ColorVariantOptions_1.default, {
            key: optionName,
            product: product,
            name: "Color",
            values:
              option === null || option === void 0 ? void 0 : option.values,
            selected: selectedOptions["Color"],
            handleChange: handleOptionChange,
          })
        : react_1.default.createElement(ProductVariantOptions_1.default, {
            key: optionName,
