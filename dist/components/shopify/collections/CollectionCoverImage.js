...
var CollectionCoverImage = function (props) {
    ...
    if (!collection)
        return null;
    return (react_1.default.createElement(__1.CoverImage, { editing: editing, enableOverlay: enableOverlay, enableGradient: enableGradient, opacity: opacity, overlayColor: overlayColor, height: height, title: collection === null || collection === void 0 ? void 0 : collection.title, description: collection === null || collection === void 0 ? void 0 : collection.description, image: (_a = collection === null || collection === void 0 ? void 0 : collection.image) === null || _a === void 0 ? void 0 : _a.url, objectFit: objectFit, alt: alt, alignItems: alignItems, href: href, handleClick: handleClick }));
};
