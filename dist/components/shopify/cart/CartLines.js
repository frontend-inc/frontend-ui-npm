...
var CartLines = function (props) {
    ...
    return (react_1.default.createElement(material_1.List, { sx: sx.root, disablePadding: true }, lines === null || lines === void 0 ? void 0 : lines.map(function (line) { return (react_1.default.createElement(shopify_2.CartLine, { key: line.id, line: line })); })));
};
