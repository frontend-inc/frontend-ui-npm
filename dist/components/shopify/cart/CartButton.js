...
var CartButton = function (props) {
  var _a = props.label,
    ...
    _e = props.icon,
    icon = _e === void 0 ? "ShoppingCart" : _e;
  var _f = (0, react_1.useContext)(webstudio_shopify_1.ShopContext),
    cart = _f.cart,
    toggleCart = _f.toggleCart;
  ...
  return react_1.default.createElement(
    ...
    !showLabel
      ? react_1.default.createElement(
          ...
          { onClick: handleCartClick, sx: sx.root },
          react_1.default.createElement(
            material_1.Badge,
            {
              color: "primary",
              badgeContent:
                cart === null || cart === void 0 ? void 0 : cart.totalQuantity,
            },
