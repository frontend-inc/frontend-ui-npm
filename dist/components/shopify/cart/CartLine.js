...
var CartQuantityInput = function (props) {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      material_1.Button,
      { sx: sx.button, onClick: handleRemoveQuantity },
    ...
    react_1.default.createElement(
      material_1.Button,
      { sx: sx.button, onClick: handleAddQuantity },
      react_1.default.createElement(components_1.Icon, {
        name: "Plus",
        size: 16,
      })
...
var CartLine = function (props) {
  ...
  var _j = (0, webstudio_shopify_2.useCart)(),
    loading = _j.loading,
    cartLineRemove = _j.cartLineRemove,
    cartLineUpdate = _j.cartLineUpdate;
  var _k = (0, react_1.useContext)(webstudio_shopify_1.ShopContext),
    shopUrl = _k.shopUrl,
    setCartOpen = _k.setCartOpen;
  var _l = line || {},
    id = _l.id,
    quantity = _l.quantity,
    merchandise = _l.merchandise,
    sellingPlanAllocation = _l.sellingPlanAllocation;
  var _m = (0, react_1.useState)(null),
    price = _m[0],
    setPrice = _m[1];
  var _o = (0, react_1.useState)(null),
    compareAtPrice = _o[0],
    setCompareAtPrice = _o[1];
  var _p = merchandise || {},
    //@ts-ignore
    product = _p.product,
    amount = _p.price.amount,
    //@ts-ignore
    compareAtAmount = _p.compareAtPrice,
    url = _p.image.url;
  var handleUpdateQuantity = function (quantity) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              cartLineUpdate({ id: id, quantity: quantity }),
            ];
          case 1:
            _a.sent();
            return [2 /*return*/];
  ...
  var handleRemoveLineItem = function (event) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
  ...
  (0, react_1.useEffect)(
    function () {
      ...
      if (
        ((_a =
          sellingPlanAllocation === null || sellingPlanAllocation === void 0
            ? void 0
            : sellingPlanAllocation.priceAdjustments) === null || _a === void 0
          ? void 0
          : _a.length) > 0
      ) {
        ...
        setPrice(amount);
        setCompareAtPrice(
          compareAtAmount === null || compareAtAmount === void 0
            ? void 0
  ...
  return react_1.default.createElement(
    ...
    {
      disableGutters: true,
      sx: __assign(__assign({}, sx.root), loading && sx.loading),
      secondaryAction: react_1.default.createElement(
        material_1.IconButton,
        { onClick: handleRemoveLineItem, size: "small" },
        react_1.default.createElement(components_1.Icon, {
          name: "X",
          size: 20,
        })
              ...
              (_b =
                (_a =
                  line === null || line === void 0
                    ? void 0
                    : line.merchandise) === null || _a === void 0
                  ? void 0
    ...
    react_1.default.createElement(material_1.ListItemText, {
      primary:
        ...
        (_d =
          ...
          ? void 0
          : _d.title,
      secondary: react_1.default.createElement(
        material_1.Stack,
        { spacing: 0.5 },
        react_1.default.createElement(
          ...
          (_g =
            (_f =
              (_e =
                line === null || line === void 0
                  ? void 0
                  : line.merchandise) === null || _e === void 0
                ? void 0
                : _e.selectedOptions) === null || _f === void 0
              ? void 0
              : _f.filter(function (option) {
        ...
        (sellingPlanAllocation === null || sellingPlanAllocation === void 0
          ...
          react_1.default.createElement(
            material_1.Typography,
            { variant: "body2", sx: sx.subscription },
            (_h =
              sellingPlanAllocation === null || sellingPlanAllocation === void 0
                ? void 0
                : sellingPlanAllocation.sellingPlan) === null || _h === void 0
              ? void 0
              : _h.name
          ),
        react_1.default.createElement(
          ...
          react_1.default.createElement(
            ...
            price == 0
              ? "Free"
              : (0, webstudio_shopify_3.formatCurrency)(price),
            " "
          )
        ),
        react_1.default.createElement(
          material_1.Box,
          null,
          react_1.default.createElement(CartQuantityInput, {
            quantity: quantity,
...
var sx = {
  ...
  button: {
    ...
    fontSize: function (theme) {
      return theme.typography.overline.fontSize;
    },
  },
  subscription: {
    fontStyle: "italic",
