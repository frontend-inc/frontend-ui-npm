...
var Cart = function (props) {
  var _a, _b;
  var _c = props.title,
    title = _c === void 0 ? "Your Cart" : _c;
  var trackCartViewed = (0, addons_1.useSegment)().trackCartViewed;
  var _d = (0, react_1.useContext)(webstudio_shopify_2.ShopContext),
    cartOpen = _d.cartOpen,
    toggleCart = _d.toggleCart;
  ...
  return react_1.default.createElement(
    components_1.Drawer,
    { anchor: "right", open: cartOpen, handleClose: toggleCart, title: title },
    ((_b =
      (_a = cart === null || cart === void 0 ? void 0 : cart.lines) === null ||
      _a === void 0
        ? void 0
        : _a.edges) === null || _b === void 0
      ? void 0
      : _b.length) > 0
      ? react_1.default.createElement(
          material_1.Stack,
          { sx: sx.root, spacing: 4 },
          ...
          react_1.default.createElement(shopify_1.CheckoutButton, null)
        )
      : react_1.default.createElement(
          material_1.Box,
          { sx: sx.empty },
