...
var AddToCartButton = function (props) {
  ...
  var toggleCart = (0, react_1.useContext)(
    webstudio_shopify_2.ShopContext
  ).toggleCart;
  var _a = (0, webstudio_shopify_1.useCart)(),
    loading = _a.loading,
    cartLineAdd = _a.cartLineAdd;
  var _b = props.size,
    size = _b === void 0 ? "large" : _b,
    _c = props.label,
    label = _c === void 0 ? "Add to Cart" : _c,
    product = props.product,
    variant = props.variant,
    _d = props.buttonVariant,
    buttonVariant = _d === void 0 ? "contained" : _d,
    _e = props.enableQuantity,
    enableQuantity = _e === void 0 ? false : _e,
    _f = props.enableSubscription,
    enableSubscription = _f === void 0 ? false : _f,
    _g = props.enableFavorites,
    enableFavorites = _g === void 0 ? false : _g;
  var _h = (0, react_1.useState)(1),
    quantity = _h[0],
    setQuantity = _h[1];
  var _j = (0, react_1.useState)(null),
    activeSellingPlanId = _j[0],
    setActiveSellingPlanId = _j[1];
  ...
  return react_1.default.createElement(
    ...
    enableSubscription &&
      react_1.default.createElement(shopify_1.SubscriptionSelector, {
        product: product,
    ...
    react_1.default.createElement(
      ...
      enableQuantity &&
        react_1.default.createElement(shopify_1.QuantitySelector, {
          size: size,
          quantity: quantity,
      ...
      react_1.default.createElement(
        material_1.Button,
        {
          ...
          size: size,
          startIcon: react_1.default.createElement(components_1.IconLoader, {
            color:
      ...
      enableFavorites &&
        react_1.default.createElement(shopify_1.FavoriteButton, {
          product: product,
        })
    )
  );
