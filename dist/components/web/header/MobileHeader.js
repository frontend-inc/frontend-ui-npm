...
var MobileHeader = function (props) {
    var bgColor = props.bgColor, logo = props.logo, _a = props.logoWidth, logoWidth = _a === void 0 ? 120 : _a, _b = props.logoHeight, logoHeight = _b === void 0 ? 50 : _b, handleClick = props.handleClick, buttons = props.buttons, disableMenu = props.disableMenu, _c = props.enableAuth, enableAuth = _c === void 0 ? false : _c, _d = props.enableStripe, enableStripe = _d === void 0 ? false : _d, _e = props.enableShopify, enableShopify = _e === void 0 ? false : _e;
    ...
    return (react_1.default.createElement("div", { className: "block md:hidden w-full h-16 bg-background", style: {
        ...
        react_1.default.createElement("div", { className: "flex justify-between items-center h-full px-4" },
            react_1.default.createElement("div", { className: "flex items-center" },
                !disableMenu && (react_1.default.createElement(components_1.Button, { variant: "ghost", size: "icon", className: "mr-2", onClick: function () { return setMenuOpen(true); } },
