...
var MobileDrawer = function (props) {
    ...
    return (react_1.default.createElement(__1.Sheet, { open: menuOpen, handleClose: function () { return setMenuOpen(false); }, side: "left" },
        react_1.default.createElement("div", null,
            ...
            (enableAuth || enableShopify) && (react_1.default.createElement("div", { className: "flex flex-col space-y-3" },
                ...
                enableAuth && (react_1.default.createElement("div", { className: "w-full border-t border-divider pt-1.5" },
                    react_1.default.createElement(__2.AuthButton, { showLabel: true }))))))));
};
