...
var Accordion = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1, sx: sx.root }, items === null || items === void 0 ? void 0 :
        items.map(function (item, i) { return (react_1.default.createElement(components_1.AccordionItem, { key: i, primary: item === null || item === void 0 ? void 0 : item.title, secondary: react_1.default.createElement(components_1.Text, { variant: "body1", color: "text.primary" }, item === null || item === void 0 ? void 0 : item.description), image: item === null || item === void 0 ? void 0 : item.image })); }),
