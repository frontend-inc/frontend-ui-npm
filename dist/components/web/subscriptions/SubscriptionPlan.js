...
var SubscriptionPlan = function (props) {
    var title = props.title, subtitle = props.subtitle, features = props.features, _a = props.variant, variant = _a === void 0 ? 'default' : _a, _b = props.interval, interval = _b === void 0 ? 'month' : _b, _c = props.buttonText, buttonText = _c === void 0 ? 'Subscribe' : _c, price = props.price, compareAtPrice = props.compareAtPrice, path = props.path, url = props.url, handleClick = props.handleClick, _d = props.precision, precision = _d === void 0 ? 0 : _d;
    ...
    return (react_1.default.createElement(react_2.Card, { isHoverable: true, className: "w-full" },
            ...
            react_1.default.createElement("div", { className: "flex flex-row space-x-4 w-full items-end" },
                react_1.default.createElement("div", { className: "flex flex-row items-center space-x-1" },
                    ...
                    price > 0 && (react_1.default.createElement(__1.Typography, { variant: "body2", className: "text-xs text-foreground/70" },
                        ...
                        interval))),
                compareAtPrice && (react_1.default.createElement(__1.Typography, { variant: "subtitle2", className: "line-through text-foreground/70" }, compareAtPrice == 0
                    ? 'FREE'
                    : (0, helpers_1.formatCurrency)(compareAtPrice, precision)))),
