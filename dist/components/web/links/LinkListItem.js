...
var LinkListItem = function (props) {
    ...
    return (react_1.default.createElement("li", { className: "w-full" },
        react_1.default.createElement("button", { 
            //@ts-ignore
            onClick: onClick, className: (0, frontend_shadcn_2.cn)('w-full flex justify-between items-center rounded-xl p-4 focus:outline-none hover:bg-muted', variant === 'fill' && 'bg-muted p-6', variant === 'outline' && 'border border-border rounded-lg') },
