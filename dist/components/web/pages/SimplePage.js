...
var SimplePage = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "w-full flex justify-center items-start ".concat(disablePadding ? '' : 'p-6') },
        react_1.default.createElement("div", { className: "w-full max-w-3xl space-y-4" },
            ...
            react_1.default.createElement(components_1.Typography, { variant: "caption", className: "block text-center" },
                "Last updated ",
                publishedAt),
            html ? (react_1.default.createElement(components_1.Typography, { variant: "body1", className: "whitespace-pre-line" },
                react_1.default.createElement("div", { dangerouslySetInnerHTML: { __html: body } }))) : (react_1.default.createElement(components_1.Typography, { variant: "body1", className: "whitespace-pre-line" }, body)))));
};
