...
var TestimonialsGrid = function (props) {
    ...
    return (react_1.default.createElement(material_1.Box, { sx: sx.root },
        ...
        (testimonials === null || testimonials === void 0 ? void 0 : testimonials.length) === 0 && (react_1.default.createElement(__1.Placeholder, { icon: 'Rating', title: "No testimonials yet.", description: "Testimonials will appear here." }))));
};
