...
var Testimonials = function (props) {
    var _a = props.layout, layout = _a === void 0 ? 'grid' : _a, enableAutoPlay = props.enableAutoPlay, _b = props.items, items = _b === void 0 ? [] : _b;
    return (react_1.default.createElement("div", { className: "flex flex-col w-full" },
        layout == 'carousel' ? (react_1.default.createElement(SwipeableTestimonials_1.default, { items: items, enableAutoPlay: enableAutoPlay })) : (react_1.default.createElement(TestimonialCards_1.default, { items: items })),
