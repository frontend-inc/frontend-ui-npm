...
var FeatureIcon = function (props) {
    ...
    return (react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('flex justify-start py-6 w-full items-start h-full', 'flex-row items-start space-x-3 min-h-[90px]', variant == 'outline' && 'border-2 border-border rounded-lg p-6', variant == 'fill' && 'bg-muted rounded-lg p-6') },
        ...
        react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('flex flex-col space-y-2', direction === 'row' && 'text-left') },
            ...
            react_1.default.createElement(components_1.Typography, { className: (0, frontend_shadcn_1.cn)('text-muted-foreground'), variant: "body1" }, subtitle))));
};
