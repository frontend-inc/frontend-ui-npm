...
var FeaturedCard = function (props) {
    ...
    return (react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('flex items-center gap-10 flex-wrap md:flex-nowrap', flexDirection === 'row-reverse' ? 'flex-row-reverse' : 'flex-row', variant == 'outline' && 'p-6 border-2 border-border rounded-lg', variant == 'fill' && 'p-6 bg-muted/50 rounded-lg') },
