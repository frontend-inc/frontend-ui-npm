...
var FeatureIcon = function (props) {
    var _a = props || {}, fill = _a.fill, border = _a.border, icon = _a.icon, title = _a.title, subtitle = _a.subtitle, _b = _a.direction, direction = _b === void 0 ? 'column' : _b;
    return (react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('flex justify-start py-6', direction === 'column'
            ? 'flex-col items-center space-y-3'
            : 'flex-row items-start space-x-3', border && 'border-2 border-border rounded-lg p-6', fill && 'bg-muted rounded-lg p-6') },
...
var FeatureIcons = function (props) {
    var _a = props || {}, fill = _a.fill, border = _a.border, _b = _a.items, items = _b === void 0 ? [] : _b, _c = _a.direction, direction = _c === void 0 ? 'column' : _c;
    return (react_1.default.createElement("div", { className: "container mx-auto max-w-screen-lg p-2" },
        react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('grid', direction === 'column'
            ...
            react_1.default.createElement(FeatureIcon, { fill: fill, border: border, icon: item === null || item === void 0 ? void 0 : item.icon, title: item === null || item === void 0 ? void 0 : item.title, subtitle: item === null || item === void 0 ? void 0 : item.subtitle, direction: direction }))); })),
