...
var FeaturedCard = function (props) {
    ...
    return (react_1.default.createElement("div", { className: (0, react_2.cn)('flex items-center gap-10 flex-wrap md:flex-nowrap', direction && flexDirectionClass[direction], variant == 'outline' && 'p-6 border-2 border-divider rounded-lg', variant == 'fill' && 'p-6 bg-content1/50 rounded-lg') },
        ...
        react_1.default.createElement("div", { className: (0, react_2.cn)("flex flex-col gap-4 w-full", "md:w-1/2") },
