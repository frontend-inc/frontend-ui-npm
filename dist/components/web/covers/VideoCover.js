...
var VideoCover = function (props) {
    ...
    return (react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('dark relative w-full overflow-hidden', height && "h-[".concat(height, "px]")) },
        ...
        react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('relative flex items-center justify-center w-full h-full', enableOverlay && 'bg-black bg-opacity-50') },
            react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('flex flex-col space-y-4', alignItems) },
                ...
                buttonText && (react_1.default.createElement("div", null,
                    react_1.default.createElement(components_1.Button, { size: "lg", 
                        //@ts-ignore
                        onClick: onClick, variant: "default" }, buttonText)))))));
};
