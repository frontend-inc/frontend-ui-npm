    ...
    return (react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('dark relative w-full') },
        ...
        react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('flex flex-col items-center justify-center', height && "h-[".concat(height, "px]"), "absolute top-0 left-0 w-full h-full px-3 sm:px-0") },
            react_1.default.createElement("div", { className: (0, frontend_shadcn_1.cn)('flex flex-col space-y-4', alignItems) },
                react_1.default.createElement(components_1.Heading, { label: label, title: title, subtitle: subtitle, textAlign: alignItems === 'items-center' ? 'center' : 'left', size: "xl", editable: editable, handleChange: handleChange }),
                actions,
