...
var Logos = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col w-full" },
        react_1.default.createElement("div", { className: "relative flex flex-wrap w-full justify-center items-center gap-4 sm:flex-nowrap" },
            react_1.default.createElement(components_1.Marquee, { className: "[--duration:20s]" }, logos.map(function (logo, i) { return (react_1.default.createElement("div", { key: i, className: 'p-4 max-h-[50px] max-w-[140px] rounded-lg w-full flex items-center justify-center' },
