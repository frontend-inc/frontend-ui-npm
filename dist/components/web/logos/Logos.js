...
var Logos = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col w-full" },
        react_1.default.createElement("div", { className: "relative flex flex-wrap w-full justify-center items-center gap-4 sm:flex-nowrap" },
            react_1.default.createElement(components_2.Marquee, { className: "duration-3000" }, logos.map(function (logo, i) { return (react_1.default.createElement("div", { key: i, className: 'p-4 max-h-[50px] max-w-[140px] rounded-lg w-full flex items-center justify-center' },
                react_1.default.createElement(image_1.default, { src: logo === null || logo === void 0 ? void 0 : logo.image, height: height, width: width, style: {
                        ...
                        height: height,
                        width: width,
                    }, alt: logo === null || logo === void 0 ? void 0 : logo.title }))); })),
            react_1.default.createElement("div", { className: "pointer-events-none absolute inset-y-0 left-0 w-1/3 bg-gradient-to-r from-backround dark:from-background" }),
