...
var Spotlight = function (props) {
    var _a = props || {}, image = _a.image, label = _a.label, title = _a.title, subtitle = _a.subtitle, actions = _a.actions, enableGradient = _a.enableGradient, enableOverlay = _a.enableOverlay, editable = _a.editable, handleChange = _a.handleChange, _b = _a.fontSize, fontSize = _b === void 0 ? '2xl' : _b;
