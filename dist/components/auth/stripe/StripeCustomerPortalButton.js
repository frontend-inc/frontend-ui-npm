...
var StripeCustomerPortalButton = function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, stripeCustomerPortal(url)];
                case 1:
                    resp = _c.sent();
    ...
    return (react_1.default.createElement(react_2.Button, { variant: "solid", color: "primary", onPress: handleClick, isLoading: loading }, loading ? 'Connecting...' : 'Manage Payments with Stripe'));
};
