...
var StripeCustomerPortalButton = function () {
    ...
    return (react_1.default.createElement(material_1.Button, { variant: "contained", color: "primary", onClick: handleClick }, loading ? 'Connecting...' : 'Manage Payments with Stripe'));
};
