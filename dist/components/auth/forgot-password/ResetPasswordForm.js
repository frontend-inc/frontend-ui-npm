...
var ResetPasswordForm = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1 },
        ...
        react_1.default.createElement(material_1.Button, { fullWidth: true, variant: "contained", color: "primary", onClick: handleSubmit, endIcon: loading && react_1.default.createElement(components_1.IconLoading, null) }, "Save and Continue"),
