...
var ResetPasswordForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
        ...
        react_1.default.createElement(core_1.Button, { fullWidth: true, onClick: handleSubmit, endIcon: loading && react_1.default.createElement(components_1.IconLoading, null) }, "Save and Continue"),
