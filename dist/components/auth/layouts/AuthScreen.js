    ...
    return (react_1.default.createElement(frontend_shadcn_1.Card, { className: "w-full rounded-lg bg-background" },
        react_1.default.createElement(frontend_shadcn_1.CardContent, { className: "space-y-4 p-4 sm:p-6" },
            react_1.default.createElement("div", { className: "space-y-2" },
                react_1.default.createElement(core_1.Typography, { variant: "h4", className: "text-center font-bold" }, title),
                subtitle && (react_1.default.createElement(core_1.Typography, { variant: "body2", className: "text-center text-muted-foreground" }, subtitle))),
            children)));
}
