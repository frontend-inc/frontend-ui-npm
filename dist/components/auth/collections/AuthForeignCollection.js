...
var ForeignCollection_1 = __importDefault(require("../../cms/collections/ForeignCollection"));
var AuthForeignCollection = function (props) {
    ...
    }), resource = _a.resource, findMany = _a.findMany, setResource = _a.setResource;
    ...
    return (react_1.default.createElement(ForeignCollection_1.default, __assign({ resource: resource, contentType: contentType }, rest)));
};
exports.default = AuthForeignCollection;
