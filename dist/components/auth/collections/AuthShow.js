...
var Show_1 = __importDefault(require("../../cms/show/Show"));
var AuthShow = function (props) {
    ...
    if (!(resource === null || resource === void 0 ? void 0 : resource.id))
        return null;
    return (react_1.default.createElement(Show_1.default, __assign({ handle: handle, resource: resource, contentType: contentType }, rest)));
};
exports.default = AuthShow;
