...
var GoogleLoginButton = function (props) {
    ...
    return (
    //@ts-ignore
    react_1.default.createElement(material_1.Button, { sx: sx.button, variant: "contained", color: "secondary", onClick: handleLogin, startIcon: loading ? (react_1.default.createElement(__1.IconLoading, { color: "secondary.contrastText" })) : (react_1.default.createElement(material_1.Box, { sx: sx.icon, dangerouslySetInnerHTML: { __html: GoogleIcon } })) }, "Sign In with Google"));
};
