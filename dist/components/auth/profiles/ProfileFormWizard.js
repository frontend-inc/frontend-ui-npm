...
var ProfileForm = function (props) {
    ...
    return (react_1.default.createElement(components_1.AuthRequired, null,
        react_1.default.createElement(components_1.FormWizard, __assign({}, rest, { url: "/api/v1/cms/profiles", fields: fields, buttonText: buttonText, handle: resource === null || resource === void 0 ? void 0 : resource.handle }))));
};
