...
var CollectionForm_1 = __importDefault(require("../../cms/forms/CollectionForm"));
var AuthForm = function (props) {
    ...
    if (!(resource === null || resource === void 0 ? void 0 : resource.id))
        return null;
    return (react_1.default.createElement(CollectionForm_1.default, __assign({}, rest, { contentType: contentType, handle: resource === null || resource === void 0 ? void 0 : resource.handle })));
};
