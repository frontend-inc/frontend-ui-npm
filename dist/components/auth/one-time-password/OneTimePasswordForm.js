...
var OneTimePasswordForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-3 w-full" },
        ...
        react_1.default.createElement(core_1.Button, { fullWidth: true, onClick: handleSubmit, endIcon: loading && react_1.default.createElement(__1.IconLoading, null) }, "Send One-Time Password"),
