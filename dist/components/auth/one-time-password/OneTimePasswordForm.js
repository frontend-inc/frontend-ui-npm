...
var OneTimePasswordForm = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1 },
        ...
        react_1.default.createElement(material_1.Button, { fullWidth: true, variant: "contained", color: "primary", onClick: handleSubmit, endIcon: react_1.default.createElement(__1.IconLoading, { loading: loading }) }, "Send One-Time Password"),
