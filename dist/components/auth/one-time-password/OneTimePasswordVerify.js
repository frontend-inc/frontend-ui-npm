...
var OneTimePasswordVerify = function (props) {
    ...
    var handleVerifyOTP = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, verifyOneTimePassword(String(oneTimePassword))];
                case 1:
                    resp = _a.sent();
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(__1.AuthScreen, { title: title, subtitle: subtitle },
            react_1.default.createElement(__1.OneTimePasswordVerifyMessage, { verified: verified, handleRedirect: handleRedirect, handleLogin: handleLogin }))));
};
