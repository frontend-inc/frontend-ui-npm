...
var LoginForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-4 w-full" },
        ...
        react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
            react_1.default.createElement(core_1.Button, { fullWidth: true, onClick: handleSubmit, loading: loading }, "Sign In"),
            handleSignup && (react_1.default.createElement(core_1.Button, { fullWidth: true, color: "secondary", onClick: handleSignup }, "No account? Sign up")),
