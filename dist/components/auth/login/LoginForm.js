...
var LoginForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-4 w-full" },
        ...
        react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
            react_1.default.createElement(core_1.Button, { size: "lg", fullWidth: true, onClick: handleSubmit, loading: loading }, "Sign In"),
            handleSignup && (react_1.default.createElement(core_1.Button, { fullWidth: true, variant: "ghost", onClick: handleSignup }, "No account? Sign up")),
            handleForgotPassword && (react_1.default.createElement(core_1.Button, { fullWidth: true, color: "secondary", variant: "ghost", onClick: handleForgotPassword }, "Forgot password?")),
            handleOneTimePassword && (react_1.default.createElement(core_1.Button, { fullWidth: true, color: "secondary", variant: "ghost", onClick: handleOneTimePassword }, "One-time password")))));
};
