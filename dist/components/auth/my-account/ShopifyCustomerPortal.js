...
var ShopifyCustomerPortal = function () {
    ...
    return (react_1.default.createElement(components_1.Placeholder, { icon: "ShoppingCart", title: "Shopify Customer Portal", description: "Manage your order history and returns.", buttons: react_1.default.createElement(components_1.Button, { onClick: handleClick, endIcon: "ExternalLink" }, "Open Customer Portal") }));
};
