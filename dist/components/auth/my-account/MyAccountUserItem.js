...
var MyAccountUserItem = function (_a) {
            ...
            react_1.default.createElement("div", { className: "flex items-center w-full" },
                ...
                react_1.default.createElement("div", { className: "flex-grow" },
                    react_1.default.createElement("div", { className: "flex items-center space-x-2" },
                        react_1.default.createElement("span", { className: "text-sm font-medium text-foreground" }, user === null || user === void 0 ? void 0 : user.name),
                    ...
                    react_1.default.createElement("span", { className: "text-xs text-muted-foreground" }, user === null || user === void 0 ? void 0 : user.email)),
