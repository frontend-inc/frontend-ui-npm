...
var TeamForm = function (props) {
    ...
    if ((team === null || team === void 0 ? void 0 : team.id) && (currentUser === null || currentUser === void 0 ? void 0 : currentUser.team_role) != 'admin') {
        return (react_1.default.createElement(components_1.Placeholder, { icon: "lock", title: "Unauthorized", description: "You do not have permission to access this page", buttons: react_1.default.createElement(material_1.Button, { color: "secondary", onClick: handleCancel, variant: "contained", startIcon: react_1.default.createElement(components_1.IconLoading, { loading: loading }) }, "Cancel") }));
    }
