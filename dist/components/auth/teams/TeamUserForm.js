...
var TeamUserForm = function (props) {
    ...
    return (react_1.default.createElement(material_1.Stack, { spacing: 1.5 },
        react_1.default.createElement(material_1.List, { dense: true, disablePadding: true },
            react_1.default.createElement(components_1.UserItem, { selected: true, user: teamUser === null || teamUser === void 0 ? void 0 : teamUser.user, handleClick: function () { return null; }, handleEdit: function () { return null; }, handleDelete: function () { return null; } })),
