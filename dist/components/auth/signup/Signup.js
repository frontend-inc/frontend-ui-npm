...
var Signup = function (props) {
    ...
    return (react_1.default.createElement(__1.AuthLayout, null,
        react_1.default.createElement(__1.AuthScreen, { title: title, subtitle: subtitle },
            react_1.default.createElement(__1.SignupForm, { errors: errors, loading: loading, user: user, handleChange: handleChange, handleSubmit: handleSubmit, handleLogin: handleLogin }))));
};
