...
var SendPinForm = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col space-y-3" },
        ...
        react_1.default.createElement(components_1.Button, { fullWidth: true, onClick: handleSubmit, loading: loading }, "Send Verification Pin"),
        handleLogin && (react_1.default.createElement(components_1.Button, { fullWidth: true, variant: "ghost", onClick: handleLogin }, "Cancel"))));
};
