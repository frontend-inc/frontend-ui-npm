...
var useSegment = function () {
    ...
    var checkout = (0, frontend_shopify_1.useCheckout)().checkout;
    var trackAddToCart = function (_a) {
        var _b, _c;
        var variant = _a.variant, quantity = _a.quantity, product = _a.product;
        segment === null || segment === void 0 ? void 0 : segment.track('Product Added', {
            checkout_id: checkout === null || checkout === void 0 ? void 0 : checkout.id,
            ...
            name: (variant === null || variant === void 0 ? void 0 : variant.title) || (product === null || product === void 0 ? void 0 : product.title),
    ...
    var trackRemoveFromCart = function (_a) {
        var _b, _c;
        var variant = _a.variant, quantity = _a.quantity, product = _a.product;
        segment === null || segment === void 0 ? void 0 : segment.track('Product Removed', {
            checkout_id: checkout === null || checkout === void 0 ? void 0 : checkout.id,
            product_id: product === null || product === void 0 ? void 0 : product.id,
            sku: variant === null || variant === void 0 ? void 0 : variant.sku,
            category: product === null || product === void 0 ? void 0 : product.productType,
    ...
    var trackCartViewed = function (cart) {
        ...
        segment === null || segment === void 0 ? void 0 : segment.track('Cart Viewed', {
            order_id: cart.id,
            value: (_a = cart === null || cart === void 0 ? void 0 : cart.totalAmount) === null || _a === void 0 ? void 0 : _a.amount,
            revenue: (_b = cart === null || cart === void 0 ? void 0 : cart.totalAmount) === null || _b === void 0 ? void 0 : _b.amount,
            coupon: (_c = cart.discountApplications.edges) === null || _c === void 0 ? void 0 : _c.map(function (e) { return e === null || e === void 0 ? void 0 : e.node; }).map(function (node) { return node === null || node === void 0 ? void 0 : node.code; }).join(', '),
            currency: (_e = (_d = cart === null || cart === void 0 ? void 0 : cart.cost) === null || _d === void 0 ? void 0 : _d.totalAmount) === null || _e === void 0 ? void 0 : _e.currencyCode,
            products: products,
        });
    };
    var trackCheckoutStarted = function (cart) {
        ...
        segment === null || segment === void 0 ? void 0 : segment.track('Checkout Started', {
            order_id: cart.id,
            value: (_a = cart === null || cart === void 0 ? void 0 : cart.totalAmount) === null || _a === void 0 ? void 0 : _a.amount,
            revenue: (_b = cart === null || cart === void 0 ? void 0 : cart.totalAmount) === null || _b === void 0 ? void 0 : _b.amount,
            coupon: (_c = cart.discountApplications.edges) === null || _c === void 0 ? void 0 : _c.map(function (e) { return e === null || e === void 0 ? void 0 : e.node; }).map(function (node) { return node === null || node === void 0 ? void 0 : node.code; }).join(', '),
            currency: (_d = cart === null || cart === void 0 ? void 0 : cart.totalAmount) === null || _d === void 0 ? void 0 : _d.currencyCode,
            products: products,
        });
    };
    var trackProductsSearched = function (query) {
        segment === null || segment === void 0 ? void 0 : segment.track('Products Searched', {
            query: query,
        });
    };
    var trackProductViewed = function (product) {
        ...
        segment === null || segment === void 0 ? void 0 : segment.track('Product Viewed', {
            product_id: product === null || product === void 0 ? void 0 : product.id,
            sku: variant === null || variant === void 0 ? void 0 : variant.sku,
            category: product === null || product === void 0 ? void 0 : product.productType,
            name: product === null || product === void 0 ? void 0 : product.title,
            ...
            variant: variant === null || variant === void 0 ? void 0 : variant.id,
            currency: (_b = variant === null || variant === void 0 ? void 0 : variant.price) === null || _b === void 0 ? void 0 : _b.currencyCode,
            url: window.location.href,
            image_url: (_c = variant === null || variant === void 0 ? void 0 : variant.image) === null || _c === void 0 ? void 0 : _c.url,
        });
    };
    var trackProductClicked = function (product) {
        var _a, _b, _c, _d, _e;
        var variant = product.variants.edges[0].node;
        segment === null || segment === void 0 ? void 0 : segment.track('Product Clicked', {
            product_id: product === null || product === void 0 ? void 0 : product.id,
    ...
    var trackProductList = function (collection) {
        ...
        segment === null || segment === void 0 ? void 0 : segment.track('Product List Viewed', {
