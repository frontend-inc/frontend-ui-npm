...
var useResource = function (props) {
  ...
  var _g = (0, react_2.useState)({}),
    query = _g[0],
    setQuery = _g[1];
  var _h = (0, react_2.useState)(null),
    meta = _h[0],
    setMeta = _h[1];
  var _j = (0, react_2.useState)(1),
    page = _j[0],
    setPage = _j[1];
  var _k = (0, react_2.useState)(10),
    perPage = _k[0],
    setPerPage = _k[1];
  var _l = (0, react_2.useState)(0),
    totalCount = _l[0],
    setTotalCount = _l[1];
  var _m = (0, react_2.useState)(0),
    numPages = _m[0],
    setNumPages = _m[1];
  ...
  var findOne = function (id) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!id) return [2 /*return*/, null];
            return [
              4 /*yield*/,
              loadingWrapper(function () {
                return api.collection(name).url(url).findOne(id);
              }),
            ];
          case 1:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              api.url(url).findMany(__assign(__assign({}, query), queryParams)),
            ];
          case 2:
            res = _a.sent();
            if (res.data) {
  ...
  var loadMore = function () {
    ...
    findMany(
      __assign(__assign({}, query), { page: nextPage }),
      loadMoreResults
    );
  };
  ...
  var updateMany = function (ids, data) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
  ...
  var addLinks = function (id, contentType, dataIds) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              ...
              loadingWrapper(function () {
                return api
                  .collection("links")
                  .url(url)
                  .addLinks(id, contentType, dataIds);
              }),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
  ...
  var removeLinks = function (id, targetIds) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
  ...
  var addAttachment = function (id, fieldName, attachmentId) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
  ...
  var removeAttachment = function (id, fieldName) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
  ...
  var updatePositions = function (sorted) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              api.collection(name).url(url).updatePositions(sorted),
            ];
          case 1:
  ...
  var handleChange = function (ev) {
    ...
    setResource(
      __assign(__assign({}, resource), ((_a = {}), (_a[name] = value), _a))
    );
  };
  var loadingWrapper = function (apiMethod) {
    return __awaiter(void 0, void 0, void 0, function () {
      var res, e_2;
      var _a;
  ...
  var handleErrors = function (e) {
    var _a, _b, _c;
    if (
      ((_a = e === null || e === void 0 ? void 0 : e.response) === null ||
      _a === void 0
        ? void 0
        : _a.status) === 401
    ) {
    ...
    if (
      (_b = e === null || e === void 0 ? void 0 : e.data) === null ||
      _b === void 0
        ? void 0
        : _b.errors
    ) {
      setErrors(
        (_c = e === null || e === void 0 ? void 0 : e.data) === null ||
          _c === void 0
          ? void 0
          : _c.errors
      );
