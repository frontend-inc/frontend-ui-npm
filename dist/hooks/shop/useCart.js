...
var useCart = function () {
    ...
    var _b = (0, react_1.useState)(null), cartId = _b[0], setCartId = _b[1];
            ...
            switch (_a.label) {
                case 0:
                    if (!cartId)
                        return [2 /*return*/, 'Cart not found'];
                    return [4 /*yield*/, loadingWrapper(function () {
                            return api.removeFromCart(cartId, productId, apiParams);
                        })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
            ...
            switch (_a.label) {
                case 0:
                    if (!cartId)
                        return [2 /*return*/, 'Cart not found'];
                    return [4 /*yield*/, loadingWrapper(function () {
                            return api.addQuantity(cartId, productId, apiParams);
                        })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
            ...
            switch (_a.label) {
                case 0:
                    if (!cartId)
                        return [2 /*return*/, 'Cart not found'];
                    return [4 /*yield*/, loadingWrapper(function () {
                            return api.removeQuantity(cartId, productId, apiParams);
                        })];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    ...
    }, [cart === null || cart === void 0 ? void 0 : cart.uid]);
    return {
        cartId: cartId,
