...
var __1 = require("..");
var useStatistics = function (props) {
    var url = props.url;
    ...
    var fetchData = function (query) { return __awaiter(void 0, void 0, void 0, function () {
        var apiQuery, queryUrl, resp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    apiQuery = new frontend_js_1.ApiQuery();
                    //@ts-ignore
                    apiQuery.filter(query.filters);
                    queryUrl = apiQuery.url();
                    return [4 /*yield*/, loadingWrapper(function () {
                            return api.get("".concat(url, "/statistics"), queryUrl);
                        })];
                case 1:
                    resp = _a.sent();
