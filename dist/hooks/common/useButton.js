    ...
    var handleClick = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (action) {
                ...
                case 'email':
                    if (src) {
                        window.location.href = "mailto:".concat(src);
                    }
                    break;
                case 'phone':
                    if (src) {
                        window.location.href = "tel:".concat(src);
                    }
                    break;
                case 'sms':
                    if (src) {
                        window.location.href = "sms:".concat(src);
                    }
                    break;
                case 'whatsapp':
                    if (src) {
                        window.open("https://wa.me/".concat(src), '_blank');
                    }
                    break;
                case 'download':
                    if (src) {
                ...
                case 'share':
                    if (isMobile) {
                        ...
                        navigator.share({
                            title: title,
                            text: "Check this out: ".concat(description),
