...
var useDragDrop = function (props) {
  var _a = (0, react_1.useState)(props.children),
    columns = _a[0],
    setColumns = _a[1];
  ...
  var reorderChildren = function (columns, source, destination) {
    var current = columns.find(function (i) {
      return String(i.id) == source.droppableId;
    });
    var next = columns.find(function (i) {
      return String(i.id) == destination.droppableId;
    });
