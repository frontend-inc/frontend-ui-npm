...
var useResponsive = function () {
  ...
  var _a = (0, react_1.useState)("lg"),
    breakpoint = _a[0],
    setBreakpoint = _a[1];
  var isMobile = (0, useMediaQuery_1.default)(theme.breakpoints.down("sm"));
  var isTablet = (0, useMediaQuery_1.default)(
    theme.breakpoints.between("sm", "md")
  );
  var isDesktop = (0, useMediaQuery_1.default)(
    theme.breakpoints.between("md", "lg")
  );
  var isSuperLargeDesktop = (0, useMediaQuery_1.default)(
