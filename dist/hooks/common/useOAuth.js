...
var useOAuth = function (props) {
    ...
    (0, react_1.useEffect)(function () {
        var handleEventListener = function (event) { return __awaiter(void 0, void 0, void 0, function () {
            var code;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!event.data) return [3 /*break*/, 2];
                        code = event.data;
                        return [4 /*yield*/, onComplete(code)];
                    case 1:
                        _a.sent();
                        window.close();
                        _a.label = 2;
    ...
    (0, react_1.useEffect)(function () {
        if (queryParams === null || queryParams === void 0 ? void 0 : queryParams.code) {
    ...
    }, [queryParams === null || queryParams === void 0 ? void 0 : queryParams.code]);
};
