...
var useAuth = function () {
  var _a = (0, react_1.useContext)(context_1.ApiContext),
    api = _a.api,
    authCookie = _a.authCookie;
  ...
  var _b = (0, react_1.useContext)(context_1.AuthContext),
    authenticated = _b.authenticated,
    setAuthenticated = _b.setAuthenticated,
    currentUser = _b.currentUser,
    setCurrentUser = _b.setCurrentUser,
    setToken = _b.setToken;
  var _c = (0, hooks_1.useResource)({
    ...
    loading = _c.loading,
    setLoading = _c.setLoading,
    user = _c.resource,
    setUser = _c.setResource,
          ...
          case 0:
            return [
              ...
              loadingWrapper(function () {
                return api.url(serverPath).updateMe(user);
              }),
            ];
          case 1:
        ...
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              loadingWrapper(function () {
                return api.url(serverPath).fetchMe();
              }),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
        ...
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              loadingWrapper(function () {
                return api.url(serverPath).login(user);
              }),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
        ...
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              loadingWrapper(function () {
                return api.url(serverPath).signup(user);
              }),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
        ...
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              loadingWrapper(function () {
                return api.url(serverPath).sendPin(user);
              }),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
  ...
  var verifyPin = function (email, pin) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              loadingWrapper(function () {
                return api.url(serverPath).verifyPin(email, pin);
              }),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
  ...
  var sendOneTimePassword = function (user) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
  ...
  var verifyOneTimePassword = function (otp) {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
        ...
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              loadingWrapper(function () {
                return api.url(serverPath).forgotPassword(user);
              }),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
        ...
        switch (_b.label) {
          ...
          case 1:
            ...
            if (
              ...
              handleErrors(
                resp === null || resp === void 0 ? void 0 : resp.error
              );
            }
            return [
              2 /*return*/,
