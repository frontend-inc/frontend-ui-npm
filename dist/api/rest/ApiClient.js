...
var ApiClient = /** @class */ (function () {
  function ApiClient(baseUrl, fetchToken, apiKey, authToken) {
    ...
    return new Proxy(this, {
      get: function (target, prop) {
        ...
        target._collection =
          prop === null || prop === void 0 ? void 0 : prop.toString();
        target._url = "/".concat(
          prop === null || prop === void 0 ? void 0 : prop.toString()
        );
        return target;
  ...
  ApiClient.prototype.create = function (data) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            this.payload = ((_a = {}), (_a[this._collection] = data), _a);
            this.handleFormatData();
            this.endpoint = this._url;
            return [
              4 /*yield*/,
              this.post(this._url, this.payload, this.headers),
            ];
          case 1:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.put(this.endpoint, this.payload, this.headers),
            ];
          case 1:
            return [2 /*return*/, _b.sent()];
        }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.post(this.endpoint, this.payload, this.headers),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
        }
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            this.endpoint = ""
              .concat(this._url, "/")
              .concat(sourceId, "/remove_links");
            return [
              4 /*yield*/,
              this.restClient.post(this.endpoint, this.payload, this.headers),
            ];
          case 1:
            return [2 /*return*/, _b.sent()];
        }
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            this.payload = ((_a = {}), (_a[this._collection] = user), _a);
            this.handleFormatData();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            this.payload =
              ((_a = {}),
              (_a[this._collection] = __assign(__assign({}, user), {
                email: user.email,
              })),
              _a);
  ...
  ApiClient.prototype.changePassword = function (
    currentPassword,
    password,
  ...
  ApiClient.prototype.resetPassword = function (
    email,
    password,
    passwordConfirmation,
    changePasswordToken
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.restClient.post(endpoint, payload, headers),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
        }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.restClient.put(endpoint, payload, headers),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
        }
      ...
      return __generator(this, function (_a) {
        ...
        for (formKey in this.payload[this._collection]) {
          ...
          if (this.isJsonObject(this.payload[this._collection][formKey])) {
            formData.append(
              "".concat(this._collection, "[").concat(formKey, "_string]"),
              JSON.stringify(this.payload[this._collection][formKey])
            );
          } else {
            formData.append(
              "".concat(this._collection, "[").concat(formKey, "]"),
