...
var CmsForm = function (props) {
    var label = props.label, title = props.title, description = props.description, textAlign = props.textAlign, theme = props.theme, py = props.py, px = props.px, maxWidth = props.maxWidth, requireTeam = props.requireTeam, requirePaid = props.requirePaid, requireAdmin = props.requireAdmin, rest = __rest(props, ["label", "title", "description", "textAlign", "theme", "py", "px", "maxWidth", "requireTeam", "requirePaid", "requireAdmin"]);
    return (react_1.default.createElement(components_1.Section, { requireAuth: true, requireTeam: requireTeam, requirePaid: requirePaid, requireAdmin: requireAdmin, theme: theme, py: py, px: px, maxWidth: maxWidth },
