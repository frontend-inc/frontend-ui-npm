...
var CmsProductReferenceList = function (props) {
    ...
    return (react_1.default.createElement(components_1.Section, { bgColor: bgColor, py: py, px: px, maxWidth: maxWidth, requireAuth: requireAuth, requirePaid: requirePaid },
        ...
        react_1.default.createElement(components_2.ProductReferenceList, __assign({}, rest))));
};
exports.default = CmsProductReferenceList;
