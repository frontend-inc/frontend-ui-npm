...
var CmsSortableReferenceList = function (props) {
    ...
    return (react_1.default.createElement(components_1.Section, { mode: mode, py: py, px: px, maxWidth: maxWidth, requireAuth: requireAuth, requireTeam: requireTeam, requirePaid: requirePaid },
        ...
        react_1.default.createElement(components_2.SortableReferenceCollectionList, __assign({}, rest))));
};
exports.default = CmsSortableReferenceList;
