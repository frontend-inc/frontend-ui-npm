...
var ShopCollectionProductsCarousel = function (props) {
    ...
    return (react_1.default.createElement(components_1.Section, { requireAuth: requireAuth, requirePaid: requirePaid, bgColor: bgColor, mode: mode, py: py, px: px, maxWidth: maxWidth },
        react_1.default.createElement("div", { className: "flex flex-col space-y-2" },
            ...
            react_1.default.createElement(shop_1.CollectionProductsCarousel, __assign({}, rest)))));
};
exports.default = ShopCollectionProductsCarousel;
