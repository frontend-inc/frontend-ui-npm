...
var UICoverCarousel = function (props) {
    var bgColor = props.bgColor, mode = props.mode, px = props.px, py = props.py, maxWidth = props.maxWidth, requireAuth = props.requireAuth, requirePaid = props.requirePaid, rest = __rest(props, ["bgColor", "mode", "px", "py", "maxWidth", "requireAuth", "requirePaid"]);
