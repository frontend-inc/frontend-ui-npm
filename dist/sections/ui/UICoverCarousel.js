...
var UICoverCarousel = function (props) {
    var mode = props.mode, px = props.px, py = props.py, maxWidth = props.maxWidth, requireAuth = props.requireAuth, requirePaid = props.requirePaid, rest = __rest(props, ["mode", "px", "py", "maxWidth", "requireAuth", "requirePaid"]);
