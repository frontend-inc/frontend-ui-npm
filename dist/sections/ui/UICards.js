...
var UICards = function (props) {
    var direction = props.direction, label = props.label, title = props.title, subtitle = props.subtitle, _a = props.textAlign, textAlign = _a === void 0 ? 'center' : _a, variant = props.variant, bgColor = props.bgColor, bgImage = props.bgImage, bgOverlay = props.bgOverlay, mode = props.mode, py = props.py, px = props.px, _b = props.fontSize, fontSize = _b === void 0 ? 'md' : _b, maxWidth = props.maxWidth, requireAuth = props.requireAuth, editable = props.editable, handleChange = props.handleChange, rest = __rest(props, ["direction", "label", "title", "subtitle", "textAlign", "variant", "bgColor", "bgImage", "bgOverlay", "mode", "py", "px", "fontSize", "maxWidth", "requireAuth", "editable", "handleChange"]);
    return (react_1.default.createElement(components_1.Section, { requireAuth: requireAuth, bgColor: bgColor, bgImage: bgImage, bgOverlay: bgOverlay, mode: mode, py: py, px: px, maxWidth: maxWidth, variant: variant },
        react_1.default.createElement(components_1.Stack, { direction: direction, spacing: 10 },
