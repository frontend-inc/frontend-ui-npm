...
var UICards = function (props) {
    var direction = props.direction, label = props.label, title = props.title, subtitle = props.subtitle, _a = props.textAlign, textAlign = _a === void 0 ? 'center' : _a, fill = props.fill, border = props.border, bgColor = props.bgColor, mode = props.mode, py = props.py, px = props.px, _b = props.fontSize, fontSize = _b === void 0 ? 'lg' : _b, maxWidth = props.maxWidth, requireAuth = props.requireAuth, editable = props.editable, handleChange = props.handleChange, rest = __rest(props, ["direction", "label", "title", "subtitle", "textAlign", "fill", "border", "bgColor", "mode", "py", "px", "fontSize", "maxWidth", "requireAuth", "editable", "handleChange"]);
