...
var UIFeatureTabs = function (props) {
    ...
    return (react_1.default.createElement(components_1.Section, { requireAuth: requireAuth, bgColor: bgColor, bgImage: bgImage, bgOverlay: bgOverlay, mode: mode, py: py, px: px, maxWidth: maxWidth, variant: variant },
        react_1.default.createElement(components_1.Stack, { spacing: 10 },
            ...
            react_1.default.createElement(components_2.FeatureTabs, __assign({}, rest, { direction: direction })))));
};
exports.default = UIFeatureTabs;
