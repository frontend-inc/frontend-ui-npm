...
var UISpotlight = function (props) {
    ...
    return (react_1.default.createElement(components_1.Section, { requireAuth: requireAuth, requirePaid: requirePaid, bgColor: bgColor, py: py, px: 0, maxWidth: maxWidth },
