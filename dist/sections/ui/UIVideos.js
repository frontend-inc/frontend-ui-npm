...
var UIVideos = function (props) {
    var label = props.label, title = props.title, subtitle = props.subtitle, textAlign = props.textAlign, _a = props.fontSize, fontSize = _a === void 0 ? 'md' : _a, bgColor = props.bgColor, bgImage = props.bgImage, bgOverlay = props.bgOverlay, mode = props.mode, py = props.py, px = props.px, maxWidth = props.maxWidth, requireAuth = props.requireAuth, editable = props.editable, handleChange = props.handleChange, rest = __rest(props, ["label", "title", "subtitle", "textAlign", "fontSize", "bgColor", "bgImage", "bgOverlay", "mode", "py", "px", "maxWidth", "requireAuth", "editable", "handleChange"]);
