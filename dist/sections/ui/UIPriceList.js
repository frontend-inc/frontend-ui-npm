...
var UIPriceList = function (props) {
    var _a = props.direction, direction = _a === void 0 ? 'column' : _a, label = props.label, title = props.title, subtitle = props.subtitle, _b = props.textAlign, textAlign = _b === void 0 ? 'center' : _b, _c = props.fontSize, fontSize = _c === void 0 ? 'md' : _c, bgColor = props.bgColor, mode = props.mode, py = props.py, px = props.px, _d = props.maxWidth, maxWidth = _d === void 0 ? 'sm' : _d, requireAuth = props.requireAuth, editable = props.editable, handleChange = props.handleChange, rest = __rest(props, ["direction", "label", "title", "subtitle", "textAlign", "fontSize", "bgColor", "mode", "py", "px", "maxWidth", "requireAuth", "editable", "handleChange"]);
