...
var UIHeading = function (props) {
    var fill = props.fill, border = props.border, bgColor = props.bgColor, mode = props.mode, py = props.py, px = props.px, _a = props.maxWidth, maxWidth = _a === void 0 ? 'sm' : _a, requireAuth = props.requireAuth, rest = __rest(props, ["fill", "border", "bgColor", "mode", "py", "px", "maxWidth", "requireAuth"]);
