...
var AdminQuestionItem_1 = __importDefault(require("./AdminQuestionItem"));
...
var AdminQuestionsList = function () {
    ...
    return (react_1.default.createElement(components_1.ResourceList, { selectable: true, url: "".concat(apiUrl, "/questions"), name: 'question', enableSearch: true, enableEdit: true, enableDelete: true, enableCreate: true, enableShow: true, sortOptions: [
        ...
        ], create: AdminQuestionCreate_1.default, edit: AdminQuestionEdit_1.default, show: AdminQuestionShow_1.default, toolbar: AdminQuestionToolbar_1.default, component: AdminQuestionItem_1.default, emptyIcon: "Text", emptyTitle: "No questions", emptyDescription: "No questions added yet." }));
};
