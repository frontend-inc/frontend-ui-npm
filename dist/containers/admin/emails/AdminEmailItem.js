...
var EmailItem = function (props) {
    ...
    return (react_1.default.createElement(components_1.ResourceListItem, { enableBorder: true, primary: email.name, secondary: email.subject, icon: "Mail", color: colors_1.deepPurple[500], secondaryAction: (email === null || email === void 0 ? void 0 : email.internal) && react_1.default.createElement(components_1.Label, { label: "System" }), handleClick: function () { return handleEdit(email); }, handleEdit: function () { return handleEdit(email); }, handleDelete: (email === null || email === void 0 ? void 0 : email.internal) ? undefined : function () { return handleDelete(email); } }));
};
