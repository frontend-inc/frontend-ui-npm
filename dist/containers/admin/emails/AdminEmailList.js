...
var AdminEmailListItem_1 = __importDefault(require("./AdminEmailListItem"));
...
var AdminEmailsList = function () {
    ...
    return (react_1.default.createElement(components_1.ResourceList, { url: "".concat(apiUrl, "/emails"), name: "email", enableCreate: true, enableEdit: true, enableSearch: true, enableDelete: true, query: {
            sort_by: 'name',
            sort_direction: 'asc',
        }, edit: AdminEmailForm_1.default, create: AdminEmailForm_1.default, component: AdminEmailListItem_1.default, emptyIcon: "MessageSquare", emptyTitle: "No email templates", emptyDescription: "No email templates yet." }));
};
