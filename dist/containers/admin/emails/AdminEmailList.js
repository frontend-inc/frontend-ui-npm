...
var AdminEmailsList = function () {
    ...
    return (react_1.default.createElement(components_1.Resources, { url: "".concat(apiUrl, "/emails"), name: "email", enableCreate: true, enableEdit: true, enableSearch: true, enableDelete: true, query: {
            sort_by: 'name',
            sort_direction: 'asc',
