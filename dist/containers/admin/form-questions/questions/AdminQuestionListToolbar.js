...
var AdminProductToolbar = function (props) {
    ...
    var handleAddQuestions = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, addQuestions(formId, selectedIds)];
                case 1:
                    _a.sent();
                    handleSuccess();
                    handleClose();
    ...
    return (react_1.default.createElement(components_1.ResourceToolbarModal, { open: open, handleClose: handleClose },
        react_1.default.createElement(material_1.Stack, { direction: "row", spacing: 1 },
            react_1.default.createElement(components_1.PrimaryButton, { fullWidth: true, onClick: handleAddQuestions, icon: "Plus" }, "Add Questions"))));
};
