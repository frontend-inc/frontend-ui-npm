...
var DocumentListSheet = function (props) {
    var _a, _b, _c;
    ...
    var _g = (0, hooks_1.useAdminDocuments)({
    ...
    return (react_1.default.createElement(components_1.Sheet, { open: open, title: "Add ".concat((_b = field === null || field === void 0 ? void 0 : field.foreign_collection) === null || _b === void 0 ? void 0 : _b.singular_name), handleClose: handleClose, buttons: react_1.default.createElement(core_1.Button, { fullWidth: true, disabled: !selected, onClick: handleAddClick }, "Add") },
        ...
        react_1.default.createElement("ul", null, documents === null || documents === void 0 ? void 0 : documents.map(function (document, idx) { return (react_1.default.createElement(DocumentListItem_1.default, { key: idx, document: document, selected: selectedIds.includes(document === null || document === void 0 ? void 0 : document.id), handleClick: function () { return handleSelectClick(document); } })); })),
        numPages > page && (react_1.default.createElement(core_1.Button, { fullWidth: true, onClick: handleLoadMore, endIcon: loading ? (react_1.default.createElement(core_1.CircularProgress, null)) : (react_1.default.createElement(lucide_react_1.ChevronDown, { className: "w-5 h-5 text-foreground" })) }, "Load More"))));
};
exports.default = DocumentListSheet;
