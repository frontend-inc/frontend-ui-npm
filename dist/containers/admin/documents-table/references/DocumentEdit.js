...
var DocumentEdit = function (props) {
    ...
    var _c = (0, hooks_1.useAdminCollections)(), collection = _c.collection, findCollection = _c.findCollection;
    var _d = (0, hooks_1.useAdminDocuments)({
    ...
    return (react_1.default.createElement(components_1.Sheet, { open: open, handleClose: handleClose, title: title }, document && activeFields && (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "w-screen sm:w-auto" },
