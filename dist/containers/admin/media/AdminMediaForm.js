...
var AdminMediaForm = function (props) {
    ...
    return (react_1.default.createElement(components_1.Drawer, { open: open, handleClose: handleClose, title: "Upload an Asset" },
        react_1.default.createElement(material_1.Box, { sx: sx.tabs },
            react_1.default.createElement(components_1.ButtonTabs, { options: [
