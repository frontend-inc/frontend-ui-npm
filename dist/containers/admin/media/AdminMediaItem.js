...
var AdminMediaItem = function (props) {
    ...
    return (react_1.default.createElement(components_1.ResourceGridItem, { enableBorder: true, sortable: sortable, 
        //@ts-ignore
        image: resource === null || resource === void 0 ? void 0 : resource.url, secondaryAction: react_1.default.createElement(components_1.Label, { variant: "secondary", label: resource === null || resource === void 0 ? void 0 : resource.content_type }), handleClick: handleClick, handleDelete: handleDelete, slots: {
            image: {
                height: 160,
                width: 320,
                objectFit: 'contain',
