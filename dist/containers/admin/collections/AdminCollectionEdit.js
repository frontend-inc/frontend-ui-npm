...
var AdminCollectionEdit = function (props) {
    ...
    return (react_1.default.createElement(components_1.Drawer, { loading: loading, open: open, handleClose: handleClose, title: (collection === null || collection === void 0 ? void 0 : collection.id) ? 'Edit Collection' : 'Add Collection', disablePadding: true, buttons: react_1.default.createElement(material_1.Button, { fullWidth: true, color: "primary", variant: "contained", onClick: handleSubmit, startIcon: loading && react_1.default.createElement(components_1.IconLoading, null) }, (collection === null || collection === void 0 ? void 0 : collection.id) ? 'Update' : 'Save') },
