...
var AdminCollectionEdit = function (props) {
    ...
    return (react_1.default.createElement(components_1.Sheet, { loading: loading, open: open, handleClose: handleClose, title: (collection === null || collection === void 0 ? void 0 : collection.id) ? 'Edit Collection' : 'Add Collection', disablePadding: true, buttons: react_1.default.createElement(core_1.Button, { fullWidth: true, onClick: handleSubmit, startIcon: loading && react_1.default.createElement(components_1.IconLoading, null) }, (collection === null || collection === void 0 ? void 0 : collection.id) ? 'Update' : 'Save') },
