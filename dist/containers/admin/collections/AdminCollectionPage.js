...
var AdminCollectionPage = function () {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(components_1.AdminLayoutCenter, null,
            react_1.default.createElement(components_1.AdminHeader, { enableExpandLeftPanel: true, buttons: collectionId && (react_1.default.createElement("div", { className: "flex flex-row items-center space-x-2" },
                    react_1.default.createElement(core_1.Button, { onClick: handleAddClick, startIcon: react_1.default.createElement(lucide_react_1.Plus, { className: "w-5 h-5 text-primary-foreground" }) }, "Add"),
                    react_1.default.createElement(core_1.IconButton, { onClick: function () { return setOpenAiModal(true); } },
                        react_1.default.createElement(components_2.Icon, { name: "Wand" })))), secondaryActions: react_1.default.createElement(CollectionSchemaToggle_1.default, { tab: "content" }) }),
            collectionId ? (react_1.default.createElement(AdminCollectionTable_1.default, { collection: collection, handleSaveView: handleSaveView })) : (react_1.default.createElement(components_2.Placeholder, { icon: "Database", title: "No collection.", description: "Select or create a CMS collection." }))),
