...
var AdminViewEdit = function (props) {
    ...
    return (react_1.default.createElement(components_1.Sheet, { loading: loading, open: open, handleClose: handleClose, title: "Save view", buttons: react_1.default.createElement(components_1.Button, { loading: loading, onClick: handleSubmit }, "Save") },
