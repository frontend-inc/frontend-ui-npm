...
var AdminFieldVariantList = function (props) {
    ...
    return (react_1.default.createElement(material_1.Box, null,
        ...
        (field === null || field === void 0 ? void 0 : field.id) ? (react_1.default.createElement(AdminFieldVariantItem_1.default, { field: constants_1.FIELD_VARIANTS === null || constants_1.FIELD_VARIANTS === void 0 ? void 0 : constants_1.FIELD_VARIANTS.find(function (f) { return f.variant == field.variant; }), handleClick: function () { return null; } })) : (groupedFields && Object.keys(groupedFields).map(function (key, i) { return (react_1.default.createElement(components_2.MenuList, { enableBorder: true, key: i, label: key }, groupedFields[key].map(function (fieldVariant, i) { return (react_1.default.createElement(AdminFieldVariantItem_1.default, { field: fieldVariant, handleClick: function () { return handleClick(fieldVariant); } })); }))); }))));
};
