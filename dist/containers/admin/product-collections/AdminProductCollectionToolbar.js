...
var AdminProductCollectionToolbar = function (props) {
    ...
    return (react_1.default.createElement(components_1.ResourceToolbarModal, { open: open, handleClose: handleClose },
        react_1.default.createElement("div", { className: "flex flex-row space-x-2" },
            react_1.default.createElement(components_2.Button, { onClick: handlePublish }, "Publish"),
            react_1.default.createElement(components_2.Button, { variant: "secondary", onClick: handleUnpublish }, "Unpublish"),
            react_1.default.createElement(components_2.Button, { variant: "secondary", onClick: handleDelete }, "Delete"))));
};
