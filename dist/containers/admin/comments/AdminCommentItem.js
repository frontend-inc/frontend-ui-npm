...
var AdminCommentItem = function (props) {
    ...
    return (react_1.default.createElement(components_1.ResourceListItem, { primary: getCommentUserName(comment), secondary: (0, helpers_1.truncate)(comment === null || comment === void 0 ? void 0 : comment.body, 40), avatar: react_1.default.createElement(components_1.UserAvatar, { user: comment === null || comment === void 0 ? void 0 : comment.user }), secondaryAction: (comment === null || comment === void 0 ? void 0 : comment.flagged) && react_1.default.createElement(components_1.Label, { label: "Flagged" }), handleClick: handleClick, handleEdit: handleEdit, handleDelete: handleDelete }));
};
