...
var AdminCommentShow = function (props) {
    ...
    return (react_1.default.createElement(components_1.ResourceModal, { loading: loading, open: open, handleClose: handleClose, enableEdit: enableEdit, enableDelete: enableDelete, handleEdit: handleEdit, handleDelete: handleDelete },
        react_1.default.createElement(components_1.ResourceDetails, __assign({ image: (_b = (_a = comment === null || comment === void 0 ? void 0 : comment.document) === null || _a === void 0 ? void 0 : _a.image) === null || _b === void 0 ? void 0 : _b.url, primary: (_c = comment === null || comment === void 0 ? void 0 : comment.user) === null || _c === void 0 ? void 0 : _c.name, secondary: "@".concat((_d = comment === null || comment === void 0 ? void 0 : comment.user) === null || _d === void 0 ? void 0 : _d.username) }, props, { fields: [
