...
var AdminDocumentShow = function (props) {
    ...
    var filteredFields = fields.filter(function (field) { var _a; return !((_a = field === null || field === void 0 ? void 0 : field.name) === null || _a === void 0 ? void 0 : _a.includes(["title", "image", "description"])); });
