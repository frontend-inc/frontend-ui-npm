...
var DocumentEdit = function (props) {
    ...
    var appId = props.appId, documentId = props.documentId, collectionId = props.collectionId, enablePayments = props.enablePayments, enableUsers = props.enableUsers, enableTeams = props.enableTeams;
    ...
    var handleSubmit = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setSaveLoading(true);
                    if (!documentIds) return [3 /*break*/, 2];
                    return [4 /*yield*/, updateDocuments(documentIds, document)];
                case 1:
                    resp = _a.sent();
                    return [3 /*break*/, 6];
                case 2:
                    if (!(document === null || document === void 0 ? void 0 : document.id)) return [3 /*break*/, 4];
                    return [4 /*yield*/, updateDocument(document)];
                case 3:
                    resp = _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, createDocument(__assign(__assign({}, document), { content_type: collectionId }))];
                case 5:
                    resp = _a.sent();
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(components_2.AdminLayoutCenter, null,
            react_1.default.createElement(components_2.AdminHeader, { enableExpandRightPanel: true, title: title, primaryActions: react_1.default.createElement(material_1.IconButton, { size: "small", onClick: handleBackClick },
                    react_1.default.createElement(lucide_react_1.ChevronLeft, null)), buttons: react_1.default.createElement(components_3.PublishLabel, { published: document === null || document === void 0 ? void 0 : document.published }) }),
