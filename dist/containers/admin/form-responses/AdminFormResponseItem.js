...
var AdminFormResponseItem = function (props) {
    ...
    return (react_1.default.createElement(components_1.ResourceListItem, __assign({ selectable: selectable, selected: selected, image: (_a = resource === null || resource === void 0 ? void 0 : resource.image) === null || _a === void 0 ? void 0 : _a.url, primary: resource === null || resource === void 0 ? void 0 : resource.name, secondary: resource === null || resource === void 0 ? void 0 : resource.email, handleDelete: handleDelete, handleClick: handleClick, handleSelect: handleSelect }, rest)));
};
