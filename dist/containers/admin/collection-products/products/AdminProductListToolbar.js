...
var AdminProductToolbar = function (props) {
    ...
    var handleAddProducts = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, addProducts(productCollectionId, selectedIds)];
                case 1:
                    _a.sent();
                    handleSuccess();
                    handleClose();
    ...
    return (react_1.default.createElement(material_1.Collapse, { in: (selectedIds === null || selectedIds === void 0 ? void 0 : selectedIds.length) > 0 },
        react_1.default.createElement(material_1.Stack, { direction: "row", spacing: 1 },
            react_1.default.createElement(components_1.PrimaryButton, { fullWidth: true, onClick: handleAddProducts, icon: "Plus" }, "Add"))));
};
