...
function AdminProductToolbar(_a) {
    ...
    var handleAddProducts = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!productCollectionId) return [3 /*break*/, 2];
                    return [4 /*yield*/, addProducts(productCollectionId, selectedIds)];
                case 1:
                    _a.sent();
                    handleSuccess();
                    handleClose();
    ...
    return (react_1.default.createElement("div", { className: "sticky top-0 z-10 pb-2 shadow-md bg-background" },
        react_1.default.createElement(frontend_shadcn_1.Collapsible, { open: selectedIds.length > 0 },
            react_1.default.createElement(frontend_shadcn_1.CollapsibleContent, { className: "space-y-2" },
                react_1.default.createElement("div", { className: "flex space-x-2" },
                    react_1.default.createElement(components_1.Button, { className: "w-full", onClick: handleAddProducts },
