...
var AdminContactsList = function () {
    ...
    return (react_1.default.createElement(components_1.Resources, { enableBorder: false, url: "".concat(apiUrl, "/contacts"), name: "contact", enableSearch: true, enableCreate: true, enableEdit: true, enableDelete: true, sortOptions: [
