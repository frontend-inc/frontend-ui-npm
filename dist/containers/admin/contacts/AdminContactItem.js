...
var AdminContactItem = function (props) {
    ...
    return (react_1.default.createElement(components_1.ResourceListItem, { primary: react_1.default.createElement("div", { className: "flex flex-row space-x-1 items-center" },
            (contact === null || contact === void 0 ? void 0 : contact.name) && (react_1.default.createElement(core_1.Typography, { variant: "body1" }, contact === null || contact === void 0 ? void 0 : contact.name)),
