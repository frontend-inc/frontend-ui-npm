...
var AdminMenuLinkList = function (props) {
    ...
    return (react_1.default.createElement(components_1.SortableResources, { direction: 'column', sortable: true, enableBorder: true, url: "".concat(apiUrl, "/menus/").concat(menuId, "/links"), name: "link", enableCreate: true, enableEdit: true, enableSearch: true, enableDelete: true, handleClick: handleClick, query: {
            sort_by: 'position',
            sort_direction: 'asc',
