...
var AdminOrderDetails = function (props) {
    ...
    return (react_1.default.createElement("div", { className: "grid grid-cols-2 gap-4 ".concat(loading ? 'opacity-50' : '') },
        react_1.default.createElement("div", { className: "flex flex-row space-x-1" },
            react_1.default.createElement(core_2.Typography, { variant: "subtitle1" },
                "Order ",
        ...
        react_1.default.createElement("div", { className: "bg-white p-4 rounded-lg shadow" },
            react_1.default.createElement("div", { className: "flex flex-col" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(core_1.Button, { startIcon: react_1.default.createElement(components_1.Icon, { name: "Mail", size: 20 }), className: "mt-1 p-0.5 text-primary", onClick: handleCopyEmail }, order.customer_name)),
                react_1.default.createElement(core_2.Typography, { variant: "overline", className: "text-muted-foreground", className: "whitespace-pre-line" }, order.shipping_address))),
        react_1.default.createElement("div", { className: "bg-white p-4 rounded-lg shadow" },
            react_1.default.createElement("div", { className: "flex flex-col" },
                react_1.default.createElement(core_2.Typography, { variant: "overline", className: "text-muted-foreground" },
                    "Subtotal: ",
