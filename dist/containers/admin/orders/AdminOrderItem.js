...
var AdminOrderItem = function (props) {
    ...
    return (react_1.default.createElement(components_1.ResourceListItem, __assign({ selectable: selectable, selected: selected, image: (_b = product === null || product === void 0 ? void 0 : product.image) === null || _b === void 0 ? void 0 : _b.url, primary: "Order ".concat(order.display_number), secondary: react_1.default.createElement(components_1.ListFields, { resource: order, fields: [{ label: 'Name', name: 'customer_name', variant: 'string' }] }), secondaryAction: react_1.default.createElement(components_1.Label, { label: order === null || order === void 0 ? void 0 : order.status }), handleEdit: handleEdit, handleClick: handleClick, handleSelect: handleSelect }, rest)));
};
