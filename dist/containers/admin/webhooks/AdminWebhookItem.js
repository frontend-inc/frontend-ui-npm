...
var AdminWebhookItem = function (props) {
    ...
    return (react_1.default.createElement(components_1.ResourceListItem, { enableBorder: true, sortable: sortable, icon: "Webhook", color: "primary.main", primary: resource === null || resource === void 0 ? void 0 : resource.event_type, secondary: (_a = resource === null || resource === void 0 ? void 0 : resource.collection) === null || _a === void 0 ? void 0 : _a.name, secondaryAction: react_1.default.createElement(components_1.Label, { label: resource === null || resource === void 0 ? void 0 : resource.event_type }), handleClick: handleClick, handleEdit: handleEdit, handleDelete: handleDelete }));
};
